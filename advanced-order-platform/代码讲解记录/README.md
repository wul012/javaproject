...
48-version-44-replay-execution-contract-blocked-sample.md
 -> 第四十四版失败事件重放 execution-contract blocked 稳定样本，给 Node 多场景矩阵提供负向样本

49-version-45-ops-evidence.md
 -> 第四十五版订单平台 ops evidence，只读汇总服务版本、失败事件重放、审批、Outbox 和执行阻断信号
```
