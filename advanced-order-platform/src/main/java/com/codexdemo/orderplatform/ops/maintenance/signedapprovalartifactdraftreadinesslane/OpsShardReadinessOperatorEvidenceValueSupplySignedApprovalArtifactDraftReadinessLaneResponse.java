...
public
record OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessLaneResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record ReadinessLaneGate(String code, String category, String gate, String enforcement) {}
}
