...
final class OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierVerificationCatalog {
  ...
  static List<
          OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierResponse.VerificationGate>
      gates(
          List<
    ...
    return List.of(
        ...
        gate(
            ...
            sourceReceipts.stream()
                .allMatch(source -> "Node v234".equals(source.consumedNodeVersion()))),
        gate(
        ...
        gate(
            ...
            sourceReceipts.stream()
                .allMatch(source -> !source.nodeMayTreatAsProductionAuditRecord())),
        gate(
