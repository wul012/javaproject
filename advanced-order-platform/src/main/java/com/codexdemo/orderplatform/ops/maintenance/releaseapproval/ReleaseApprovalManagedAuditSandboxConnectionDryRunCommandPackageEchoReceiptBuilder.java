...
final class ReleaseApprovalManagedAuditSandboxConnectionDryRunCommandPackageEchoReceiptBuilder {
  ...
  private static final List<String> ECHOED_COMMAND_IDS =
      List.of(
  ...
  private static final List<String> WARNING_DIGEST_WARNING_INPUT_NAMES =
      List.of("managedAuditSandboxConnectionDryRunCommandPackageEchoReceiptWarnings");
  ...
  ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionDryRunCommandPackageShape
        packageShape = packageShape();
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionDryRunCommandPackageFieldEcho
        fieldEcho = fieldEcho();
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    if (!sourceReceiptAccepted) {
      receiptWarnings.add(
          "NODE_V244_SOURCE_SANDBOX_CONNECTION_OPERATOR_WINDOW_CHECKLIST_ECHO_RECEIPT_NOT_READY");
    }
            ...
            List.of(
                ...
                ReleaseApprovalDigestSupport.line(
                    ...
                    ReleaseApprovalUpstreamContractConstants
                        .NODE_V241_MANUAL_SANDBOX_CONNECTION_DRY_RUN_COMMAND_PACKAGE_PROFILE),
                ...
                ReleaseApprovalDigestSupport.line(
                    "disabledByDefault", packageShape.disabledByDefault()),
                ...
                ReleaseApprovalDigestSupport.line(
                    "credentialHandleNameField", fieldEcho.credentialHandleNameField()),
                ReleaseApprovalDigestSupport.line(
                    "schemaRehearsalIdField", fieldEcho.schemaRehearsalIdField()),
                ReleaseApprovalDigestSupport.line(
                    "rollbackPathIdField", fieldEcho.rollbackPathIdField()),
                ReleaseApprovalDigestSupport.line("timeoutBudgetMs", fieldEcho.timeoutBudgetMs()),
                ReleaseApprovalDigestSupport.line(
                    "manualAbortMarkerField", fieldEcho.manualAbortMarkerField()),
                ReleaseApprovalDigestSupport.line(
    ...
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        ...
        ReleaseApprovalContractConstants
            .RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_CONNECTION_OPERATOR_WINDOW_CHECKLIST_ECHO_RECEIPT_SCHEMA_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V241_MANUAL_SANDBOX_CONNECTION_DRY_RUN_COMMAND_PACKAGE_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V241_MANUAL_SANDBOX_CONNECTION_DRY_RUN_COMMAND_PACKAGE_PROFILE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V241_MANUAL_SANDBOX_CONNECTION_DRY_RUN_COMMAND_PACKAGE_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V241_MANUAL_SANDBOX_CONNECTION_DRY_RUN_COMMAND_PACKAGE_STATE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V244_MANUAL_SANDBOX_DRY_RUN_COMMAND_UPSTREAM_ECHO_VERIFICATION_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V244_MANUAL_SANDBOX_DRY_RUN_COMMAND_UPSTREAM_ECHO_VERIFICATION_PROFILE,
        true,
        packageShape,
        fieldEcho,
  ...
  List<String> warningDigestBoundaryLines(
    ...
    return List.of(
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionDryRunCommandPackageEchoReceiptDigest", receipt.receiptDigest()),
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionDryRunCommandPackageCommandCount",
        ...
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionDryRunCommandPackageDryRunOnly", receipt.packageShape().dryRunOnly()),
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionDryRunCommandPackageCarriesCredentialValue",
