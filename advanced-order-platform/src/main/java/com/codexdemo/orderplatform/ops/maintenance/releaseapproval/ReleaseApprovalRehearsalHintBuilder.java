...
final class ReleaseApprovalRehearsalHintBuilder {
  ...
  ReleaseApprovalRehearsalResponseRecords.RehearsalRequestContext rehearsalRequestContext(
    ...
    ReleaseApprovalContextHeaderField requestId =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
            normalizedRequestId,
            "X-Rehearsal-Request-Id",
            "rehearsal-request-id-not-supplied",
            "REHEARSAL_REQUEST_ID_MISSING");
    ReleaseApprovalContextHeaderField operatorIdentity =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField auditCorrelationId =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    return new ReleaseApprovalRehearsalResponseRecords.RehearsalRequestContext(
        ReleaseApprovalContractConstants.RELEASE_APPROVAL_REHEARSAL_CONTEXT_VERSION,
        requestId.value(),
        requestId.source(),
        ...
        List.of("X-Rehearsal-Request-Id", "X-Operator-Identity", "X-Audit-Correlation-Id"),
  ...
  ReleaseApprovalRehearsalResponseRecords.RehearsalOperatorWindowHint rehearsalOperatorWindowHint(
    ...
    List<String> warnings = new ArrayList<>();
    ReleaseApprovalContextHeaderField operatorId =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField operatorRoles =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField operatorVerifiedClaim =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField approvalCorrelationId =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    OperatorWindowFlags operatorWindowFlags =
        OperatorWindowFlags.fromEchoes(
            operatorId.echoed(),
    ...
    return new ReleaseApprovalRehearsalResponseRecords.RehearsalOperatorWindowHint(
        ReleaseApprovalContractConstants.RELEASE_APPROVAL_REHEARSAL_OPERATOR_WINDOW_HINT_VERSION,
        operatorId.value(),
        operatorId.source(),
        operatorRoles.value(),
  ...
  ReleaseApprovalRehearsalResponseRecords.RehearsalCiEvidenceHint rehearsalCiEvidenceHint(
    ...
    List<String> warnings = new ArrayList<>();
    ReleaseApprovalContextHeaderField manifestVersion =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField manifestDigest =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField manifestEndpoint =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField artifactRecordCount =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    CiEvidenceFlags ciEvidenceFlags =
        CiEvidenceFlags.fromEchoes(
    ...
    return new ReleaseApprovalRehearsalResponseRecords.RehearsalCiEvidenceHint(
        ReleaseApprovalContractConstants.RELEASE_APPROVAL_REHEARSAL_CI_EVIDENCE_HINT_VERSION,
  ...
  ReleaseApprovalRehearsalResponseRecords.RehearsalArtifactRetentionHint
    ...
    List<String> warnings = new ArrayList<>();
    ReleaseApprovalContextHeaderField uploadContractVersion =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField uploadContractDigest =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField artifactName =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField artifactRoot =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField retentionDays =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField uploadMode =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    boolean retentionDaysWithinJavaRetention =
        retentionDaysWithinJavaRetention(
            normalizedCiRetentionDays, retentionFixture.retentionDays());
    ArtifactRetentionFlags artifactRetentionFlags =
        ArtifactRetentionFlags.fromEchoes(
    ...
    return new ReleaseApprovalRehearsalResponseRecords.RehearsalArtifactRetentionHint(
        ReleaseApprovalContractConstants.RELEASE_APPROVAL_REHEARSAL_ARTIFACT_RETENTION_HINT_VERSION,
  ...
  ReleaseApprovalRehearsalResponseRecords.RehearsalLiveReadinessHint rehearsalLiveReadinessHint(
    ...
    List<String> warnings = new ArrayList<>();
    ReleaseApprovalContextHeaderField runtimePreflightVersion =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField runtimePreflightDigest =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField runtimeSmokeSessionId =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField runtimeReadTargetId =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField runtimeWindowMode =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    boolean liveReadinessContextComplete =
        ReleaseApprovalContextHeaderField.allEchoed(
            runtimePreflightVersion,
            runtimePreflightDigest,
            runtimeSmokeSessionId,
            runtimeReadTargetId,
            runtimeWindowMode);
    LiveReadinessFlags liveReadinessFlags =
        LiveReadinessFlags.fromEchoes(
    ...
    return new ReleaseApprovalRehearsalResponseRecords.RehearsalLiveReadinessHint(
        ReleaseApprovalContractConstants.RELEASE_APPROVAL_REHEARSAL_LIVE_READINESS_HINT_VERSION,
        evidence.sampledAt(),
        "sampledAt",
        ReleaseApprovalContractConstants.RELEASE_APPROVAL_REHEARSAL_RESPONSE_SCHEMA_VERSION,
