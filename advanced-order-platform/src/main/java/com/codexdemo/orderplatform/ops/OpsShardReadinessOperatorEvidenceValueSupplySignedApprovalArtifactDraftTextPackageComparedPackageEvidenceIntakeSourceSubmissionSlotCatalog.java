...
final
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparedPackageEvidenceIntakeSourceSubmissionSlotCatalog {
  ...
  static List<
    ...
    return List.of(
        slot(
            "compared-package-evidence-slot-source-acceptance-precheck",
            "v1322",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonAcceptancePrecheckCatalogService
                .ENDPOINT),
        slot(
            "compared-package-evidence-slot-manual-submission-reference",
            "v1323",
