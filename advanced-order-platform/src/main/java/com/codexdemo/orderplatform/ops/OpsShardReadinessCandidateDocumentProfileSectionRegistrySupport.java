...
final class OpsShardReadinessCandidateDocumentProfileSectionRegistrySupport {
    ...
    static OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse response(
            ...
            List<OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.ProfileSection> sections,
            List<OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.FieldEntry> fieldEntries,
            List<OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.RenderedSection> renderedSections,
            List<OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.RouteFieldLock> routeFieldLocks,
            List<String> gates,
        ...
        int lockedRouteFieldCount = lockCopy.stream()
                .mapToInt(OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.RouteFieldLock::lockedFieldCount)
                .sum();
        List<String> checks = new ArrayList<>();
        checks.add("candidate-document-profile-section-registry-source-plan-" + SOURCE_PLAN);
        checks.add("candidate-document-profile-section-registry-source-node-"
                + SOURCE_NODE_PROFILE_RENDERER_VERSION);
        checks.add("candidate-document-profile-section-registry-module-count-" + moduleCopy.size());
        checks.add("candidate-document-profile-section-registry-source-route-count-" + sourceCopy.size());
        checks.add("candidate-document-profile-section-registry-section-count-" + sectionCopy.size());
        checks.add("candidate-document-profile-section-registry-rendered-section-count-"
                + renderedCopy.size());
        checks.add("candidate-document-profile-section-registry-field-entry-count-" + fieldCopy.size());
        checks.add("candidate-document-profile-section-registry-route-field-lock-count-"
                + lockCopy.size());
        checks.add("candidate-document-profile-section-registry-locked-route-field-count-"
