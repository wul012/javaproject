...
final class ReleaseApprovalManagedAuditSandboxConnectionDryRunEnvelopeEchoReceiptBuilder {
  ...
  private static final List<String> WARNING_DIGEST_WARNING_INPUT_NAMES =
      List.of("managedAuditSandboxConnectionDryRunEnvelopeEchoReceiptWarnings");
  ...
  ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionDryRunEnvelopeFieldBoundary
        envelopeFieldBoundary = envelopeFieldBoundary();
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionDryRunEnvelopeCredentialBoundary
        credentialBoundary = credentialBoundary();
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionDryRunEnvelopeExecutionBoundary
    ...
    boolean allEnvelopeFieldsEchoed =
        envelopeFieldBoundary.operatorReviewFieldsComplete()
    ...
    boolean credentialValueExcluded =
        credentialBoundary.credentialHandleOnly()
    ...
    boolean noExecutionEffects =
        noWriteCredentialConnectionSchemaRollbackOrServiceStartProved(
            credentialBoundary, javaExecutionBoundary);
            ...
            List.of(
                ...
                ReleaseApprovalDigestSupport.line(
                    ...
                    ReleaseApprovalUpstreamContractConstants
                        .NODE_V236_MANUAL_SANDBOX_CONNECTION_DRY_RUN_REQUEST_ENVELOPE_PROFILE),
                ReleaseApprovalDigestSupport.line(
    ...
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        ...
        ReleaseApprovalContractConstants
            .RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_CONNECTION_PRECONDITION_RECEIPT_SCHEMA_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V236_MANUAL_SANDBOX_CONNECTION_DRY_RUN_REQUEST_ENVELOPE_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V236_MANUAL_SANDBOX_CONNECTION_DRY_RUN_REQUEST_ENVELOPE_PROFILE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V236_MANUAL_SANDBOX_CONNECTION_DRY_RUN_REQUEST_ENVELOPE_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V236_MANUAL_SANDBOX_CONNECTION_DRY_RUN_REQUEST_ENVELOPE_STATE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V237_MANUAL_SANDBOX_CONNECTION_READINESS_GATE_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V237_MANUAL_SANDBOX_CONNECTION_READINESS_GATE_PROFILE,
        true,
  ...
  List<String> warningDigestBoundaryLines(
    ...
    return List.of(
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionDryRunEnvelopeEchoReceiptDigest", receipt.receiptDigest()),
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionDryRunEnvelopeCredentialValueIncluded",
  ...
  boolean noWriteCredentialConnectionSchemaRollbackOrServiceStartProved(
    ...
    return noWriteCredentialConnectionSchemaRollbackOrServiceStartProved(
        receipt.credentialBoundary(), receipt.javaExecutionBoundary());
  }
