...
public class OpsShardReadinessRouteCleanupMaintenanceRiskLedgerService {
  ...
  public static final String ENDPOINT =
      RouteCleanupRoutes.BASE_PATH + RouteCleanupRoutes.MAINTENANCE_RISK_LEDGER;
  static final String PROFILE = "java-shard-readiness-route-cleanup-maintenance-risk-ledger.v1";

  @Transactional(readOnly = true)
  public OpsShardReadinessRouteCleanupMaintenanceRiskLedgerResponse ledger() {
    List<OpsShardReadinessRouteCleanupMaintenanceRiskLedgerResponse.RiskEntry> risks =
        List.of(
  ...
  private OpsShardReadinessRouteCleanupMaintenanceRiskLedgerResponse.RiskEntry risk(
      String name, String mitigation, String owner, String severity) {
    return new OpsShardReadinessRouteCleanupMaintenanceRiskLedgerResponse.RiskEntry(
        name, mitigation, owner, severity, "mitigated");
  }
}
