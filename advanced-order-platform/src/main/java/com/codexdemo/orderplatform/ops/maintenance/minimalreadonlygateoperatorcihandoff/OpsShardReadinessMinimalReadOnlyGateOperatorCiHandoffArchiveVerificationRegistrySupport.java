...
final
class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveVerificationRegistrySupport {
  ...
  static OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveVerificationRegistryResponse
    ...
    checks.add("minimal-read-only-gate-operator-ci-handoff-archive-source-plan-" + SOURCE_PLAN);
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-required-archive-"
            + REQUIRED_ARCHIVE_VERIFICATION_PLAN);
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-operator-plan-"
            + OPERATOR_HANDOFF_PLAN);
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-source-handoff-version-"
            + sourceHandoff.version());
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-source-handoff-status-"
            + sourceHandoff.status());
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-source-handoff-count-"
            + sourceHandoffCopy.size());
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-artifact-count-" + artifactCopy.size());
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-passed-artifact-count-"
            + passedArtifactCount);
    checks.add("minimal-read-only-gate-operator-ci-handoff-archive-lane-count-" + laneCopy.size());
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-passed-lane-count-" + passedLaneCount);
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-ci-batch-count-" + ciBatchCopy.size());
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-passed-ci-batch-count-"
            + passedCiBatchCount);
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-boundary-count-" + boundaryCopy.size());
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-locked-boundary-count-"
            + lockedBoundaryCount);
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-scorecard-count-"
            + scorecardCopy.size());
    checks.add(
        "minimal-read-only-gate-operator-ci-handoff-archive-markdown-section-count-"
