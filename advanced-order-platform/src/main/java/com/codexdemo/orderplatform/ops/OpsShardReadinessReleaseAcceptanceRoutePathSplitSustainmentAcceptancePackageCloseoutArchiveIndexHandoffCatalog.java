...
final class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutArchiveIndexHandoffCatalog {

    private OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutArchiveIndexHandoffCatalog() {
    }
    ...
    static List<OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutArchiveIndexResponse
        ...
        return List.of(
                note("archive-curator", "retain receipt, criteria, markdown, checks, and tags together", ready),
                note("release-reviewer", "use the archive index as the first scan point", ready),
                note("route-owner", "add new route split evidence beside this index, not inside old receipt",
                        ready),
                note("ci-maintainer", "confirm focused, related, and remote CI gates before future tags", ready)
        );
    }
