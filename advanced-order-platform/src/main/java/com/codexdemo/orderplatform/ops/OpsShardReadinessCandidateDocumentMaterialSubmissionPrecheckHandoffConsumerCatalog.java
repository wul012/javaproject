...
final class OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffConsumerCatalog {
    ...
    static List<OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffResponse.ConsumerRule> consumerRules(
        ...
        return sourcePrecheck.checkpoints().stream()
                .map(checkpoint -> new OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffResponse.ConsumerRule(
