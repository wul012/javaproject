...
public class OpsShardReadinessRouteCleanupCiRunAttestationService {
  ...
  static final String ENDPOINT =
      RouteCleanupRoutes.BASE_PATH + RouteCleanupRoutes.CI_RUN_ATTESTATION;
  ...
  public OpsShardReadinessRouteCleanupCiRunAttestationResponse attestation() {
    ...
    List<OpsShardReadinessRouteCleanupCiRunAttestationResponse.AttestationItem> items =
        List.of(
