...
final class OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionFieldCatalog {
  ...
  static List<
          OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryResponse.FieldEntry>
      fieldEntries(
          List<
  ...
  private static OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryResponse
    ...
    return new OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryResponse
        .FieldEntry(order, sectionCode, fieldName, fieldValue, routeFacing, "passed");
  }
}
