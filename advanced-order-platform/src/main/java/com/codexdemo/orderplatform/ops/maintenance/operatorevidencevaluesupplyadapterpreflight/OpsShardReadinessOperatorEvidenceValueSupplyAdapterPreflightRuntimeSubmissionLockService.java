...
@Service
public
class OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightRuntimeSubmissionLockService {
  ...
  public OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightResponse lock() {
    return OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightSupport.response(
        ...
        OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightSlotCatalog.rules(15, 17),
        List.of(
