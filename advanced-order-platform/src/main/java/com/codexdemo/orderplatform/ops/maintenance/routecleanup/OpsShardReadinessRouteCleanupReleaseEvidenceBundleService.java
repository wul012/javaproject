...
public class OpsShardReadinessRouteCleanupReleaseEvidenceBundleService {
  ...
  static final String ENDPOINT =
      RouteCleanupRoutes.BASE_PATH + RouteCleanupRoutes.RELEASE_EVIDENCE_BUNDLE;
  ...
  public OpsShardReadinessRouteCleanupReleaseEvidenceBundleResponse bundle() {
    ...
    List<OpsShardReadinessRouteCleanupReleaseEvidenceBundleResponse.BundleItem> items =
        List.of(
