...
final
class ReleaseApprovalManagedAuditSandboxEndpointCredentialResolverDisabledPrecheckEchoMarkerBuilder {
  ...
  private static final List<String> REQUIRED_ENV_HANDLE_NAMES =
      List.of(
  ...
  private static final List<String> OPT_IN_GATE_NAMES =
      List.of(
          "ORDEROPS_MANAGED_AUDIT_CREDENTIAL_RESOLVER_ENABLED",
          "ORDEROPS_MANAGED_AUDIT_SANDBOX_ENDPOINT_RESOLUTION_ENABLED");
  ...
  private static final List<String> INHERITED_NO_GO_CONDITIONS =
      List.of(
  ...
  private static RehearsalSandboxEndpointCredentialResolverDisabledPrecheckSourceEcho
      sourceNodeV261(SourceGate sourceGate) {
  ...
  private static RehearsalSandboxEndpointCredentialResolverDisabledPrecheckRecord
      disabledPrecheck() {
  ...
  private static RehearsalSandboxEndpointCredentialResolverDryRunResponseShape
      dryRunResponseShape() {
  ...
  private static RehearsalSandboxEndpointCredentialResolverDisabledPrecheckSideEffectBoundary
      sideEffectBoundary() {
