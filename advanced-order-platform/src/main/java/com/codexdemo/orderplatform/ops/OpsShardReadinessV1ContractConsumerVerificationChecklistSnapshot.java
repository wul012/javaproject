...
final class OpsShardReadinessV1ContractConsumerVerificationChecklistSnapshot {
    ...
    static List<String> v215RequiredEvidence(OpsShardReadinessV1ContractConsumerHandoffBundleResponse bundle) {
        return List.of(
    ...
    static List<String> v215VerificationChecks(OpsShardReadinessV1ContractConsumerHandoffBundleResponse bundle) {
        return List.of(
