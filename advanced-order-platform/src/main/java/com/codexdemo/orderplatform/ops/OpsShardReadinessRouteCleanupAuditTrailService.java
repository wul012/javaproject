...
public class OpsShardReadinessRouteCleanupAuditTrailService {
  ...
  static final String ENDPOINT =
      OpsShardReadinessRoutePaths.BASE_PATH + OpsShardReadinessRoutePaths.ROUTE_CLEANUP_AUDIT_TRAIL;
  ...
  public OpsShardReadinessRouteCleanupAuditTrailResponse auditTrail() {
    List<OpsShardReadinessRouteCleanupAuditTrailResponse.AuditCheckpoint> checkpoints =
        List.of(
            checkpoint(
                "node-plan-source",
  ...
  private OpsShardReadinessRouteCleanupAuditTrailResponse.AuditCheckpoint checkpoint(
      String name, String evidence, String owner) {
    return new OpsShardReadinessRouteCleanupAuditTrailResponse.AuditCheckpoint(
        name, evidence, owner, true, false, "passed");
  }
}
