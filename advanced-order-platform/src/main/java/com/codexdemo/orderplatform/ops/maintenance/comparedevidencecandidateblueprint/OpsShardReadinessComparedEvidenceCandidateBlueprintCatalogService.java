...
public class OpsShardReadinessComparedEvidenceCandidateBlueprintCatalogService {
  ...
  static final String PROFILE =
      "java-shard-readiness-compared-evidence-candidate-blueprint-catalog.v1";
  ...
  static OpsShardReadinessComparedEvidenceCandidateBlueprintResponse response(
      ...
      List<String> checks) {
    return OpsShardReadinessComparedEvidenceCandidateBlueprintSupport.response(
        version, endpoint, profile, sections, blockers, checks);
  }
}
