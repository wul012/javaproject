...
final class OpsShardReadinessCredentialResolverDisabledFakeHarnessEvidenceArchiveBoundaryCatalog {
    ...
    static List<OpsShardReadinessCredentialResolverDisabledFakeHarnessEvidenceArchiveResponse.FakeHarnessBoundary>
        ...
        return receipt.interfaceBoundaries().stream()
                ...
                .map(boundary -> new OpsShardReadinessCredentialResolverDisabledFakeHarnessEvidenceArchiveResponse
                        .FakeHarnessBoundary(
                        boundary.code(),
