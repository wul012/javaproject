...
final
class ReleaseApprovalSandboxEndpointCredentialResolverEndpointHandleAllowlistApprovalContractCatalog {
  ...
  private static final List<RequiredFieldTemplate> REQUIRED_FIELDS =
      List.of(
          requiredField(
              "endpoint_handle",
              "Endpoint handle",
              "stable non-secret endpoint handle",
  ...
  static List<RehearsalEndpointHandleAllowlistApprovalRequiredField> requiredFields() {
    return REQUIRED_FIELDS.stream()
        .map(
            template ->
                new RehearsalEndpointHandleAllowlistApprovalRequiredField(
                    template.id(),
                    template.label(),
                    true,
  ...
  static List<RehearsalEndpointHandleAllowlistApprovalProhibitedField> prohibitedFields() {
    return PROHIBITED_FIELDS.stream()
        .map(
            template ->
                new RehearsalEndpointHandleAllowlistApprovalProhibitedField(
  ...
  static List<RehearsalEndpointHandleAllowlistApprovalRejectionReason> rejectionReasons() {
    return REJECTION_REASONS.stream()
        .map(
            template ->
                new RehearsalEndpointHandleAllowlistApprovalRejectionReason(
  ...
  static List<RehearsalEndpointHandleAllowlistApprovalNoGoBoundary> noGoBoundaries() {
    return NO_GO_BOUNDARIES.stream()
        .map(
            template ->
                new RehearsalEndpointHandleAllowlistApprovalNoGoBoundary(
  ...
  static List<RehearsalEndpointHandleAllowlistApprovalUpstreamEchoRequest> upstreamEchoRequests() {
    return UPSTREAM_ECHO_REQUESTS.stream()
        .map(
            template ->
                new RehearsalEndpointHandleAllowlistApprovalUpstreamEchoRequest(
