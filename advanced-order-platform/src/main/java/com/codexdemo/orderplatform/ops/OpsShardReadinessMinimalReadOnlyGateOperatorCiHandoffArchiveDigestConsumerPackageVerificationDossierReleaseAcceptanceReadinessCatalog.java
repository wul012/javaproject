...
final
class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceReadinessCatalog {
  ...
  static List<
    ...
    return List.of(
        ...
        gate(
            ...
            "source-dossier-snapshot=" + source.sourcePackageSnapshotCount(),
            1,
        ...
        gate(
            "audience-routes",
            "audience-routes=" + source.readyAudienceRouteCount(),
            4,
        ...
        gate(
            "boundary-audits",
            "boundary-audits=" + source.lockedBoundaryAuditCount(),
            8,
  ...
  OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
          .ReleaseReadinessGate
      gate(String code, String evidence, int expected, int actual) {
