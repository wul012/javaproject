...
public class OpsShardReadinessRouteCleanupFinalArchivePlanService {
  ...
  static final String ENDPOINT =
      RouteCleanupRoutes.BASE_PATH + RouteCleanupRoutes.FINAL_ARCHIVE_PLAN;
  ...
  public OpsShardReadinessRouteCleanupFinalArchivePlanResponse plan() {
    ...
    List<OpsShardReadinessRouteCleanupFinalArchivePlanResponse.ArchiveStep> steps =
        List.of(
            step(
            ...
            step(
                ...
                "Node historical fixtures are out of Java cleanup scope"));
    boolean passed =
