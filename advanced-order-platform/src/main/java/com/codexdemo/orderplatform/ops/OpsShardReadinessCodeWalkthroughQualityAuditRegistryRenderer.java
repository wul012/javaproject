...
final class OpsShardReadinessCodeWalkthroughQualityAuditRegistryRenderer {
    ...
    static List<OpsShardReadinessCodeWalkthroughQualityAuditRegistryResponse.MarkdownSection>
            render(
    ...
    private static OpsShardReadinessCodeWalkthroughQualityAuditRegistryResponse.MarkdownSection
        ...
        batchAssessments.forEach(batch -> lines.add(batch.batch()
                + " | range="
                + batch.versionRange()
                + " | version-count="
                + batch.versionCount()
    ...
    private static OpsShardReadinessCodeWalkthroughQualityAuditRegistryResponse.MarkdownSection
        ...
        versionAudits.forEach(audit -> lines.add(audit.javaVersion()
                + " | "
                + audit.tag()
                + " | surfaces="
    ...
    private static OpsShardReadinessCodeWalkthroughQualityAuditRegistryResponse.MarkdownSection
        ...
        rubricScores.forEach(score -> lines.add(score.section()
                + " | required="
    ...
    private static OpsShardReadinessCodeWalkthroughQualityAuditRegistryResponse.MarkdownSection
        ...
        reviewFindings.forEach(finding -> lines.add(finding.code()
                + " | severity="
                + finding.severity()
                + " | blocking="
                + finding.blocking()
    ...
    private static OpsShardReadinessCodeWalkthroughQualityAuditRegistryResponse.MarkdownSection
        ...
        boundaryAudits.forEach(boundary -> lines.add(boundary.code()
                + " | forbidden="
