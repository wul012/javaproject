...
final class OpsShardReadinessSandboxConnectionPrecheckUpstreamReceiptVerificationManifestReferenceCatalog {

    private OpsShardReadinessSandboxConnectionPrecheckUpstreamReceiptVerificationManifestReferenceCatalog() {
    }

    static List<OpsShardReadinessSandboxConnectionPrecheckUpstreamReceiptVerificationManifestResponse.EvidenceReference>
    references(ReleaseApprovalRehearsalResponse rehearsal) {
        ...
        return List.of(
                reference("node-v1983-v2002-roadmap", "Node plan",
                ...
                reference("node-v247-verification-report", "Node report", "Node v247",
                        receipt.nextNodePrecheckUpstreamReceiptVerificationProfile(),
                        "Existing report reused by the split module family.")
        );
    }

    private static OpsShardReadinessSandboxConnectionPrecheckUpstreamReceiptVerificationManifestResponse
