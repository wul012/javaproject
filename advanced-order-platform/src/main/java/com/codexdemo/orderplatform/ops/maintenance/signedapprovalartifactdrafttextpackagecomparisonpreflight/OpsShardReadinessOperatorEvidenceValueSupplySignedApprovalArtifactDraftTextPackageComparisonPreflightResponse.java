...
public
record OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record ComparisonGate(String code, String category, String gate, String enforcement) {}
}
