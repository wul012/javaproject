...
final class ReleaseApprovalSandboxEndpointCredentialResolverAbortRollbackSemanticsContractSections {
    ...
    private ReleaseApprovalSandboxEndpointCredentialResolverAbortRollbackSemanticsContractSections() {
    }
    ...
    static RehearsalAbortRollbackSemanticsContractSourceNodeV325 sourceNodeV325() {
        return new RehearsalAbortRollbackSemanticsContractSourceNodeV325(
                ...
                true,
                ReleaseApprovalSandboxEndpointCredentialResolverAbortRollbackSemanticsContractCatalog.SOURCE_NODE_V325_REVIEW_DIGEST,
                5,
                1,
                6,
                ReleaseApprovalSandboxEndpointCredentialResolverAbortRollbackSemanticsContractCatalog.TARGET_PREREQUISITE_ID,
                true,
                "Node v326",
                true,
                true,
    ...
    static RehearsalAbortRollbackSemanticsContract abortRollbackSemanticsContract() {
        List<RehearsalAbortRollbackSemanticsRequiredField> requiredFields =
                ReleaseApprovalSandboxEndpointCredentialResolverAbortRollbackSemanticsContractCatalog.requiredFields();
        List<RehearsalAbortRollbackSemanticsProhibitedField> prohibitedFields =
                ReleaseApprovalSandboxEndpointCredentialResolverAbortRollbackSemanticsContractCatalog.prohibitedFields();
        List<RehearsalAbortRollbackSemanticsRejectionReason> rejectionReasons =
                ReleaseApprovalSandboxEndpointCredentialResolverAbortRollbackSemanticsContractCatalog.rejectionReasons();
        List<RehearsalAbortRollbackSemanticsNoGoBoundary> noGoBoundaries =
                ReleaseApprovalSandboxEndpointCredentialResolverAbortRollbackSemanticsContractCatalog.noGoBoundaries();
