...
final class OpsShardReadinessCredentialResolverDisabledFakeHarnessEvidenceArchiveVerificationCatalog {

    private OpsShardReadinessCredentialResolverDisabledFakeHarnessEvidenceArchiveVerificationCatalog() {
    }

    static List<OpsShardReadinessCredentialResolverDisabledFakeHarnessEvidenceArchiveResponse.VerificationGate> gates(
        ...
        return List.of(
                gate("source-implementation-plan-echo-ready",
                ...
                gate("java-v121-requirements-frozen",
                ...
                gate("not-production-audit-record",
    ...
    private static OpsShardReadinessCredentialResolverDisabledFakeHarnessEvidenceArchiveResponse.VerificationGate gate(
            String name,
            String evidence,
            boolean passed
    ) {
