...
@Service
public
class OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightSourceEvidenceSnapshotService {
  ...
  public OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightResponse snapshot() {
    return OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightSupport.response(
        ...
        OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightSlotCatalog.rules(12, 15),
        List.of(
