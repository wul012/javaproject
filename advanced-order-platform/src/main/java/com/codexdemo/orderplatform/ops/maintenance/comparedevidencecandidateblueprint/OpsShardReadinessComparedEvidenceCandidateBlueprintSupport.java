...
final class OpsShardReadinessComparedEvidenceCandidateBlueprintSupport {
  ...
  public static final String SOURCE_PLAN = "Node v1361";
  public static final String SOURCE_NODE_PREFLIGHT_VERSION = "Node v1351";
  public static final String SOURCE_JAVA_PREFLIGHT_VERSION = "Java v1054";
  ...
  static OpsShardReadinessComparedEvidenceCandidateBlueprintResponse response(
    ...
    int passedSectionCount =
        (int) sectionCopy.stream().filter(section -> "passed".equals(section.status())).count();
    ...
    checks.add(
        "compared-evidence-candidate-blueprint-source-node-" + SOURCE_NODE_PREFLIGHT_VERSION);
    checks.add(
        "compared-evidence-candidate-blueprint-source-java-" + SOURCE_JAVA_PREFLIGHT_VERSION);
  ...
  static OpsShardReadinessComparedEvidenceCandidateBlueprintResponse.CandidateBlocker blocker(
      String code, String category, String blocker, String rejectionCode) {
    return new OpsShardReadinessComparedEvidenceCandidateBlueprintResponse.CandidateBlocker(
        code, category, blocker, rejectionCode, "fail-closed", "passed");
  }
}
