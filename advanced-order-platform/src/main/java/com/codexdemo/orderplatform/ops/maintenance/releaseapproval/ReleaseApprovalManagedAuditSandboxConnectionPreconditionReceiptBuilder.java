...
final class ReleaseApprovalManagedAuditSandboxConnectionPreconditionReceiptBuilder {
  ...
  private static final List<String> WARNING_DIGEST_WARNING_INPUT_NAMES =
      List.of("managedAuditSandboxConnectionPreconditionReceiptWarnings");
  ...
  ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionPreconditionOwnerApprovalBoundary
        ownerApprovalBoundary = ownerApprovalBoundary();
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionPreconditionCredentialBoundary
        credentialBoundary = credentialBoundary();
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionPreconditionSchemaBoundary
        schemaRehearsalBoundary = schemaRehearsalBoundary();
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionPreconditionRollbackBoundary
        rollbackPathBoundary = rollbackPathBoundary();
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionPreconditionExecutionBoundary
            ...
            List.of(
                ...
                ReleaseApprovalDigestSupport.line(
                    ...
                    ReleaseApprovalUpstreamContractConstants
                        .NODE_V234_MANUAL_SANDBOX_CONNECTION_BLOCKED_EXECUTION_REHEARSAL_PROFILE),
                ReleaseApprovalDigestSupport.line(
    ...
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        ...
        ReleaseApprovalContractConstants
            .RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_CONNECTION_PREFLIGHT_ECHO_MARKER_SCHEMA_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V234_MANUAL_SANDBOX_CONNECTION_BLOCKED_EXECUTION_REHEARSAL_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V234_MANUAL_SANDBOX_CONNECTION_BLOCKED_EXECUTION_REHEARSAL_PROFILE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V234_MANUAL_SANDBOX_CONNECTION_BLOCKED_EXECUTION_REHEARSAL_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V234_MANUAL_SANDBOX_CONNECTION_BLOCKED_EXECUTION_REHEARSAL_STATE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V235_MANUAL_SANDBOX_CONNECTION_PRECONDITION_INTAKE_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V235_MANUAL_SANDBOX_CONNECTION_PRECONDITION_INTAKE_PROFILE,
        true,
        ownerApprovalBoundary,
        credentialBoundary,
        schemaRehearsalBoundary,
  ...
  List<String> warningDigestWarningLines(
    ...
    return List.of(
        ReleaseApprovalDigestSupport.line(
            "managedAuditSandboxConnectionPreconditionReceiptWarnings", receipt.receiptWarnings()));
  }
  ...
  List<String> warningDigestBoundaryLines(
    ...
    return List.of(
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionPreconditionReceiptDigest", receipt.receiptDigest()),
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionPreconditionOwnerApprovalArtifactProvidedByJava",
  ...
  private static ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        .RehearsalSandboxConnectionPreconditionOwnerApprovalBoundary(
        OWNER_APPROVAL_ARTIFACT_ID_FIELD, true, false, false, false, false);
  }
  ...
  private static ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        .RehearsalSandboxConnectionPreconditionCredentialBoundary(
        CREDENTIAL_HANDLE_NAME_FIELD, true, true, false, false, false, false);
  }
  ...
  private static ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        .RehearsalSandboxConnectionPreconditionSchemaBoundary(
        SCHEMA_REHEARSAL_ID_FIELD, true, false, false, false);
  }
