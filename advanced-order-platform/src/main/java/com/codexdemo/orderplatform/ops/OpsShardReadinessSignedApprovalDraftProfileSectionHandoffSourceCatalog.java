...
final class OpsShardReadinessSignedApprovalDraftProfileSectionHandoffSourceCatalog {
    ...
    static List<OpsShardReadinessSignedApprovalDraftProfileSectionHandoffResponse.HandoffSource> sources(
            OpsShardReadinessSignedApprovalDraftProfileSectionRegistryResponse registry
    ) {
        return List.of(new OpsShardReadinessSignedApprovalDraftProfileSectionHandoffResponse.HandoffSource(
                1,
