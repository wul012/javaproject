...
public record OpsShardReadinessSandboxConnectionPrecheckUpstreamReceiptVerificationManifestResponse(
  ...
  public record PrecheckField(
      String id, String fieldName, String value, boolean echoed, boolean carriesCredentialValue) {}

  public record BoundaryGuard(
      String name, String evidence, boolean expectedValue, boolean actualValue, boolean passed) {}

  public record CodeHealthGate(String name, String evidence, boolean passed) {}
