...
final class ReleaseApprovalManagedAuditSandboxConnectionFakeTransportDryRunPacketEchoMarkerBuilder {
  ...
  private static final List<String> REQUEST_FIELD_NAMES =
      List.of(
          "requestId",
          "operation",
          "transportKind",
  ...
  private static final List<String> RESPONSE_FIELD_NAMES =
      List.of(
          "requestId",
          "status",
          "code",
  ...
  private static final List<String> FAILURE_MAPPING_CODES =
      List.of(
  ...
  private static final List<String> WARNING_DIGEST_WARNING_INPUT_NAMES =
      List.of("managedAuditSandboxConnectionFakeTransportDryRunPacketEchoMarkerWarnings");
  ...
  ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
    ...
    ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
            .RehearsalSandboxConnectionFakeTransportCleanupBoundary
        cleanupBoundary = cleanupBoundary();
    ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
            .RehearsalSandboxConnectionFakeTransportSideEffectBoundary
        sideEffectBoundary = sideEffectBoundary();

    List<String> markerWarnings = new ArrayList<>();
    if (!sourceReceiptAccepted) {
      markerWarnings.add(
          "NODE_V257_SOURCE_DISABLED_ADAPTER_CLIENT_PRECHECK_ECHO_RECEIPT_NOT_READY");
    }
            ...
            List.of(
                ...
                ReleaseApprovalDigestSupport.line(
                    ...
                    ReleaseApprovalUpstreamContractConstants
                        .NODE_V255_FAKE_TRANSPORT_DRY_RUN_PACKET_PROFILE),
    ...
    return new ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
        ...
        ReleaseApprovalContractConstants
            .RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_CONNECTION_DISABLED_ADAPTER_CLIENT_PRECHECK_ECHO_RECEIPT_SCHEMA_VERSION,
        ReleaseApprovalUpstreamContractConstants.NODE_V255_FAKE_TRANSPORT_DRY_RUN_PACKET_VERSION,
        ReleaseApprovalUpstreamContractConstants.NODE_V255_FAKE_TRANSPORT_DRY_RUN_PACKET_PROFILE,
        ReleaseApprovalUpstreamContractConstants.NODE_V255_FAKE_TRANSPORT_DRY_RUN_PACKET_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants.NODE_V255_FAKE_TRANSPORT_DRY_RUN_PACKET_STATE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V256_FAKE_TRANSPORT_PACKET_ARCHIVE_VERIFICATION_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V256_FAKE_TRANSPORT_PACKET_ARCHIVE_VERIFICATION_PROFILE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V256_FAKE_TRANSPORT_PACKET_ARCHIVE_VERIFICATION_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V256_FAKE_TRANSPORT_PACKET_ARCHIVE_VERIFICATION_STATE,
        ReleaseApprovalUpstreamContractConstants
  ...
  List<String> warningDigestBoundaryLines(
    ...
    return List.of(
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionFakeTransportDryRunPacketEchoMarkerDigest", marker.markerDigest()),
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionFakeTransportDryRunPacketRequestShapeFieldCount",
  ...
  private static ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
    ...
    return new ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
        .RehearsalSandboxConnectionFakeTransportTimeoutBoundary(
        TIMEOUT_BUDGET_MS, true, "operator-review-field", false, false, true);
  }
  ...
  private static ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
    ...
    return new ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
        .RehearsalSandboxConnectionFakeTransportCleanupBoundary(
        true, false, false, false, CLEANUP_ARTIFACT_COUNT, true, false);
  }
  ...
  private static boolean requestShapeEchoed(
    ...
    return REQUEST_ID.equals(requestShape.requestId())
        ...
        && "ORDEROPS_MANAGED_AUDIT_SANDBOX_CREDENTIAL_HANDLE"
            .equals(requestShape.credentialHandle())
