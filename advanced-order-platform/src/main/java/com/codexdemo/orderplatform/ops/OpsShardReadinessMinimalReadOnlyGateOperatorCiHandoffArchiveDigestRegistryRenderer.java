...
final class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestRegistryRenderer {
    ...
    static List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestRegistryResponse
        ...
        return List.of(
                OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestSourceRenderer
                        .render(sources),
                OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestSectionRenderer
                        .render(digestSections),
                ...
                OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestScorecardRenderer
                        .render(scorecard)
        );
    }
}
