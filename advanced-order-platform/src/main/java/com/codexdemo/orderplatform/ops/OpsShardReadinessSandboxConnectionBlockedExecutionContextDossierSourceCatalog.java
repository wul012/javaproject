...
final class OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierSourceCatalog {
    ...
    static List<OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierResponse.SourceReceipt>
        ...
        return List.of(new OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierResponse.SourceReceipt(
