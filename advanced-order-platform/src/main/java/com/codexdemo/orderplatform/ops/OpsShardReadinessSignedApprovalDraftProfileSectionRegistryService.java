...
public class OpsShardReadinessSignedApprovalDraftProfileSectionRegistryService {
    ...
    private final OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftAuthoringReadinessCatalogService
            authoringReadinessService;
    private final OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftInstructionPreflightCatalogService
    ...
    public OpsShardReadinessSignedApprovalDraftProfileSectionRegistryResponse registry() {
        var sources = OpsShardReadinessSignedApprovalDraftProfileSectionSourceCatalog.sources(
        ...
        var fieldEntries = OpsShardReadinessSignedApprovalDraftProfileSectionFieldCatalog.fieldEntries(sections);
        return OpsShardReadinessSignedApprovalDraftProfileSectionRegistrySupport.response(
                ...
                OpsShardReadinessSignedApprovalDraftProfileSectionRouteLockCatalog.routeFieldLocks(sections),
                OpsShardReadinessSignedApprovalDraftProfileSectionGateCatalog.gates(),
                List.of("signed-approval-draft-profile-section-registry-service-assembled-from-five-read-only-routes"));
    }
}
