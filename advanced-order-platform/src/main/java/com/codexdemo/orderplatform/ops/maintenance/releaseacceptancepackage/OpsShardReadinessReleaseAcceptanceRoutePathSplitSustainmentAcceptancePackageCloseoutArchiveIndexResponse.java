...
public
record OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutArchiveIndexResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record SourceSnapshot(String source, String version, String endpoint, String status) {}

  public record CriteriaEcho(String name, String evidence, String status) {}

  public record ArchiveIndexItem(String item, String location, String retention, boolean ready) {}

  public record VerificationGate(String gate, String evidence, boolean passed) {}
