...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellStopPrerequisiteDecisionEchoRecords.RehearsalRuntimeShellChainDecisionNecessityProof;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellStopPrerequisiteDecisionEchoRecords.RehearsalRuntimeShellChainNoGoCondition;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellStopPrerequisiteDecisionEchoRecords.RehearsalRuntimeShellChainPrerequisite;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellStopPrerequisiteDecisionEchoRecords.RehearsalRuntimeShellChainStopPrerequisiteDecisionRecord;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellStopPrerequisiteDecisionEchoRecords.RehearsalRuntimeShellStopPrerequisiteDecisionChecks;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellStopPrerequisiteDecisionEchoRecords.RehearsalRuntimeShellStopPrerequisiteSideEffectBoundary;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellStopPrerequisiteDecisionEchoRecords.RehearsalRuntimeShellStopPrerequisiteSourcePostDecisionPlanIntakeEcho;
import java.util.List;

final
class ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellStopPrerequisiteDecisionEchoSupport {
  ...
  private
  ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellStopPrerequisiteDecisionEchoSupport() {}
  ...
  RehearsalManagedAuditSandboxEndpointCredentialResolverRuntimeShellStopPrerequisiteDecisionEchoReceipt
    ...
    String receiptDigest =
        receiptDigest(source, sourceEcho, decisionRecord, checks, boundary, readiness);
  ...
  private static RehearsalRuntimeShellStopPrerequisiteDecisionChecks checks(
    ...
    boolean sourceSideEffectsClosed =
        sourceEcho.noCredentialReadEchoed()
    ...
    boolean decisionSelectsGate =
        "require-explicit-approval-prerequisites-before-runtime-shell"
                .equals(decisionRecord.decision())
    ...
    boolean prerequisitesDocumented =
  ...
  private static EchoWorkflowReadiness readiness(
    ...
    return workflowReadiness(
        workflowStep(
            ...
            checks.sourcePostDecisionPlanIntakeEchoReady()
                && sourceEcho.readyForNodeV302PostDecisionPlanIntakeUpstreamEchoVerification()),
        ...
        workflowStep(
            ...
            !decisionRecord.allowsCredentialValueRead() && !boundary.credentialValueRead()),
        workflowStep(
            "noRawEndpointParseEchoed",
            !decisionRecord.allowsRawEndpointUrlParse() && !boundary.rawEndpointUrlParsed()),
        workflowStep(
        ...
        workflowStep(
            ...
            !decisionRecord.allowsApprovalLedgerWrite()
                ...
                && !boundary.schemaMigrationExecuted()),
        workflowStep(
            "noMiniKvWriteOrAuthorityEchoed", checks.miniKvWriteOrAuthorityStillForbidden()),
        workflowStep(
    ...
    return ReleaseApprovalDigestSupport.digest(
        List.of(
            ...
            ReleaseApprovalDigestSupport.line(
                "sourceReceiptDigest", sourceEcho.sourceReceiptDigest()),
            ReleaseApprovalDigestSupport.line(
  ...
  private static List<String> receiptWarnings(EchoWorkflowReadiness readiness) {
    return ReleaseApprovalDigestSupport.warnings(
        ...
        readiness.warningIfMissing(
            "nodeV304DecisionRecordEchoed", "NODE_V304_STOP_PREREQUISITE_DECISION_NOT_ECHOED"),
        readiness.warningIfMissing(
            "requiredPrerequisitesEchoed", "RUNTIME_SHELL_PREREQUISITES_NOT_DOCUMENTED"),
        readiness.warningIfMissing(
            "noGoConditionsEchoed", "STOP_PREREQUISITE_NO_GO_CONDITIONS_UNSTABLE"),
        readiness.warningIfMissing(
            "parallelJavaMiniKvEchoRequestEchoed", "PARALLEL_JAVA_MINIKV_ECHO_NOT_RECOMMENDED"),
        readiness.warningIfMissing(
            "noMiniKvWriteOrAuthorityEchoed", "MINIKV_WRITE_OR_AUTHORITY_BOUNDARY_OPEN"));
  }
}
