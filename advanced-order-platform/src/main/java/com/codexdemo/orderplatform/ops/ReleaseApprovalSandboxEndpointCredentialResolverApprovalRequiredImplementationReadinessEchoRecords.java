...
public final class ReleaseApprovalSandboxEndpointCredentialResolverApprovalRequiredImplementationReadinessEchoRecords {

    private ReleaseApprovalSandboxEndpointCredentialResolverApprovalRequiredImplementationReadinessEchoRecords() {
    }

    public record RehearsalManagedAuditSandboxEndpointCredentialResolverApprovalRequiredImplementationReadinessEchoReceipt(
            ...
            String consumedByNodeCredentialResolverApprovalRequiredImplementationReadinessReviewMarkdownEndpoint,
    ...
    public record RehearsalSandboxEndpointCredentialResolverApprovalRequiredImplementationReadinessReviewSourceEcho(
            String sourceVersion,
            String profileVersion,
            String reviewState,
            boolean readyForManagedAuditManualSandboxConnectionCredentialResolverApprovalRequiredImplementationReadinessReview,
    ...
    public record RehearsalSandboxEndpointCredentialResolverApprovalRequiredBoundaryUpstreamEchoVerificationSource(
            String sourceVersion,
            String profileVersion,
    ...
    public record RehearsalSandboxEndpointCredentialResolverApprovalRequiredImplementationReadinessReview(
            String reviewDigest,
            String reviewMode,
            String sourceSpan,
    ...
    public record RehearsalSandboxEndpointCredentialResolverApprovalRequiredImplementationBoundaryReadiness(
            String code,
    ...
    public record RehearsalSandboxEndpointCredentialResolverApprovalRequiredImplementationReadinessChecks(
    ...
    public record RehearsalSandboxEndpointCredentialResolverApprovalRequiredImplementationReadinessSummary(
            int checkCount,
    ...
    public record RehearsalSandboxEndpointCredentialResolverApprovalRequiredImplementationReadinessSideEffectBoundary(
            boolean implementationReadinessReviewOnly,
            boolean readOnlyImplementationReadinessReview,
            boolean readyForManagedAuditResolverImplementation,
            boolean readyForManagedAuditSandboxAdapterConnection,
