...
final class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightSupport {
    ...
    private OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightSupport() {
    }
    ...
    response(
            ...
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightResponse
                    .AcceptanceControl> controls,
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightResponse
                    .ComparisonGate> gates,
        ...
        int passedControlCount = (int) controlCopy.stream()
                .filter(control -> "passed".equals(control.status())).count();
        List<String> checks = new ArrayList<>();
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-lane-count-"
                + laneCopy.size());
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-passed-lane-count-"
                + passedLaneCount);
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-acceptance-control-count-"
                + controlCopy.size());
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-passed-acceptance-control-count-"
                + passedControlCount);
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-source-plan-" + SOURCE_PLAN);
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-source-node-submission-"
                + SOURCE_NODE_SUBMISSION_PREFLIGHT_VERSION);
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-source-java-submission-"
                + SOURCE_JAVA_SUBMISSION_PREFLIGHT_VERSION);
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-source-java-closeout-"
                + SOURCE_JAVA_SUBMISSION_CLOSEOUT_VERSION);
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-no-package-acceptance");
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-no-draft-text-parsing");
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-no-detached-signature-parsing");
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-no-approval-grant");
        checks.add("signed-approval-artifact-draft-text-package-comparison-preflight-no-runtime-or-sibling-mutation");
    ...
    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightResponse
        ...
        return new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightResponse
                .ComparisonLane(code, versionRange, comparisonLane, comparisonQuestion, acceptanceControl,
                sourceEndpoint, "passed");
    }

    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightResponse
            .AcceptanceControl control(String code, String category, String control, String rejectionCode) {
        return new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightResponse
