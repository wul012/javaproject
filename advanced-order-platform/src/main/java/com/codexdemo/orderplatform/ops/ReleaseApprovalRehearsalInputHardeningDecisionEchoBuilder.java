...
final class ReleaseApprovalRehearsalInputHardeningDecisionEchoBuilder {
    ...
    ReleaseApprovalRehearsalResponseRecords.RehearsalInputHardeningDecisionEcho build(
        ...
        return new ReleaseApprovalRehearsalResponseRecords.RehearsalInputHardeningDecisionEcho(
                OpsEvidenceService.RELEASE_APPROVAL_REHEARSAL_INPUT_HARDENING_DECISION_ECHO_VERSION,
                "Node v329",
                OpsEvidenceService.NODE_V329_INPUT_HARDENING_DECISION_PROFILE_VERSION,
                OpsEvidenceService.NODE_V329_INPUT_HARDENING_DECISION_STATE,
                OpsEvidenceService.NODE_V329_INPUT_HARDENING_DECISION,
                OpsEvidenceService.NODE_V329_INPUT_HARDENING_DECISION_DIGEST,
