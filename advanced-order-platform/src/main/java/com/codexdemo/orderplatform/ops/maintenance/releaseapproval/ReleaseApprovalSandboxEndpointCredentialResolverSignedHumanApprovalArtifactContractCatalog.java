...
final
class ReleaseApprovalSandboxEndpointCredentialResolverSignedHumanApprovalArtifactContractCatalog {
  ...
  private static final List<RequiredFieldTemplate> REQUIRED_FIELDS =
      List.of(
          ...
          requiredField(
              ...
              "Bind the signed artifact to the approval review chain."),
          requiredField(
              "operator_identity_handle",
              "Operator identity handle",
          ...
          requiredField(
              ...
              "boolean assertion plus evidence handle",
              "Assert this contract path sends no HTTP/TCP request."),
          requiredField(
  ...
  private static final List<ProhibitedFieldTemplate> PROHIBITED_FIELDS =
      List.of(
          prohibitedField(
              "credential_value",
              "Credential values must not enter the signed approval artifact.",
              "CREDENTIAL_VALUE_PRESENT"),
          prohibitedField(
              "raw_endpoint_url",
              "The contract may reference endpoint handles, not raw endpoint URLs.",
              "RAW_ENDPOINT_URL_PRESENT"),
          prohibitedField(
              "signing_private_key",
              "A signed artifact may reference a signer handle, not a private key.",
          ...
          prohibitedField(
              ...
              "No HTTP/TCP payload may be prepared or sent by v314.",
  ...
  private static final List<NoGoTemplate> NO_GO_BOUNDARIES =
      List.of(
          ...
          noGo(
              ...
              "v314 must not instantiate secret providers or resolver clients."),
  ...
  private static final List<String> SOURCE_COMPLETED_PREREQUISITE_IDS =
      List.of("java-mini-kv-decision-echo");
  ...
  private static final List<String> WARNING_CODES =
      List.of("SIGNED_ARTIFACT_CONTRACT_DOES_NOT_CLOSE_ALL_PREREQUISITES");
  ...
  static List<RehearsalSignedHumanApprovalArtifactRequiredField> requiredFields() {
    return REQUIRED_FIELDS.stream()
        .map(
            template ->
                new RehearsalSignedHumanApprovalArtifactRequiredField(
                    template.id(),
                    template.label(),
                    true,
  ...
  static List<RehearsalSignedHumanApprovalArtifactProhibitedField> prohibitedFields() {
    return PROHIBITED_FIELDS.stream()
        .map(
            template ->
                new RehearsalSignedHumanApprovalArtifactProhibitedField(
  ...
  static List<RehearsalSignedHumanApprovalArtifactRejectionReason> rejectionReasons() {
    return REJECTION_REASONS.stream()
        .map(
            template ->
                new RehearsalSignedHumanApprovalArtifactRejectionReason(
  ...
  static List<RehearsalSignedHumanApprovalArtifactNoGoBoundary> noGoBoundaries() {
    return NO_GO_BOUNDARIES.stream()
        .map(
            template ->
                new RehearsalSignedHumanApprovalArtifactNoGoBoundary(
  ...
  static List<RehearsalSignedHumanApprovalArtifactUpstreamEchoRequest> upstreamEchoRequests() {
    return UPSTREAM_ECHO_REQUESTS.stream()
        .map(
            template ->
                new RehearsalSignedHumanApprovalArtifactUpstreamEchoRequest(
