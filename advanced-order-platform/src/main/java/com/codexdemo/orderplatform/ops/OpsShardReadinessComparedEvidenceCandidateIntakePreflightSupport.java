...
final class OpsShardReadinessComparedEvidenceCandidateIntakePreflightSupport {
    ...
    static final String INTAKE_STATE = "waiting-for-real-compared-package-evidence-candidate-document";
    ...
    static OpsShardReadinessComparedEvidenceCandidateIntakePreflightResponse response(
        ...
        checks.add("compared-evidence-candidate-intake-preflight-required-field-count-" + REQUIRED_FIELD_COUNT);
        ...
        checks.add("compared-evidence-candidate-intake-preflight-source-node-" + SOURCE_NODE_CANDIDATE_BLUEPRINT_VERSION);
        checks.add("compared-evidence-candidate-intake-preflight-source-java-" + SOURCE_JAVA_CANDIDATE_BLUEPRINT_VERSION);
