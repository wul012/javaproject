...
public class OpsShardReadinessRouteCleanupCompletionCertificateService {
  ...
  static final String ENDPOINT =
      RouteCleanupRoutes.BASE_PATH + RouteCleanupRoutes.COMPLETION_CERTIFICATE;
  ...
  public OpsShardReadinessRouteCleanupCompletionCertificateResponse certificate() {
    ...
    List<OpsShardReadinessRouteCleanupCompletionCertificateResponse.CertificateClaim> claims =
        List.of(
