...
final class OpsShardReadinessCandidateDocumentProfileSectionRenderer {
    ...
    static List<OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.RenderedSection> render(
        ...
        return sections.stream()
                .map(section -> new OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.RenderedSection(
                        section.order(),
                        section.code(),
                        "### " + section.heading(),
