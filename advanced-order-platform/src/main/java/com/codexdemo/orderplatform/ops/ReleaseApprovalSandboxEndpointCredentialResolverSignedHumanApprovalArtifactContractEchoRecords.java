...
public final class ReleaseApprovalSandboxEndpointCredentialResolverSignedHumanApprovalArtifactContractEchoRecords {

    private ReleaseApprovalSandboxEndpointCredentialResolverSignedHumanApprovalArtifactContractEchoRecords() {
    }

    public record RehearsalManagedAuditSandboxEndpointCredentialResolverSignedHumanApprovalArtifactContractEchoReceipt(
    ...
    public record RehearsalSignedHumanApprovalArtifactContractEchoChecks(
            ...
            boolean readyForManagedAuditManualSandboxConnectionCredentialResolverSignedHumanApprovalArtifactContractEcho
    ) {
    }
