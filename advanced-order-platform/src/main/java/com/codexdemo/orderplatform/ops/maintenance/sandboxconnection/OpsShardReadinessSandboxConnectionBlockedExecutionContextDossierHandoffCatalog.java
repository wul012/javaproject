...
final class OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierHandoffCatalog {
  ...
  static List<OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierResponse.HandoffNote>
      notes() {
    return List.of(
        note(
            "node",
  ...
  private static OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierResponse
    ...
    return new OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierResponse.HandoffNote(
        audience, note, true);
  }
}
