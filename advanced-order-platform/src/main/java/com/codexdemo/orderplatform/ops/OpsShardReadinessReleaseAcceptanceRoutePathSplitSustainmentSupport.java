...
final class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentSupport {
    ...
    static OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse response(
            ...
            List<OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse.OwnershipRule>
                    ownershipRules,
            List<OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse.DriftGuard> driftGuards,
        ...
        var checks = checks(source, sourceSnapshotCopy, ownershipCopy, driftCopy, boundaryCopy, ciCopy,
                consumerCopy, scorecardCopy, markdownCopy);
        String status = status(source, sourceSnapshotCopy, ownershipCopy, driftCopy, boundaryCopy, ciCopy,
                consumerCopy, scorecardCopy, markdownCopy);
    ...
    private static List<String> checks(
        ...
        checks.add("release-acceptance-route-path-split-sustainment-node-parallel-plan-"
                + NODE_PARALLEL_PLAN);
        checks.add("release-acceptance-route-path-split-sustainment-source-closeout-version-"
                + source.version());
        checks.add("release-acceptance-route-path-split-sustainment-source-closeout-status-"
                + source.status());
        checks.add("release-acceptance-route-path-split-sustainment-source-split-version-"
                + source.sourceSplitVersion());
        checks.add("release-acceptance-route-path-split-sustainment-source-route-count-"
                + source.routePathCount());
        checks.add("release-acceptance-route-path-split-sustainment-source-compatibility-count-"
                + source.compatibilityCheckCount());
        checks.add("release-acceptance-route-path-split-sustainment-source-snapshot-count-"
                + sourceSnapshots.size());
        checks.add("release-acceptance-route-path-split-sustainment-ownership-rule-count-"
                + ownershipRules.size());
        checks.add("release-acceptance-route-path-split-sustainment-enforced-ownership-rule-count-"
                + count(ownershipRules, OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse
                .OwnershipRule::enforced));
        checks.add("release-acceptance-route-path-split-sustainment-drift-guard-count-"
                + driftGuards.size());
        checks.add("release-acceptance-route-path-split-sustainment-locked-drift-guard-count-"
                + count(driftGuards, OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse
                .DriftGuard::locked));
        checks.add("release-acceptance-route-path-split-sustainment-boundary-guard-count-"
                + boundaryGuards.size());
        checks.add("release-acceptance-route-path-split-sustainment-locked-boundary-guard-count-"
                + count(boundaryGuards, OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse
                .BoundaryGuard::locked));
        checks.add("release-acceptance-route-path-split-sustainment-ci-gate-count-" + ciGates.size());
        checks.add("release-acceptance-route-path-split-sustainment-required-ci-gate-count-"
                + count(ciGates, OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse
                .CiGate::required));
        checks.add("release-acceptance-route-path-split-sustainment-consumer-handoff-count-"
                + consumerHandoffs.size());
        checks.add("release-acceptance-route-path-split-sustainment-ready-consumer-handoff-count-"
                + count(consumerHandoffs, OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse
                .ConsumerHandoff::ready));
        checks.add("release-acceptance-route-path-split-sustainment-scorecard-entry-count-"
                + scorecard.size());
        checks.add("release-acceptance-route-path-split-sustainment-passed-scorecard-entry-count-"
                + count(scorecard, OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse
                .ScorecardEntry::passed));
        checks.add("release-acceptance-route-path-split-sustainment-markdown-section-count-"
    ...
    private static String status(
        ...
        boolean allLocked = ownershipRules.stream()
                .allMatch(OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse
                        .OwnershipRule::enforced)
                && driftGuards.stream()
                .allMatch(OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse
                        .DriftGuard::locked)
                ...
                .allMatch(OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse
                        .BoundaryGuard::locked)
                && ciGates.stream()
                .allMatch(OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse.CiGate::required)
