...
final
class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutArchiveIndexItemCatalog {
  ...
  static List<
    ...
    return List.of(
        ...
        item(
            "accepted-criteria-ledger",
            "criteria-count=" + source.acceptedCriteriaCount(),
            "criteria-retention",
            source.acceptedCriteriaCount() == 7),
        item(
            "receipt-markdown-lines",
            "markdown-lines=" + source.markdownLineCount(),
            "markdown-retention",
            source.markdownLineCount() == 7),
        item(
            "receipt-checks",
            "checks=" + source.checks().size(),
            "check-retention",
            source
                .checks()
                .contains(
  ...
  OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutArchiveIndexResponse
          .ArchiveIndexItem
      item(String item, String location, String retention, boolean ready) {
