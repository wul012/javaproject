...
public final class ReleaseApprovalSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPacketEchoRecords {

    private ReleaseApprovalSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPacketEchoRecords() {
    }

    public record RehearsalManagedAuditSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPacketEchoReceipt(
    ...
    public record RehearsalHumanApprovalArtifactReviewRejectionReason(
            String code,
            String message
    ) {
    }
    ...
    public record RehearsalHumanApprovalArtifactReviewChecks(
            ...
            boolean readyForManagedAuditManualSandboxConnectionCredentialResolverHumanApprovalArtifactReviewPacket
    ) {
    }
