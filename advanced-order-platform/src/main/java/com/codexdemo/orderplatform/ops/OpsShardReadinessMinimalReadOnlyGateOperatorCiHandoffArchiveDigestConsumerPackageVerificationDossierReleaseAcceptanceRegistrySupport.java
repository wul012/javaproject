...
final class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistrySupport {
    ...
    private OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistrySupport() {
    }
    ...
    static OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
            response(
                    ...
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
                            .SourceDossierSnapshot> sourceDossiers,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
                            .ReleaseReadinessGate> readinessGates,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
                            .EvidenceChainEntry> evidenceChain,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
                            .SignoffLane> signoffLanes,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
                            .CiReplayLane> ciReplayLanes,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
                            .BoundaryControl> boundaryControls,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
                            .RetentionPolicy> retentionPolicies,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
                            .ReplayDecision> replayDecisions,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
                            .CloseoutCheckpoint> closeoutCheckpoints,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse
        ...
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-source-plan-"
                + SOURCE_PLAN);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-required-archive-"
                + REQUIRED_ARCHIVE_VERIFICATION_PLAN);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-operator-plan-"
                + OPERATOR_HANDOFF_PLAN);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-source-dossier-version-"
                + source.version());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-source-dossier-status-"
                + source.status());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-source-dossier-count-"
                + sourceDossierCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-readiness-gate-count-"
                + readinessGateCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-passed-readiness-gate-count-"
                + passedReadinessGateCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-evidence-chain-count-"
                + evidenceChainCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-passed-evidence-chain-count-"
                + passedEvidenceChainCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-signoff-lane-count-"
                + signoffLaneCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-ready-signoff-lane-count-"
                + readySignoffLaneCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-ci-replay-lane-count-"
                + ciReplayLaneCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-read-only-ci-replay-lane-count-"
                + readOnlyCiReplayLaneCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-boundary-control-count-"
                + boundaryControlCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-locked-boundary-control-count-"
                + lockedBoundaryControlCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-retention-policy-count-"
                + retentionPolicyCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-ready-retention-policy-count-"
                + readyRetentionPolicyCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-replay-decision-count-"
                + replayDecisionCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-passed-replay-decision-count-"
                + passedReplayDecisionCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-closeout-checkpoint-count-"
                + closeoutCheckpointCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-ready-closeout-checkpoint-count-"
                + readyCloseoutCheckpointCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-scorecard-count-"
                + scorecardCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-passed-scorecard-count-"
                + passedScorecardCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-markdown-section-count-"
                + markdownSectionCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-consumes-verification-dossier");
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-no-upstream-autostart");
        ...
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-no-raw-endpoint-resolution");
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-no-managed-audit-http");
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-no-runtime-execution");
        checks.add("minimal-read-only-gate-operator-ci-handoff-release-acceptance-no-deployment-rollback");
