...
public final class ReleaseApprovalSandboxEndpointCredentialResolverFakeShellArchiveEchoRecords {
  ...
  public record RehearsalManagedAuditSandboxEndpointCredentialResolverFakeShellArchiveEchoReceipt(
      ...
      String
          consumedByNodeSandboxEndpointCredentialResolverFakeShellArchiveVerificationMarkdownEndpoint,
      ...
      String
          sourceNodeSandboxEndpointCredentialResolverTestOnlyShellUpstreamEchoVerificationProfile,
      ...
      String
          nextNodeSandboxEndpointCredentialResolverFakeShellArchiveUpstreamEchoVerificationProfile,
  ...
  public record RehearsalSandboxEndpointCredentialResolverFakeShellArchiveSnippet(
      String id, String workspacePath, String expectedSignal, boolean matchedByNode) {}
