...
final
class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageLineageCatalog {
  ...
  static List<
          OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse
              .VersionLineage>
      lineage(OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse source) {
  ...
  OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse
          .VersionLineage
      lineage(String stage, String version, String endpoint, boolean passed) {
