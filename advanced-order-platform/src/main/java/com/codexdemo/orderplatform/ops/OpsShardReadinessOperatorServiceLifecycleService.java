...
public class OpsShardReadinessOperatorServiceLifecycleService {
    ...
    static final String ENDPOINT = "/api/v1/ops/shard-readiness/operator-service-lifecycle";
    static final String FIXTURE_ENDPOINT =
            "/contracts/java-shard-readiness-operator-service-lifecycle-v160.fixture.json";
    static final String EVIDENCE_PATH = "e/160/evidence/java-shard-readiness-operator-service-lifecycle-v160.json";
    ...
    private String lifecycleStatus(OpsShardReadinessLiveReadGatePlanResponse sourcePlan) {
        boolean passed = "passed".equals(sourcePlan.status())
                && sourcePlan.readOnly()
