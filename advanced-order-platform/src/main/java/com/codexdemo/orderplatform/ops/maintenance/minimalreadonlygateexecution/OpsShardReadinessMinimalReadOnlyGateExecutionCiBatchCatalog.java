...
final class OpsShardReadinessMinimalReadOnlyGateExecutionCiBatchCatalog {
  ...
  static List<OpsShardReadinessMinimalReadOnlyGateExecutionRegistryResponse.CiBatch> ciBatches() {
    return List.of(
        batch(
  ...
  private static OpsShardReadinessMinimalReadOnlyGateExecutionRegistryResponse.CiBatch batch(
    ...
    return new OpsShardReadinessMinimalReadOnlyGateExecutionRegistryResponse.CiBatch(
        name, order, commandFamily, scope, blocksNextBatch);
  }
}
