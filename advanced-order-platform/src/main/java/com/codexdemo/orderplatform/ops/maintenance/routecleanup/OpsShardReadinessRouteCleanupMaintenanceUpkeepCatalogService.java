...
public class OpsShardReadinessRouteCleanupMaintenanceUpkeepCatalogService {
  ...
  static final String ENDPOINT =
      RouteCleanupRoutes.BASE_PATH + RouteCleanupRoutes.MAINTENANCE_UPKEEP_CATALOG;
  static final String PROFILE = "java-shard-readiness-route-cleanup-maintenance-upkeep-catalog.v1";
