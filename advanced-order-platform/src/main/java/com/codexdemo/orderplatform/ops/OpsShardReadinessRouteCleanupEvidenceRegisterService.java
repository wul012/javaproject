...
public class OpsShardReadinessRouteCleanupEvidenceRegisterService {
    ...
    public OpsShardReadinessRouteCleanupEvidenceRegisterResponse register() {
        List<OpsShardReadinessRouteCleanupEvidenceRegisterResponse.RegisteredEvidence> registeredEvidence =
                endpointManifestService.manifest().endpoints().stream()
                        .map(endpoint -> new OpsShardReadinessRouteCleanupEvidenceRegisterResponse.RegisteredEvidence(
