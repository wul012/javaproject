...
final
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftAuthoringReadinessFoundationRequirementCatalog {
  ...
  static List<
    ...
    return List.of(
        ...
        requirement(
            ...
            "sourceArtifactPreflightDigest",
            "Pin artifact preflight digest for future citation.",
        ...
        requirement(
            ...
            "Pin signed approval template digest before wording exists.",
        ...
        requirement(
            ...
            "Pin approval packet review digest as source evidence.",
        ...
        requirement(
            ...
            "operatorIdentityRef",
            "Expose reviewed operator identity for later manual authoring.",
        ...
        requirement(
            ...
            "operatorRoleRef",
            "Expose reviewed operator role separately from approval capture.",
        ...
        requirement(
            ...
            "captureWindowId",
            "Bind planned capture window id without opening a window.",
        ...
        requirement(
            ...
            "Carry channel policy while write routes remain disabled.",
        ...
        requirement(
            ...
            "Document expected signature algorithm policy.",
        ...
        requirement(
            ...
            "Require detached signature handling to remain external.",
        ...
        requirement(
            ...
            "Carry signature redaction policy without raw signature material.",
        ...
        requirement(
            ...
            "Pin approval statement digest without generating text.",
        ...
        requirement(
            ...
            "Expose source evidence version for later manual citation.",
