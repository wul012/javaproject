...
public final class ReleaseApprovalSandboxEndpointCredentialResolverNoNetworkSafetyFixtureContractEchoRecords {

    private ReleaseApprovalSandboxEndpointCredentialResolverNoNetworkSafetyFixtureContractEchoRecords() {
    }

    public record RehearsalManagedAuditSandboxEndpointCredentialResolverNoNetworkSafetyFixtureContractEchoReceipt(
    ...
    public record RehearsalNoNetworkSafetyFixtureContractEchoChecks(
            ...
            boolean readyForManagedAuditManualSandboxConnectionCredentialResolverNoNetworkSafetyFixtureContractEcho
    ) {
    }
