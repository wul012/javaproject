...
final class ReleaseApprovalManagedAuditAdapterImplementationGuardReceiptBuilder {
    ...
    private static final String NODE_V220_PROFILE =
    ...
    ReleaseApprovalRehearsalResponse.RehearsalManagedAuditAdapterImplementationGuardReceipt
        ...
        boolean sourceReceiptAccepted =
                OpsEvidenceService.RELEASE_APPROVAL_REHEARSAL_OPS_EVIDENCE_SERVICE_QUALITY_SPLIT_RECEIPT_VERSION
        ...
        String guardDigest = ReleaseApprovalDigestSupport.digest(List.of(
                ...
                ReleaseApprovalDigestSupport.line("sourceQualitySplitSchemaVersion", SOURCE_SCHEMA_VERSION),
                ReleaseApprovalDigestSupport.line("consumedByNodeDisabledShellVersion", NODE_V220_VERSION),
                ReleaseApprovalDigestSupport.line("consumedByNodeDisabledShellProfile", NODE_V220_PROFILE),
                ReleaseApprovalDigestSupport.line("consumedByNodeDisabledShellState", "disabled-shell-ready"),
                ReleaseApprovalDigestSupport.line("nodeV220SelectedAdapterDisabled", nodeV220SelectedAdapterDisabled),
                ReleaseApprovalDigestSupport.line("nodeV220LocalDryRunOnlyDeclared", nodeV220LocalDryRunOnlyDeclared),
                ReleaseApprovalDigestSupport.line("nodeV220AppendWritten", nodeV220AppendWritten),
                ReleaseApprovalDigestSupport.line("nodeV220QueryReturnedRecords", nodeV220QueryReturnedRecords),
                ReleaseApprovalDigestSupport.line(
                        "nodeV220ExternalManagedAuditAccessed",
                        nodeV220ExternalManagedAuditAccessed
                ),
                ...
                ReleaseApprovalDigestSupport.line("javaApprovalLedgerWritten", javaApprovalLedgerWritten),
                ReleaseApprovalDigestSupport.line("javaManagedAuditStoreWritten", javaManagedAuditStoreWritten),
