...
public class OpsShardReadinessDeclaredOperatorLifecycleService {
  ...
  public static final String ENDPOINT = "/api/v1/ops/shard-readiness/declared-operator-lifecycle";
  ...
  public static final String EVIDENCE_PATH =
      "e/161/evidence/java-shard-readiness-declared-operator-lifecycle-v161.json";
