...
public class OpsShardReadinessRouteCleanupMaintenanceArchiveRetentionCalendarService {
    ...
    public OpsShardReadinessRouteCleanupMaintenanceArchiveRetentionCalendarResponse calendar() {
        List<OpsShardReadinessRouteCleanupMaintenanceArchiveRetentionCalendarResponse.ArchiveRetentionEntry>
                entries = OpsShardReadinessRouteCleanupMaintenanceUpkeepCatalog.items().stream()
                .map(this::entry)
                .toList();
    ...
    private OpsShardReadinessRouteCleanupMaintenanceArchiveRetentionCalendarResponse.ArchiveRetentionEntry entry(
    ...
    private String status(
            List<OpsShardReadinessRouteCleanupMaintenanceArchiveRetentionCalendarResponse
                    .ArchiveRetentionEntry> entries,
            int nextReviewVersion
    ) {
        boolean passed = entries.size() == OpsShardReadinessRouteCleanupMaintenanceUpkeepCatalog.items().size()
                ...
                && nextReviewVersion > OpsShardReadinessRouteCleanupMaintenanceUpkeepCatalog.latestRouteVersion()
