...
public class OpsShardReadinessRouteCleanupMaintenanceBoundaryReportService {
    ...
    public OpsShardReadinessRouteCleanupMaintenanceBoundaryReportResponse report() {
        ...
        List<OpsShardReadinessRouteCleanupMaintenanceBoundaryReportResponse.BoundaryRule> rules = List.of(
        ...
        boolean passed = receipt.status().equals("passed")
                && guard.status().equals("passed")
                && rules.stream().noneMatch(OpsShardReadinessRouteCleanupMaintenanceBoundaryReportResponse
                        .BoundaryRule::allowed);
