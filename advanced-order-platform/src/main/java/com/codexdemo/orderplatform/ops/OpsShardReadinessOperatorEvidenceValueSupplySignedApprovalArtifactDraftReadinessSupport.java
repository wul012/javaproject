...
final class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessSupport {
    ...
    private OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessSupport() {
    }

    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessResponse response(
            String version,
            String endpoint,
            String profile,
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessResponse.ReadinessItem>
                    readinessItems,
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessResponse.OwnershipRule>
                    ownershipRules,
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessResponse.DraftGate>
                    gates,
        ...
        int passedItemCount = (int) itemCopy.stream()
        ...
        checks.add("signed-approval-artifact-draft-readiness-source-artifact-preflight-"
                + SOURCE_ARTIFACT_PREFLIGHT_VERSION);
        checks.add("signed-approval-artifact-draft-readiness-source-capture-" + SOURCE_CAPTURE_PREFLIGHT_VERSION);
    ...
    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessResponse.ReadinessItem item(
            String code,
    ...
    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessResponse.OwnershipRule
    ownership(String code, String category, String owner, String responsibility, String enforcement) {
        return new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessResponse
                .OwnershipRule(code, category, owner, responsibility, enforcement);
    }

    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessResponse.DraftGate gate(
            String code,
            String category,
            String gate,
            String enforcement
