...
final class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentConsumerCatalog {
    ...
    static List<OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse.ConsumerHandoff> handoffs(
    ...
    private static OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse.ConsumerHandoff handoff(
            String consumer,
            String handoffRule,
            String expectedUse,
            boolean ready
