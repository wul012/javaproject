...
public
record OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageIntakeResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record IntakeGate(String code, String category, String gate, String enforcement) {}
}
