...
@Service
public class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutReceiptService {
    ...
    private final OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageService sourceService;

    public OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutReceiptService(
            OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageService sourceService
    ) {
    ...
    public OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutReceiptResponse
        ...
        var criteria = OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutReceiptCriteriaCatalog
                .criteria(source);
        var markdownLines = OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutReceiptRenderer
                .render(criteria);
        boolean accepted = "passed".equals(source.status())
    ...
    private List<String> checks(
            ...
            List<OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutReceiptResponse
        ...
        checks.add("release-acceptance-route-path-split-package-closeout-node-parallel-plan-Node v1879-v1903");
        checks.add("release-acceptance-route-path-split-package-closeout-source-version-" + source.version());
        checks.add("release-acceptance-route-path-split-package-closeout-source-status-" + source.status());
        checks.add("release-acceptance-route-path-split-package-closeout-criteria-count-" + criteria.size());
        checks.add("release-acceptance-route-path-split-package-closeout-markdown-line-count-"
                + markdownLines.size());
