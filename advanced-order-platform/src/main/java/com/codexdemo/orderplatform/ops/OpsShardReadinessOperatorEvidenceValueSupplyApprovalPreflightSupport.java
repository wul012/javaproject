...
final class OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightSupport {
    ...
    static OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightResponse response(
            ...
            String endpoint,
            String profile,
            List<OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightResponse.ApprovalItem> items,
            List<OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightResponse.ApprovalPolicy> policies,
            List<String> additionalChecks
    ) {
        List<OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightResponse.ApprovalItem> itemCopy =
                List.copyOf(items);
        List<OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightResponse.ApprovalPolicy> policyCopy =
        ...
        checks.add("value-supply-approval-preflight-source-value-supply-" + SOURCE_VALUE_SUPPLY_VERSION);
        checks.add("value-supply-approval-preflight-source-adapter-preflight-" + SOURCE_ADAPTER_PREFLIGHT_VERSION);
    ...
    static OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightResponse.ApprovalPolicy policy(
            String code,
            String category,
            String policy,
            String enforcement
