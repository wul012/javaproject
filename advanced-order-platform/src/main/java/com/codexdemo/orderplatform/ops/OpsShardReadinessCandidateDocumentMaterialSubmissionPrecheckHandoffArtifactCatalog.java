...
final class OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffArtifactCatalog {
    ...
    static List<OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffResponse.ArtifactReference> artifactReferences(
        ...
        return sourcePrecheck.artifacts().stream()
                .map(artifact -> new OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffResponse.ArtifactReference(
