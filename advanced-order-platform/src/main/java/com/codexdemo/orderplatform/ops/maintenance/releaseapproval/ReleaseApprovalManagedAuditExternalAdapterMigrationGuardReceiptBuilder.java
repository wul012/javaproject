...
final class ReleaseApprovalManagedAuditExternalAdapterMigrationGuardReceiptBuilder {
  ...
  private static final String NODE_V222_STATE = "local-adapter-candidate-verification-ready";
    ...
    String guardDigest =
        digest(
            List.of(
                ...
                line(
                    "ownerApprovalRequiredBeforeConnection", ownerApprovalRequiredBeforeConnection),
    ...
    if (value instanceof List<?> list) {
      return "["
          + String.join(
              ...
              list.stream()
                  .map(
                      ReleaseApprovalManagedAuditExternalAdapterMigrationGuardReceiptBuilder::value)
                  .toList())
          + "]";
    }
