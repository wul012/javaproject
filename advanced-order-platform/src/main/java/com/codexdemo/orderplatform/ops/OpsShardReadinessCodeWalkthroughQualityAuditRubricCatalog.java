...
final class OpsShardReadinessCodeWalkthroughQualityAuditRubricCatalog {
    ...
    static List<OpsShardReadinessCodeWalkthroughQualityAuditRegistryResponse.RubricScore>
        ...
        return List.of(
                ...
                score("服务层核心流程", 3, 5, "catalog, renderer, support, service, and controller flow is explained"),
                score("Java 证据检查", 3, 5, "route, service, renderer, boundary, controller, immutability, and docs tests are named"),
                score("mini-kv 证据检查", 1, 2, "mini-kv is explicitly recorded as untouched read-only boundary"),
                score("阻断与安全边界", 4, 6, "write routing, credentials, raw endpoint, audit, deployment, and autostart remain denied"),
                score("测试覆盖", 2, 4, "targeted Maven, full Maven, archive compliance, and CI are named")
        );
    }

    private static OpsShardReadinessCodeWalkthroughQualityAuditRegistryResponse.RubricScore
            score(
                    String section,
