...
final class OpsShardReadinessCodeWalkthroughQualityGateEvidenceAnchorCatalog {
  ...
  private static OpsShardReadinessCodeWalkthroughQualityGateRegistryResponse.EvidenceAnchor anchor(
      String anchor, String owner, String source, String requiredProof) {
    return new OpsShardReadinessCodeWalkthroughQualityGateRegistryResponse.EvidenceAnchor(
        anchor, owner, source, requiredProof, true);
  }
}
