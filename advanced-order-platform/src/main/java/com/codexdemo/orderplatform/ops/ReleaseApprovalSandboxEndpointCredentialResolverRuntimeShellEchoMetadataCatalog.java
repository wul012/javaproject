...
final class ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellEchoMetadataCatalog {
    ...
    private static final List<String> DECISION_RECORD_REQUIRED_EVIDENCE_IDS = List.of(
    ...
    private static final List<NoGoConditionTemplate> DECISION_RECORD_NO_GO_CONDITION_TEMPLATES = List.of(
    ...
    private static final List<String> DECISION_RECORD_PROOF_CLAIMS = List.of(
    ...
    private static final List<String> DECISION_RECORD_NODE_VERIFICATION_ACTIONS = List.of(
    ...
    private static final List<String> DECISION_RECORD_NODE_WARNING_CODES = List.of(
            "DECISION_RECORD_ONLY_DOES_NOT_AUTHORIZE_RUNTIME",
            "NODE_V300_REQUIRES_JAVA_V135_AND_MINI_KV_V132"
    );

    private static final List<String> DECISION_RECORD_NODE_RECOMMENDATION_CODES = List.of(
            "RUN_PARALLEL_JAVA_V135_MINI_KV_V132",
            "KEEP_NODE_V300_BEHIND_PARALLEL_EVIDENCE"
    );

    private static final List<String> DECISION_RECORD_NEXT_REQUIRED_ECHO_VERSIONS = List.of(
    ...
    private static final List<ContinuationOptionTemplate> POST_DECISION_PLAN_INTAKE_CONTINUATION_OPTION_TEMPLATES =
            List.of(
    ...
    private static final List<String> POST_DECISION_PLAN_INTAKE_PROOF_CLAIMS = List.of(
    ...
    private static final List<String> POST_DECISION_PLAN_INTAKE_NODE_VERIFICATION_ACTIONS = List.of(
    ...
    private static final List<String> POST_DECISION_PLAN_INTAKE_NODE_WARNING_CODES = List.of(
            "CONTINUATION_PLAN_DOES_NOT_AUTHORIZE_RUNTIME",
            "NODE_V302_REQUIRES_JAVA_V136_AND_MINI_KV_V133"
    );

    private static final List<String> POST_DECISION_PLAN_INTAKE_NODE_RECOMMENDATION_CODES = List.of(
            "REQUEST_PARALLEL_JAVA_MINI_KV_ECHO",
            "STOP_CHAIN_AFTER_V302_WITHOUT_NEW_BLOCKER"
    );

    private static final List<String> POST_DECISION_PLAN_INTAKE_NEXT_REQUIRED_ECHO_VERSIONS = List.of(
    ...
    static List<RehearsalRuntimeShellDecisionNoGoCondition> decisionRecordNoGoConditions() {
        return DECISION_RECORD_NO_GO_CONDITION_TEMPLATES.stream()
                .map(template -> new RehearsalRuntimeShellDecisionNoGoCondition(
                        template.code(),
                        template.condition(),
    ...
    static List<RehearsalRuntimeShellPostDecisionContinuationOption> postDecisionPlanIntakeContinuationOptions() {
        return POST_DECISION_PLAN_INTAKE_CONTINUATION_OPTION_TEMPLATES.stream()
                .map(template -> new RehearsalRuntimeShellPostDecisionContinuationOption(
                        template.code(),
                        template.title(),
                        template.status(),
                        template.rationale(),
