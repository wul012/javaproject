...
final class ReleaseApprovalSandboxEndpointCredentialResolverNoNetworkSafetyFixtureContractCatalog {
  ...
  private static final List<RequiredFieldTemplate> REQUIRED_FIELDS =
      List.of(
          requiredField(
              "fixture_id",
              "Fixture id",
              "stable non-secret fixture identifier",
          ...
          requiredField(
              "cleanup_marker",
              "Cleanup marker",
              "stable cleanup marker or digest",
  ...
  private static final List<String> SOURCE_REMAINING_PREREQUISITE_IDS =
      List.of("no-network-safety-fixture", "abort-rollback-semantics");
  ...
  static List<RehearsalNoNetworkSafetyFixtureRequiredField> requiredFields() {
    return REQUIRED_FIELDS.stream()
        .map(
            template ->
                new RehearsalNoNetworkSafetyFixtureRequiredField(
                    template.id(),
                    template.label(),
                    true,
  ...
  static List<RehearsalNoNetworkSafetyFixtureProhibitedField> prohibitedFields() {
    return PROHIBITED_FIELDS.stream()
        .map(
            template ->
                new RehearsalNoNetworkSafetyFixtureProhibitedField(
  ...
  static List<RehearsalNoNetworkSafetyFixtureRejectionReason> rejectionReasons() {
    return REJECTION_REASONS.stream()
        .map(
            template ->
                new RehearsalNoNetworkSafetyFixtureRejectionReason(
  ...
  static List<RehearsalNoNetworkSafetyFixtureNoGoBoundary> noGoBoundaries() {
    return NO_GO_BOUNDARIES.stream()
        .map(
            template ->
                new RehearsalNoNetworkSafetyFixtureNoGoBoundary(
  ...
  static List<RehearsalNoNetworkSafetyFixtureUpstreamEchoRequest> upstreamEchoRequests() {
    return UPSTREAM_ECHO_REQUESTS.stream()
        .map(
            template ->
                new RehearsalNoNetworkSafetyFixtureUpstreamEchoRequest(
