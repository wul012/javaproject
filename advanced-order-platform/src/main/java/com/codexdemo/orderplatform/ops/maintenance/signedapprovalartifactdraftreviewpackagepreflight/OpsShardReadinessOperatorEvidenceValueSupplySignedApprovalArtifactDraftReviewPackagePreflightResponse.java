...
public
record OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReviewPackagePreflightResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record ReviewPackageGate(String code, String category, String gate, String enforcement) {}
}
