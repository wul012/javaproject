...
public final class OpsShardReadinessReleaseAcceptanceRoutePaths {
  ...
  public static final String RELEASE_ACCEPTANCE_ROUTE_PATH_SPLIT_CLOSEOUT_REGISTRY =
      "/release-acceptance-route-path-split-closeout-registry";
  public static final String RELEASE_ACCEPTANCE_ROUTE_PATH_SPLIT_SUSTAINMENT_REGISTRY =
      "/release-acceptance-route-path-split-sustainment-registry";
  public static final String RELEASE_ACCEPTANCE_ROUTE_PATH_SPLIT_SUSTAINMENT_ACCEPTANCE_PACKAGE =
