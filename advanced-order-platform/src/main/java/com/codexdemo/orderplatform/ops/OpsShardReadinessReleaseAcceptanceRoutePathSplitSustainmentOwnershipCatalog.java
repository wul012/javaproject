...
final class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentOwnershipCatalog {
    ...
    static List<OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse.OwnershipRule> rules(
    ...
    private static OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse.OwnershipRule rule(
            String component,
            String owner,
            String rule,
            String landingZone,
