...
public class OpsShardReadinessCandidateDocumentProfileSectionRegistryService {
    ...
    static final String PROFILE = "java-shard-readiness-candidate-document-profile-section-registry.v1";

    private final OpsShardReadinessCandidateDocumentRequestPackageService requestPackageService;
    private final OpsShardReadinessCandidateDocumentSubmissionPrecheckService submissionPrecheckService;
    ...
    private final OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckService materialSubmissionPrecheckService;
    ...
    public OpsShardReadinessCandidateDocumentProfileSectionRegistryService(
            ...
            OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckService materialSubmissionPrecheckService
    ) {
    ...
    public OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse registry() {
        var sources = OpsShardReadinessCandidateDocumentProfileSectionSourceCatalog.sources(
        ...
        var fieldEntries = OpsShardReadinessCandidateDocumentProfileSectionFieldCatalog.fieldEntries(sections);
        return OpsShardReadinessCandidateDocumentProfileSectionRegistrySupport.response(
                ...
                List.of("candidate-document-profile-section-registry-service-assembled-from-five-read-only-routes"));
    }
}
