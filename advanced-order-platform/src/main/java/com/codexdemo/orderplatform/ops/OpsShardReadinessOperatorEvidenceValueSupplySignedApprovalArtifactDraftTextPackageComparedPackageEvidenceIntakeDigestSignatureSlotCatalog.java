...
final class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparedPackageEvidenceIntakeDigestSignatureSlotCatalog {

    private OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparedPackageEvidenceIntakeDigestSignatureSlotCatalog() {
    }
    ...
    static List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparedPackageEvidenceIntakeResponse
            .EvidenceSlot> digestSignatureSlots() {
        return List.of(
                slot("compared-package-evidence-slot-digest-match-summary", "v1326",
                ...
                slot("compared-package-evidence-slot-detached-signature-observation", "v1327",
    ...
    private static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparedPackageEvidenceIntakeResponse
        ...
        return OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparedPackageEvidenceIntakeSupport
                .slot(code, sourceVersion, evidenceSlot, evidenceQuestion, missingEvidenceGuard,
