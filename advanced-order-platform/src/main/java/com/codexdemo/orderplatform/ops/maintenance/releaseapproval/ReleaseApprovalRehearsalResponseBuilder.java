...
public final class ReleaseApprovalRehearsalResponseBuilder {
  ...
  public ReleaseApprovalRehearsalResponse build(
      OpsEvidenceResponse evidence, ReleaseApprovalRehearsalRequest request) {
    ReleaseApprovalRehearsalHintBuilder rehearsalHintBuilder =
        new ReleaseApprovalRehearsalHintBuilder();
    ...
    RehearsalSections sections =
        rehearsalSections(evidence, normalizedRequest, rehearsalHintBuilder, handoffHintBuilder);
    ...
    return new ReleaseApprovalRehearsalResponse(
        evidence.sampledAt(),
        ReleaseApprovalContractConstants.RELEASE_APPROVAL_REHEARSAL_VERSION,
        "/api/v1/ops/evidence",
        ...
        releaseApprovalVerificationHint(
            sections, managedAuditReceiptChain, failureTaxonomy, executionBoundaries),
  ...
  private ReleaseApprovalRehearsalResponseRecords.RehearsalVerificationHint
      releaseApprovalVerificationHint(
          RehearsalSections sections,
          ReleaseApprovalRehearsalManagedAuditReceiptChainBuilder.ReceiptChain
              managedAuditReceiptChain,
          ReleaseApprovalRehearsalResponseRecords.RehearsalFailureTaxonomy failureTaxonomy,
          ReleaseApprovalRehearsalResponseRecords.ExecutionBoundaries executionBoundaries) {
    return new ReleaseApprovalVerificationHintBuilder()
        .build(
            new ReleaseApprovalVerificationHintContext(
                sections.requestContext(),
                sections.operatorWindowHint(),
                sections.ciEvidenceHint(),
                sections.artifactRetentionHint(),
  ...
  private ReleaseApprovalRehearsalResponseRecords.LiveSignals liveSignals(
      OpsEvidenceResponse evidence) {
  ...
  private record NormalizedRequest(
    ...
    static NormalizedRequest from(ReleaseApprovalRehearsalRequest request) {
      ...
      ReleaseApprovalRehearsalRequest.OperatorWindow operatorWindow =
          normalizedRequest.operatorWindow();
      ...
      ReleaseApprovalRehearsalRequest.ApprovalBinding approvalBinding =
          normalizedRequest.approvalBinding();
    ...
    private static String normalized(String value) {
      return ReleaseApprovalContextHeaderField.normalizeValue(value);
    }
  }
