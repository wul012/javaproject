...
final class OpsShardReadinessSignedApprovalDraftProfileSectionHandoffModuleCatalog {
  ...
  static List<OpsShardReadinessSignedApprovalDraftProfileSectionHandoffResponse.ModuleEntry>
      modules() {
    return List.of(
        module(
            240,
            "signed-approval-draft-profile-section-handoff-types",
            "defines the signed approval draft profile section handoff records"),
        module(
            241,
            "signed-approval-draft-profile-section-handoff-source-catalog",
            "pins the source registry version, endpoint, and profile"),
        module(
            242,
            "signed-approval-draft-profile-section-handoff-section-catalog",
        ...
        module(
            244,
            "signed-approval-draft-profile-section-handoff-boundary-decisions",
            "keeps artifact, approval, import, runtime, and write boundaries closed"),
        module(
            245,
            "signed-approval-draft-profile-section-handoff-renderer",
            "renders stable Markdown handoff blocks for downstream readers"),
        module(
            246,
            "signed-approval-draft-profile-section-handoff-gates",
  ...
  private static OpsShardReadinessSignedApprovalDraftProfileSectionHandoffResponse.ModuleEntry
