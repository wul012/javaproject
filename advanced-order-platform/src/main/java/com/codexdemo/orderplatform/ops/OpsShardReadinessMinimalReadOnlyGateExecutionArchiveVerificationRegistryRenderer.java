...
final class OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryRenderer {
    ...
    static List<OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryResponse
        ...
        sections.add(OpsShardReadinessMinimalReadOnlyGateExecutionArtifactVerificationRenderer.render(
                artifactVerifications));
        sections.add(readTargetSection(readTargetVerifications));
        sections.add(OpsShardReadinessMinimalReadOnlyGateExecutionGateVerificationRenderer.render(
                gateCheckVerifications));
        sections.add(OpsShardReadinessMinimalReadOnlyGateExecutionBoundaryVerificationRenderer.render(
                boundaryVerifications));
        sections.add(ciAndHandoffSection(ciBatchVerifications, operatorHandoffVerifications, scorecard));
        return List.copyOf(sections);
    }

    private static OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryResponse
            .MarkdownSection sourceRegistrySection(
                    List<OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryResponse
                            .SourceRegistrySnapshot> snapshots
            ) {
        List<String> lines = new ArrayList<>();
        lines.add("source-registry-count=" + snapshots.size());
        snapshots.forEach(snapshot -> lines.add(String.join(
                " | ",
                snapshot.version(),
                snapshot.endpoint(),
                snapshot.sourcePlan(),
    ...
    private static OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryResponse
            .MarkdownSection readTargetSection(
                    List<OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryResponse
                            .ReadTargetVerification> readTargets
            ) {
        List<String> lines = new ArrayList<>();
    ...
    private static OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryResponse
            .MarkdownSection ciAndHandoffSection(
                    List<OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryResponse
                            .CiBatchVerification> ciBatches,
                    List<OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryResponse
                            .OperatorHandoffVerification> handoffs,
                    List<OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryResponse
                            .ScorecardEntry> scorecard
            ) {
        List<String> lines = new ArrayList<>();
