...
final
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightCloseoutAssuranceHandoffCatalog {
  ...
  static List<
    ...
    return List.of(
        handoff(
            "submission-closeout-execution-lock-proof",
            "execution",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightPolicyExecutionCloseoutService
                .ENDPOINT),
        handoff(
            "submission-closeout-runtime-payload-absence",
            "execution",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightPolicyExecutionCloseoutService
                .ENDPOINT),
        handoff(
            "submission-closeout-write-routing-lock",
            "execution",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightPolicyExecutionCloseoutService
                .ENDPOINT),
        handoff(
            "submission-closeout-sibling-mutation-lock",
            "sibling",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightPolicyExecutionCloseoutService
                .ENDPOINT),
        handoff(
            "submission-closeout-archive-summary",
            "archive",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightCatalogService
                .ENDPOINT),
        handoff(
            "submission-closeout-route-evidence-summary",
            "route",
            ...
            OpsShardReadinessSignedApprovalArtifactDraftTextPackageSubmissionPreflightRoutePaths
                .BASE_PATH),
        handoff(
            "submission-closeout-comparison-control-summary",
            "comparison",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightCatalogService
                .ENDPOINT),
        handoff(
            "submission-closeout-gate-summary",
            "gate",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightCatalogService
                .ENDPOINT),
        handoff(
            "submission-closeout-operator-handoff",
            "operator",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightEvidenceValueService
                .ENDPOINT),
        handoff(
            "submission-closeout-integrity-checklist",
            "integrity",
            ...
            OpsShardReadinessSignedApprovalArtifactDraftTextPackageSubmissionPreflightRoutePaths
                .BASE_PATH),
        handoff(
            "submission-closeout-future-consumer-boundary",
            "boundary",
            ...
            OpsShardReadinessSignedApprovalArtifactDraftTextPackageSubmissionPreflightRoutePaths
                .BASE_PATH),
        handoff(
            "submission-closeout-ci-evidence-pointer",
            "verification",
            ...
            OpsShardReadinessSignedApprovalArtifactDraftTextPackageSubmissionPreflightRoutePaths
                .BASE_PATH),
        handoff(
            "submission-closeout-final-summary",
            "archive",
