...
public class OpsShardReadinessRuntimeExecutionApprovalGateInputService {
    ...
    static final String ENDPOINT = "/api/v1/ops/shard-readiness/runtime-execution-approval-gate-input";
    ...
    private final OpsShardReadinessRuntimeExecutionPacketContributionService packetContributionService;
    ...
    private String approvalGateInputStatus(
        ...
        boolean sourceContributionComplete = sourceContribution.javaPacketContributionPresent()
                && sourceContribution.javaPacketContributionComplete();
        boolean runtimeStillClosed = !sourceContribution.crossProjectRuntimeExecutionPacketPresent()
