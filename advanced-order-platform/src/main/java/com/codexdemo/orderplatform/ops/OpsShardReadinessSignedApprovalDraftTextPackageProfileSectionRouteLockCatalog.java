...
final class OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRouteLockCatalog {
    ...
    static List<OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryResponse.RouteFieldLock>
    routeFieldLocks(
            List<OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryResponse
                    .TextPackageProfileSection> sections
    ) {
        return sections.stream()
                .map(section -> new OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryResponse
                        .RouteFieldLock(
                                section.code(),
                                section.endpoint(),
                                section.profile(),
