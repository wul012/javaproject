...
final class OpsShardReadinessCandidateDocumentIntakePacketSupport {
  ...
  static OpsShardReadinessCandidateDocumentIntakePacketResponse response(
    ...
    checks.add(
        "candidate-document-intake-packet-source-node-" + SOURCE_NODE_SUBMISSION_PRECHECK_VERSION);
    ...
    checks.add(
        "candidate-document-intake-packet-covered-checkpoint-count-" + coveredCheckpointCount);
    checks.add(
        "candidate-document-intake-packet-covered-validator-count-"
