...
public class OpsShardReadinessComparedEvidenceCandidateIntakePreflightController {
    ...
    private final OpsShardReadinessComparedEvidenceCandidateIntakePreflightCatalogService catalogService;
    private final OpsShardReadinessComparedEvidenceCandidateIntakePreflightSourceService sourceService;
    private final OpsShardReadinessComparedEvidenceCandidateIntakePreflightComparisonService comparisonService;
    private final OpsShardReadinessComparedEvidenceCandidateIntakePreflightPolicyService policyService;
    private final OpsShardReadinessComparedEvidenceCandidateIntakePreflightCloseoutService closeoutService;
