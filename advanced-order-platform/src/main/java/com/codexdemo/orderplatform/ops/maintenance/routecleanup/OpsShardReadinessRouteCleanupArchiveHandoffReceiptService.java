...
public class OpsShardReadinessRouteCleanupArchiveHandoffReceiptService {
  ...
  static final String ENDPOINT =
      RouteCleanupRoutes.BASE_PATH + RouteCleanupRoutes.ARCHIVE_HANDOFF_RECEIPT;
  ...
  public OpsShardReadinessRouteCleanupArchiveHandoffReceiptResponse receipt() {
    ...
    OpsShardReadinessRouteCleanupConsumerSignoffPacketResponse signoff =
        consumerSignoffPacketService.packet();
    OpsShardReadinessRouteCleanupPostPushCloseoutResponse closeout =
        postPushCloseoutService.closeout();
    List<OpsShardReadinessRouteCleanupArchiveHandoffReceiptResponse.ReceiptItem> items =
        List.of(
