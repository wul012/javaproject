...
final class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftInstructionPreflightAssuranceSlotCatalog {

    static final int ASSURANCE_SLOT_COUNT = 12;

    private OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftInstructionPreflightAssuranceSlotCatalog() {
    }

    static List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftInstructionPreflightResponse
            .InstructionSlot> assuranceSlots() {
        return List.of(
                slot("SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_SOURCE_FILE_SLOT",
                        "SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_SOURCE_FILE",
                        "future draft must cite source evidence file",
                        "Prepare source file instruction slot.", "Source file instruction cannot import evidence.",
                        ...
                        OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftAuthoringReadinessEvidenceRequirementService
                                .ENDPOINT),
                slot("SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_SOURCE_SNIPPET_SLOT",
                        "SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_SOURCE_SNIPPET",
                        "future draft must cite source evidence snippet",
                        "Prepare source snippet instruction slot.", "Source snippet instruction cannot build payloads.",
                        "SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_SOURCE_SNIPPET_SLOT_GUARD",
                        OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftAuthoringReadinessEvidenceRequirementService
                                .ENDPOINT),
                slot("SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_REDACTED_VALUE_DIGEST_SLOT",
                        ...
                        "Prepare redacted value digest instruction slot.", "Redacted value instruction cannot accept raw values.",
                ...
                slot("SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_RAW_SECRET_EMBARGO_SLOT",
                        ...
                        OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftAuthoringReadinessEmbargoRequirementService
                                .ENDPOINT),
                slot("SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_APPROVAL_GRANT_EMBARGO_SLOT",
                        ...
                        "Prepare approval grant embargo instruction slot.", "Approval grant instruction cannot approve execution.",
                        "SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_APPROVAL_GRANT_EMBARGO_SLOT_GUARD",
                        OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftAuthoringReadinessEmbargoRequirementService
                                .ENDPOINT),
                slot("SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_ZERO_VALUE_IMPORT_EMBARGO_SLOT",
                        ...
                        "Prepare zero value import instruction slot.", "Zero value instruction cannot import values.",
                        "SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_ZERO_VALUE_IMPORT_EMBARGO_SLOT_GUARD",
                        OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftAuthoringReadinessEmbargoRequirementService
                                .ENDPOINT),
                slot("SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_WRITE_ROUTE_EMBARGO_SLOT",
                        ...
                        "Prepare write route embargo instruction slot.", "Write route instruction cannot enable writes.",
                        "SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_WRITE_ROUTE_EMBARGO_SLOT_GUARD",
                        OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftAuthoringReadinessEmbargoRequirementService
                                .ENDPOINT),
                slot("SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_SIBLING_NON_MUTATION_SLOT",
                        ...
                        "Prepare sibling non-mutation instruction slot.", "Sibling instruction cannot mutate Java or mini-kv.",
                        "SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_SIBLING_NON_MUTATION_SLOT_GUARD",
                        OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftAuthoringReadinessEmbargoRequirementService
                                .ENDPOINT),
                slot("SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_INSTRUCTION_PREFLIGHT_CLOSEOUT_SLOT",
                        "SIGNED_APPROVAL_CAPTURE_ARTIFACT_DRAFT_AUTHORING_READINESS_CLOSEOUT",
                        "future real draft text package must be separate",
                        "Prepare instruction preflight closeout slot.", "Closeout instruction cannot create draft text.",
    ...
    private static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftInstructionPreflightResponse
        ...
        return OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftInstructionPreflightSupport
                .slot(code, sourceAuthoringRequirement, futureInstruction, instructionPurpose,
                        materializationBlocker, guardCode, sourceEndpoint);
    }
}
