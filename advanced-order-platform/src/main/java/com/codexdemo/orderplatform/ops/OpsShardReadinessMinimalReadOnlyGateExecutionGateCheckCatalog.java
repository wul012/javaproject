...
final class OpsShardReadinessMinimalReadOnlyGateExecutionGateCheckCatalog {
    ...
    static List<OpsShardReadinessMinimalReadOnlyGateExecutionRegistryResponse.GateCheck>
        ...
        return List.of(
                ...
                check("java-ops-overview-read-target-passed", "read-target",
                ...
                check("managed-audit-http-not-called", "runtime-boundary", "managed audit remains disabled"),
                ...
                check("v366-read-window-decision-honored", "lineage", "v367 honored v366 read-window decision"),
    ...
    private static OpsShardReadinessMinimalReadOnlyGateExecutionRegistryResponse.GateCheck
            check(String code, String group, String evidence) {
