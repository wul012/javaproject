...
final
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightDigestSignatureLaneCatalog {
  ...
  static List<
    ...
    return List.of(
        lane(
            "comparison-lane-digest-pin-set",
            "v1291",
        ...
        lane(
            "comparison-lane-digest-algorithm",
            "v1292",
        ...
        lane(
            "comparison-lane-digest-source-handle",
            "v1293",
        ...
        lane(
            "comparison-lane-digest-recheck-control",
            "v1294",
        ...
        lane(
            "comparison-lane-detached-signature-metadata",
            "v1295",
        ...
        lane(
            "comparison-lane-detached-signature-envelope",
            "v1296",
        ...
        lane(
            "comparison-lane-detached-signature-absence-lock",
            "v1297",
