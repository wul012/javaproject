...
public class OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryService {
    ...
    private final OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageIntakeCatalogService
            intakeService;
    private final OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageReviewPreflightCatalogService
            reviewPreflightService;
    private final OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightCatalogService
            submissionPreflightService;
    private final OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightCatalogService
            comparisonPreflightService;
    private final OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonAcceptancePrecheckCatalogService
            acceptancePrecheckService;
    private final OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparedPackageEvidenceIntakeCatalogService
            comparedPackageEvidenceIntakeService;
    private final OpsShardReadinessComparedEvidenceEvaluationPreflightCatalogService evaluationPreflightService;
    private final OpsShardReadinessComparedEvidenceCandidateBlueprintCatalogService candidateBlueprintService;
    ...
    public OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryService(
            ...
            OpsShardReadinessComparedEvidenceCandidateIntakePreflightCatalogService candidateIntakePreflightService
    ) {
    ...
    public OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryResponse registry() {
        var sources = OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionSourceCatalog.sources(
        ...
        var sections = OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionCatalog.sections(sources);
        var fieldEntries = OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionFieldCatalog
                .fieldEntries(sections);
        return OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistrySupport.response(
                ...
                sections,
                fieldEntries,
                OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRenderer
