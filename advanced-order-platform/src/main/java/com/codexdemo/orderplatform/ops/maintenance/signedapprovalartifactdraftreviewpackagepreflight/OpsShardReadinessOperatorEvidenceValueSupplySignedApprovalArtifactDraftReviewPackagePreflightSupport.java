...
final
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReviewPackagePreflightSupport {
  ...
  OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReviewPackagePreflightResponse
    ...
    checks.add(
        "signed-approval-artifact-draft-review-package-preflight-slot-count-" + slotCopy.size());
    checks.add(
        "signed-approval-artifact-draft-review-package-preflight-passed-slot-count-"
            + passedSlotCount);
    checks.add(
        "signed-approval-artifact-draft-review-package-preflight-guard-count-" + guardCopy.size());
    checks.add(
        "signed-approval-artifact-draft-review-package-preflight-passed-guard-count-"
            + passedGuardCount);
    checks.add(
        "signed-approval-artifact-draft-review-package-preflight-gate-count-" + gateCopy.size());
    checks.add(
        "signed-approval-artifact-draft-review-package-preflight-source-plan-" + SOURCE_PLAN);
    checks.add(
        "signed-approval-artifact-draft-review-package-preflight-source-node-readiness-lane-"
            + SOURCE_NODE_READINESS_LANE_VERSION);
    checks.add(
        "signed-approval-artifact-draft-review-package-preflight-source-java-readiness-lane-"
  ...
  OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReviewPackagePreflightResponse
    ...
    return new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReviewPackagePreflightResponse
        .PackageGuard(code, category, guard, rejectionCode, enforcement, "passed");
  }
