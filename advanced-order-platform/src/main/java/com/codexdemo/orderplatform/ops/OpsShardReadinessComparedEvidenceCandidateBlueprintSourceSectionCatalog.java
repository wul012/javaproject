...
final class OpsShardReadinessComparedEvidenceCandidateBlueprintSourceSectionCatalog {
    ...
    static List<OpsShardReadinessComparedEvidenceCandidateBlueprintResponse.CandidateSection> sourceSections() {
        return List.of(
                OpsShardReadinessComparedEvidenceCandidateBlueprintSupport.section("source-intake-readiness",
                        "Node v1352", "source",
                ...
                OpsShardReadinessComparedEvidenceCandidateBlueprintSupport.section("operator-provenance",
                        "Node v1353", "source",
                        "operator provenance, source evidence handle",
                        "operator evidence reviewer",
                        OpsShardReadinessComparedEvidenceEvaluationPreflightEndpointRefs.SOURCE_ARTIFACT,
                        "block-missing-operator-provenance"),
                OpsShardReadinessComparedEvidenceCandidateBlueprintSupport.section("manual-submission-reference",
                        "Node v1354", "source",
