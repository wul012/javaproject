...
public class OpsShardReadinessRuntimeExecutionPassEvidenceCloseoutService {
    ...
    public OpsShardReadinessRuntimeExecutionPassEvidenceCloseoutResponse closeout() {
        OpsShardReadinessRuntimeExecutionLiveReadGateResponse sourceReceipt = liveReadGateService.gate();
    ...
    private boolean nodeApprovedSmokePresent(OpsShardReadinessRuntimeExecutionLiveReadGateResponse sourceReceipt) {
        return "Node v407".equals(sourceReceipt.nextNodeConsumerHint())
                && "passed".equals(sourceReceipt.status());
    }

    private boolean nodeApprovedSmokePassed(OpsShardReadinessRuntimeExecutionLiveReadGateResponse sourceReceipt) {
    ...
    private List<String> closeoutHandoffChecks(OpsShardReadinessRuntimeExecutionLiveReadGateResponse sourceReceipt) {
        return List.of(
    ...
    private List<String> failClosedRules(OpsShardReadinessRuntimeExecutionLiveReadGateResponse sourceReceipt) {
        return List.of(
    ...
    private String closeoutStatus(OpsShardReadinessRuntimeExecutionLiveReadGateResponse sourceReceipt) {
        boolean sourcePassed = "passed".equals(sourceReceipt.status())
                && sourceReceipt.liveReadGateReceiptComplete()
                && sourceReceipt.readyForApprovedLocalLoopbackReadOnlySmoke();
        boolean smokePassed = nodeApprovedSmokePassed(sourceReceipt);
        boolean javaDidNotRerun = !sourceReceipt.runtimeSmokeAttempted()
