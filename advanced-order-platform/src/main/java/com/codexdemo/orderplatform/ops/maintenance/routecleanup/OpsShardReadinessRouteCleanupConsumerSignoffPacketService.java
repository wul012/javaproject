...
public class OpsShardReadinessRouteCleanupConsumerSignoffPacketService {
  ...
  static final String ENDPOINT =
      RouteCleanupRoutes.BASE_PATH + RouteCleanupRoutes.CONSUMER_SIGNOFF_PACKET;
  ...
  public OpsShardReadinessRouteCleanupConsumerSignoffPacketResponse packet() {
    ...
    List<OpsShardReadinessRouteCleanupConsumerSignoffPacketResponse.SignoffItem> items =
        List.of(
