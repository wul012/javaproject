...
final class ReleaseApprovalManagedAuditSandboxEndpointHandlePreflightEchoMarkerBuilder {
  ...
  private static final String CREDENTIAL_HANDLE =
  ...
  private static final String TLS_POLICY_HANDLE =
  ...
  private static final List<String> REQUIRED_REVIEW_ITEMS =
      List.of(
  ...
  private static final List<String> FORBIDDEN_OPERATIONS =
      List.of(
