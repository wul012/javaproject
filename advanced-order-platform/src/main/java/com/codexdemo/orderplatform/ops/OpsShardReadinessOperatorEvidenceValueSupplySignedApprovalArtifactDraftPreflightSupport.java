...
final class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightSupport {
    ...
    private OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightSupport() {
    }

    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightResponse response(
            String version,
            String endpoint,
            String profile,
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightResponse.DraftField>
                    fields,
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightResponse.DraftGuard>
                    guards,
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightResponse
                    .DraftPreflightGate> gates,
        ...
        int passedFieldCount = (int) fieldCopy.stream().filter(field -> "passed".equals(field.status())).count();
        ...
        checks.add("signed-approval-artifact-draft-preflight-source-artifact-preflight-"
                + SOURCE_ARTIFACT_PREFLIGHT_VERSION);
        checks.add("signed-approval-artifact-draft-preflight-source-java-readiness-"
        ...
        return new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightResponse(
                ...
                gateCopy,
                List.copyOf(checks),
                passedFieldCount == fieldCopy.size() && passedGuardCount == guardCopy.size() ? "passed" : "blocked"
        );
    }

    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightResponse.DraftField field(
            String code,
        ...
        return new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightResponse.DraftField(
                code,
                sourceReadinessItem,
                draftStage,
                fieldRequirement,
    ...
    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightResponse.DraftGuard guard(
            String code,
            String category,
        ...
        return new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightResponse.DraftGuard(
                code,
                category,
                guardRequirement,
                rejectionCode,
    ...
    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightResponse.DraftPreflightGate
