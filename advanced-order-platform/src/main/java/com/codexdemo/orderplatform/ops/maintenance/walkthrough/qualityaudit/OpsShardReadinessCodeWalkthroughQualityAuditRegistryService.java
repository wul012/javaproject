...
public class OpsShardReadinessCodeWalkthroughQualityAuditRegistryService {
  ...
  public static final String ENDPOINT =
      OpsShardReadinessCodeWalkthroughQualityAuditRoutePaths.BASE_PATH
          + OpsShardReadinessCodeWalkthroughQualityAuditRoutePaths
              .CODE_WALKTHROUGH_QUALITY_AUDIT_REGISTRY;
  static final String PROFILE = "java-shard-readiness-code-walkthrough-quality-audit-registry.v1";
  ...
  public OpsShardReadinessCodeWalkthroughQualityAuditRegistryResponse registry() {
    ...
    var versionAudits = OpsShardReadinessCodeWalkthroughQualityAuditVersionCatalog.versionAudits();
    var rubricScores = OpsShardReadinessCodeWalkthroughQualityAuditRubricCatalog.rubricScores();
    var reviewFindings =
