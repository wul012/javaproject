...
final class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistrySupport {
    ...
    private OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistrySupport() {
    }
    ...
    static OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
            response(
                    ...
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                            .SourceArchiveSnapshot> sourceArchiveSnapshots,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                            .ArtifactManifestEntry> artifactManifest,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                            .RoutePackageEntry> routePackages,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                            .OperatorPackEntry> operatorPacks,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                            .CiAttestationEntry> ciAttestations,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                            .BoundarySealEntry> boundarySeals,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                            .RetentionWindowEntry> retentionWindows,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                            .CloseoutLedgerEntry> closeoutLedger,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
        ...
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-source-plan-" + SOURCE_PLAN);
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-required-archive-"
                + REQUIRED_ARCHIVE_VERIFICATION_PLAN);
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-operator-plan-" + OPERATOR_HANDOFF_PLAN);
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-source-version-"
                + source.version());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-source-state-"
                + source.releaseAcceptanceState());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-source-count-"
                + sourceArchiveCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-artifact-manifest-count-"
                + artifactManifestCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-passed-artifact-manifest-count-"
                + passedArtifactManifestCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-route-package-count-"
                + routePackageCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-ready-route-package-count-"
                + readyRoutePackageCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-operator-pack-count-"
                + operatorPackCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-ready-operator-pack-count-"
                + readyOperatorPackCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-ci-attestation-count-"
                + ciAttestationCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-passed-ci-attestation-count-"
                + passedCiAttestationCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-boundary-seal-count-"
                + boundarySealCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-locked-boundary-seal-count-"
                + lockedBoundarySealCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-retention-window-count-"
                + retentionWindowCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-ready-retention-window-count-"
                + readyRetentionWindowCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-closeout-ledger-count-"
                + closeoutLedgerCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-ready-closeout-ledger-count-"
                + readyCloseoutLedgerCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-scorecard-count-"
                + scorecardCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-passed-scorecard-count-"
                + passedScorecardCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-markdown-section-count-"
                + markdownSectionCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-consumes-release-acceptance");
        ...
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-no-raw-endpoint-resolution");
        ...
        checks.add("minimal-read-only-gate-operator-ci-handoff-archive-registry-no-deployment-rollback");
    ...
    private static int countReadyRoutePackages(
            List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                    .RoutePackageEntry> entries
    ) {
        return (int) entries.stream()
                .filter(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                        .RoutePackageEntry::ready)
                .count();
    }

    private static int countReadyOperatorPacks(
            List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                    .OperatorPackEntry> entries
    ) {
        return (int) entries.stream()
                .filter(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                        .OperatorPackEntry::ready)
                .count();
    }

    private static int countPassedCiAttestations(
            List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                    .CiAttestationEntry> entries
    ) {
        return (int) entries.stream().filter(entry -> "passed".equals(entry.status())).count();
    }
    ...
    private static int countLockedBoundarySeals(
            List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                    .BoundarySealEntry> entries
    ) {
        return (int) entries.stream()
                .filter(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                        .BoundarySealEntry::locked)
                .count();
    }

    private static int countReadyRetentionWindows(
            List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                    .RetentionWindowEntry> entries
    ) {
        return (int) entries.stream()
                .filter(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                        .RetentionWindowEntry::ready)
                .count();
    }

    private static int countReadyCloseoutLedger(
            List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                    .CloseoutLedgerEntry> entries
    ) {
        return (int) entries.stream()
                .filter(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                        .CloseoutLedgerEntry::ready)
                .count();
    }
