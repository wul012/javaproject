...
final class OpsShardReadinessCandidateDocumentProfileSectionSourceCatalog {
  ...
  static List<OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.SectionSource>
      sources(
    ...
    return List.of(
        ...
        source(
            ...
            materialSubmissionPrecheck.version(),
            materialSubmissionPrecheck.endpoint(),
            materialSubmissionPrecheck.profile(),
            materialSubmissionPrecheck.status()));
  }

  private static OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.SectionSource
      source(
          int order,
          String code,
    ...
    return new OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.SectionSource(
        order, code, sourceVersion, endpoint, profile, sourceStatus, "passed");
  }
}
