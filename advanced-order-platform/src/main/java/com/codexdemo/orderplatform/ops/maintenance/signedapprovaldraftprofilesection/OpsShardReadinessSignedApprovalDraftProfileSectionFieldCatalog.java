...
final class OpsShardReadinessSignedApprovalDraftProfileSectionFieldCatalog {
  ...
  static List<OpsShardReadinessSignedApprovalDraftProfileSectionRegistryResponse.FieldEntry>
      fieldEntries(
          List<
  ...
  private static OpsShardReadinessSignedApprovalDraftProfileSectionRegistryResponse.FieldEntry
      entry(
