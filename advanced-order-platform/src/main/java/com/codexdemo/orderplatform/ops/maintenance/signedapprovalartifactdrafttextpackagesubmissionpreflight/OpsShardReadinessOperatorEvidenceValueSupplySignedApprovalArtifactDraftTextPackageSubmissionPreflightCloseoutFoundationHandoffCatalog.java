...
final
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightCloseoutFoundationHandoffCatalog {
  ...
  static List<
    ...
    return List.of(
        handoff(
            "submission-closeout-identity-envelope",
            "identity",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightIdentityService
                .ENDPOINT),
        handoff(
            "submission-closeout-request-correlation",
            "identity",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightIdentityService
                .ENDPOINT),
        handoff(
            "submission-closeout-source-lineage",
            "lineage",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightCatalogService
                .ENDPOINT),
        handoff(
            "submission-closeout-digest-pin-set",
            "digest",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightDigestSignatureService
                .ENDPOINT),
        handoff(
            "submission-closeout-digest-comparison-control",
            "digest",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightDigestSignatureService
                .ENDPOINT),
        handoff(
            "submission-closeout-signature-metadata",
            "signature",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightDigestSignatureService
                .ENDPOINT),
        handoff(
            "submission-closeout-signature-envelope-lock",
            "signature",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightDigestSignatureService
                .ENDPOINT),
        handoff(
            "submission-closeout-source-evidence-handles",
            "source-evidence",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightEvidenceValueService
                .ENDPOINT),
        handoff(
            "submission-closeout-source-evidence-freeze",
            "source-evidence",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightEvidenceValueService
                .ENDPOINT),
        handoff(
            "submission-closeout-operator-value-handle",
            "value",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightEvidenceValueService
                .ENDPOINT),
        handoff(
            "submission-closeout-policy-assertion",
            "policy",
            ...
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightPolicyExecutionCloseoutService
                .ENDPOINT),
        handoff(
            "submission-closeout-review-state-bridge",
            "policy",
