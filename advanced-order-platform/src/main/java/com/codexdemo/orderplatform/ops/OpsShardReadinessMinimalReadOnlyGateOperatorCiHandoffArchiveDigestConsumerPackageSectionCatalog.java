...
final class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageSectionCatalog {

    private OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageSectionCatalog() {
    }
    ...
    static List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
        ...
        return List.of(
                ...
                section("consumer-packets", "operator-ci", "packets=" + source.consumerPacketCount(), sourcePassed),
                section("ci-matrix", "ci", "replay-instructions=" + source.replayInstructionCount(),
                        sourcePassed),
                section("boundary-locks", "operator", "locked-boundaries=" + source.lockedBoundaryCount(),
                        sourcePassed)
        );
    }
