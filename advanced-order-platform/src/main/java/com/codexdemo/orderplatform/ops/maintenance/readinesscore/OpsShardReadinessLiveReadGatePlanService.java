...
public class OpsShardReadinessLiveReadGatePlanService {
  ...
  public static final String ENDPOINT = "/api/v1/ops/shard-readiness/live-read-gate-plan";
  ...
  public static final String EVIDENCE_PATH =
      "e/159/evidence/java-shard-readiness-live-read-gate-plan-v159.json";
  ...
  public OpsShardReadinessLiveReadGatePlanResponse plan() {
    OpsShardReadinessActiveShardPlanHandoffResponse sourceHandoff =
        activeShardPlanHandoffService.handoff();
