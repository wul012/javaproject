...
final
class ReleaseApprovalManagedAuditSandboxConnectionDisabledAdapterClientPrecheckEchoReceiptBuilder {
  ...
  private static final List<String> REQUIRED_ENV_HANDLES =
      List.of(
  ...
  private static final List<String> DRY_RUN_RESPONSE_FIELDS =
      List.of(
          "profileVersion",
          "precheckState",
          "adapterMode",
  ...
  private static final List<String> REUSED_NO_GO_CONDITIONS =
      List.of(
  ...
  private static final List<String> WARNING_DIGEST_WARNING_INPUT_NAMES =
      List.of("managedAuditSandboxConnectionDisabledAdapterClientPrecheckEchoReceiptWarnings");
  ...
  ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
    ...
    ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
            .RehearsalSandboxConnectionDisabledAdapterClientBoundary
        clientBoundary = clientBoundary();
    ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
            .RehearsalSandboxConnectionDisabledAdapterClientOptInGate
        optInGate = optInGate();
    ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
    ...
    boolean readOnlyPrecheckBoundaryEchoed =
        noWriteCredentialConnectionSchemaRollbackOrServiceStartProved(javaExecutionBoundary);
            ...
            List.of(
                ...
                ReleaseApprovalDigestSupport.line(
                    ...
                    ReleaseApprovalUpstreamContractConstants
                        .NODE_V252_DISABLED_ADAPTER_CLIENT_PRECHECK_PROFILE),
                ...
                ReleaseApprovalDigestSupport.line(
                    "requiredEnvHandleCount", precheckShape.requiredEnvHandleCount()),
                ReleaseApprovalDigestSupport.line(
                    "failureClassCount", precheckShape.failureClassCount()),
                ReleaseApprovalDigestSupport.line(
                    "dryRunResponseFieldCount", precheckShape.dryRunResponseFieldCount()),
                ...
                ReleaseApprovalDigestSupport.line(
                    "clientMayBeInstantiated", clientBoundary.clientMayBeInstantiated()),
                ReleaseApprovalDigestSupport.line(
                    "externalRequestMayBeSent", clientBoundary.externalRequestMayBeSent()),
                ReleaseApprovalDigestSupport.line(
                    "credentialValueMayBeLoaded", clientBoundary.credentialValueMayBeLoaded()),
                ReleaseApprovalDigestSupport.line("optInGateName", optInGate.gateName()),
                ReleaseApprovalDigestSupport.line(
    ...
    return new ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
        ...
        ReleaseApprovalContractConstants
            .RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_CONNECTION_PRECHECK_PACKET_ECHO_RECEIPT_SCHEMA_VERSION,
        ReleaseApprovalUpstreamContractConstants.NODE_V252_DISABLED_ADAPTER_CLIENT_PRECHECK_VERSION,
        ReleaseApprovalUpstreamContractConstants.NODE_V252_DISABLED_ADAPTER_CLIENT_PRECHECK_PROFILE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V252_DISABLED_ADAPTER_CLIENT_PRECHECK_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants.NODE_V252_DISABLED_ADAPTER_CLIENT_PRECHECK_STATE,
        ReleaseApprovalUpstreamContractConstants.NODE_V253_TEST_ONLY_ADAPTER_SHELL_CONTRACT_VERSION,
        ReleaseApprovalUpstreamContractConstants.NODE_V253_TEST_ONLY_ADAPTER_SHELL_CONTRACT_PROFILE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V254_DISABLED_ADAPTER_CLIENT_UPSTREAM_ECHO_VERIFICATION_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V254_DISABLED_ADAPTER_CLIENT_UPSTREAM_ECHO_VERIFICATION_PROFILE,
        true,
        precheckShape,
        clientBoundary,
        optInGate,
  ...
  private static ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
          .RehearsalSandboxConnectionDisabledAdapterClientPrecheckShape
      precheckShape() {
    return new ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
        .RehearsalSandboxConnectionDisabledAdapterClientPrecheckShape(
  ...
  private static ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
    ...
    return new ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
        .RehearsalSandboxConnectionDisabledAdapterClientBoundary(
        CLIENT_IMPLEMENTATION_STATUS, false, false, false, true, false, false, false);
  }
  ...
  private static ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
    ...
    return new ReleaseApprovalSandboxConnectionAdapterPreflightEchoRecords
        .RehearsalSandboxConnectionDisabledAdapterClientOptInGate(
        "ORDEROPS_MANAGED_AUDIT_ADAPTER_CLIENT_ENABLED", "true", "false", true, true);
  }
