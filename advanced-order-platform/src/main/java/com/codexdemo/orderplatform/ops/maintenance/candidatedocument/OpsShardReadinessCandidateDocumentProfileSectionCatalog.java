...
final class OpsShardReadinessCandidateDocumentProfileSectionCatalog {
  ...
  static List<OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.ProfileSection>
      sections(
          List<OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.SectionSource>
              sources) {
    return sources.stream()
        .map(
            source ->
                new OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.ProfileSection(
                    source.order(),
                    source.code() + "-section",
                    heading(source.code()),
