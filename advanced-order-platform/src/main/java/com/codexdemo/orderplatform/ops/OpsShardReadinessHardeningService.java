...
public class OpsShardReadinessHardeningService {
  ...
  public static final String ENDPOINT = "/api/v1/ops/shard-readiness/hardening";
  ...
  public static final String EVIDENCE_PATH =
      "e/154/evidence/java-shard-readiness-hardening-v154.json";
  ...
  private OpsShardReadinessHardeningResponse.FieldExplanation field(
      String field, String producer, String consumer, String meaning, String compatibility) {
    return new OpsShardReadinessHardeningResponse.FieldExplanation(
        field, producer, consumer, meaning, compatibility);
  }

  private OpsShardReadinessHardeningResponse.ErrorSemantic error(
      String condition, String status, String nodeInterpretation) {
    return new OpsShardReadinessHardeningResponse.ErrorSemantic(
        condition, status, nodeInterpretation);
  }
}
