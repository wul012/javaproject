...
public class OpsShardReadinessRouteCleanupMaintenanceUpkeepCloseoutService {
    ...
    static final String PROFILE =
            "java-shard-readiness-route-cleanup-maintenance-upkeep-closeout.v1";
    ...
    public OpsShardReadinessRouteCleanupMaintenanceUpkeepCloseoutResponse closeout() {
        ...
        List<OpsShardReadinessRouteCleanupMaintenanceUpkeepCloseoutResponse.CloseoutCheck> closeoutChecks = List.of(
    ...
    private String status(
        ...
        return checks.stream().allMatch(check -> "passed".equals(check.status())) ? "passed" : "blocked";
    }
}
