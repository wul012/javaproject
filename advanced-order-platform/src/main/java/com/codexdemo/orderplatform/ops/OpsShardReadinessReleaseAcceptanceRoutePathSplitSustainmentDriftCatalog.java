...
final class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentDriftCatalog {
  ...
  static List<OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse.DriftGuard>
  ...
  private static OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse.DriftGuard
      guard(String guard, String signal, String expected, boolean locked) {
    return new OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse.DriftGuard(
        guard, signal, expected, locked);
  }
}
