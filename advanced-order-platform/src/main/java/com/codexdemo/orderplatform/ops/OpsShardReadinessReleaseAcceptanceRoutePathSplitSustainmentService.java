...
public class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentService {
    ...
    public OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentResponse registry() {
        ...
        var sourceSnapshots = OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentSourceCatalog
                .snapshots(source);
        var ownershipRules = OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentOwnershipCatalog
                .rules(source);
        var driftGuards = OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentDriftCatalog.guards(source);
        var boundaryGuards = OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentBoundaryCatalog
                .guards(source);
        var ciGates = OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentCiCatalog.gates(source);
        var consumerHandoffs = OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentConsumerCatalog
                .handoffs(source);
        var scorecard = OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentScorecardCatalog.scorecard(
                sourceSnapshots,
                ownershipRules,
                driftGuards,
                boundaryGuards,
