...
final class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistrySupport {
    ...
    private OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistrySupport() {
    }
    ...
    static OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
            response(
                    ...
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                            .SourceDigestSnapshot> sourceDigests,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                            .ManifestEntry> manifest,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                            .ConsumerAudience> audiences,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                            .PackageSection> packageSections,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                            .AcceptanceCriterion> acceptanceCriteria,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                            .CiMatrixEntry> ciMatrix,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                            .BoundaryLock> boundaryLocks,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                            .HandoffChecklistItem> handoffChecklist,
                    List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
        ...
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-source-plan-"
                + SOURCE_PLAN);
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-required-archive-"
                + REQUIRED_ARCHIVE_VERIFICATION_PLAN);
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-operator-plan-"
                + OPERATOR_HANDOFF_PLAN);
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-source-digest-version-"
                + sourceDigest.version());
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-source-digest-status-"
                + sourceDigest.status());
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-source-digest-count-"
                + sourceDigestCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-manifest-count-"
                + manifestCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-passed-manifest-count-"
                + passedManifestCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-audience-count-"
                + audienceCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-ready-audience-count-"
                + readyAudienceCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-section-count-"
                + packageSectionCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-ready-section-count-"
                + readyPackageSectionCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-acceptance-count-"
                + acceptanceCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-passed-acceptance-count-"
                + passedAcceptanceCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-ci-matrix-count-"
                + ciMatrixCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-read-only-ci-matrix-count-"
                + readOnlyCiMatrixCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-boundary-lock-count-"
                + boundaryLockCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-locked-boundary-count-"
                + lockedBoundaryCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-checklist-count-"
                + handoffChecklistCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-ready-checklist-count-"
                + readyChecklistCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-scorecard-count-"
                + scorecardCopy.size());
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-passed-scorecard-count-"
                + passedScorecardCount);
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-markdown-section-count-"
        ...
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-no-raw-endpoint-resolution");
        checks.add("minimal-read-only-gate-operator-ci-handoff-consumer-package-no-managed-audit-http");

        String status = "passed".equals(sourceDigest.status())
    ...
    private static int countReadyAudiences(
            List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                    .ConsumerAudience> entries
    ) {
        return (int) entries.stream()
                .filter(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                        .ConsumerAudience::ready)
                .count();
    }

    private static int countReadySections(
            List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                    .PackageSection> entries
    ) {
        return (int) entries.stream()
                .filter(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                        .PackageSection::ready)
                .count();
    }
    ...
    private static int countReadOnlyCiMatrix(
            List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                    .CiMatrixEntry> entries
    ) {
        return (int) entries.stream()
                .filter(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                        .CiMatrixEntry::readOnly)
                .count();
    }

    private static int countLockedBoundaries(
            List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                    .BoundaryLock> entries
    ) {
        return (int) entries.stream()
                .filter(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                        .BoundaryLock::locked)
    ...
    private static int countReadyChecklist(
            List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                    .HandoffChecklistItem> entries
    ) {
        return (int) entries.stream()
                .filter(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse
                        .HandoffChecklistItem::ready)
                .count();
    }
