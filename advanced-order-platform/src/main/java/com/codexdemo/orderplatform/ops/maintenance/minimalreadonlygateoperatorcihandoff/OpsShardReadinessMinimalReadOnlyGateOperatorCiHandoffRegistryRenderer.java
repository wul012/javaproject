...
final class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryRenderer {
  ...
  static List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.MarkdownSection>
      render(
          List<
    ...
    sections.add(
        OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffLaneRenderer.render(operatorLanes));
