...
final class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightFoundationLaneCatalog {

    private OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightFoundationLaneCatalog() {
    }
    ...
    static List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightResponse
            .ComparisonLane> foundationLanes() {
        return List.of(
                lane("comparison-lane-identity-subject", "v1287",
                        ...
                        OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightIdentityService
                                .ENDPOINT),
                lane("comparison-lane-identity-envelope", "v1288",
                        ...
                        OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightCloseoutHandoffLedgerService
                                .ENDPOINT),
                lane("comparison-lane-request-id", "v1289",
                        ...
                        OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightIdentityService
                                .ENDPOINT),
                lane("comparison-lane-correlation-window", "v1290",
    ...
    private static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightResponse
        ...
        return OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightSupport
                .lane(code, versionRange, comparisonLane, comparisonQuestion, acceptanceControl, sourceEndpoint);
    }
}
