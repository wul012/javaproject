...
final class OpsShardReadinessCodeWalkthroughQualityGateRegistryRenderer {
  ...
  static List<OpsShardReadinessCodeWalkthroughQualityGateRegistryResponse.MarkdownSection> render(
