...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverFakeShellArchiveEchoRecords.RehearsalSandboxEndpointCredentialResolverFakeShellArchiveEvidenceFile;
...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverFakeShellArchiveEchoRecords.RehearsalSandboxEndpointCredentialResolverFakeShellArchiveSnippet;
...
final class ReleaseApprovalSandboxEndpointCredentialResolverFakeShellArchiveEchoSupport {
  ...
  private static final List<String> EVIDENCE_FILE_IDS =
      List.of(
          "v264-html-archive",
          "v264-screenshot",
          "v264-explanation",
  ...
  private static final List<String> REQUIRED_SNIPPET_IDS =
      List.of(
          "v264-html-title",
          "v264-html-ready",
  ...
  static RehearsalSandboxEndpointCredentialResolverFakeShellArchiveVerification
      archiveVerification() {
  ...
  static RehearsalSandboxEndpointCredentialResolverFakeShellArchiveSideEffectBoundary
      sideEffectBoundary() {
  ...
  static boolean archiveEvidenceReady(
    ...
    return archiveEvidence.archiveFileCount() == ARCHIVE_FILE_COUNT
        ...
        && archiveEvidence.files().stream()
            .allMatch(
                file -> file.expectedPresent() && file.expectedNonEmpty() && file.digestRequired())
        && archiveEvidence.snippets().stream()
            .allMatch(
                RehearsalSandboxEndpointCredentialResolverFakeShellArchiveSnippet::matchedByNode);
  }
