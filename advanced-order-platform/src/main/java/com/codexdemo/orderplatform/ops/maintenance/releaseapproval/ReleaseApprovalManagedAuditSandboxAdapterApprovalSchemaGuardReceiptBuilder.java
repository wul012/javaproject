...
final class ReleaseApprovalManagedAuditSandboxAdapterApprovalSchemaGuardReceiptBuilder {
  ...
  private static final List<String> WARNING_DIGEST_WARNING_INPUT_NAMES =
      List.of("managedAuditSandboxAdapterApprovalSchemaGuardReceiptWarnings");
  ...
  private static final String NODE_V224_PROFILE = "managed-audit-sandbox-adapter-dry-run-plan.v1";

  private static final String NODE_V224_ENDPOINT =
      "/api/v1/audit/managed-audit-sandbox-adapter-dry-run-plan";

  private static final String NODE_V224_STATE = "sandbox-adapter-dry-run-plan-ready";
  ...
  ReleaseApprovalRehearsalResponseRecords
    ...
    ReleaseApprovalRehearsalResponseRecords.RehearsalManagedAuditSandboxPlanEvidence
        nodeV224SandboxPlan = nodeV224SandboxPlan();
    ReleaseApprovalRehearsalResponseRecords.RehearsalSandboxOwnerApprovalBoundary
        ownerApprovalBoundary = ownerApprovalBoundary();
    ReleaseApprovalRehearsalResponseRecords.RehearsalSandboxSchemaRehearsalBoundary
    ...
    ReleaseApprovalRehearsalResponseRecords.RehearsalSandboxExecutionBoundary executionBoundary =
        executionBoundary();
    ReleaseApprovalRehearsalResponseRecords.RehearsalSandboxQualityGateBoundary
        qualityGateBoundary = qualityGateBoundary();
    ...
    String guardDigest =
        ReleaseApprovalDigestSupport.digest(
            List.of(
                ...
                ReleaseApprovalDigestSupport.line(
                    "sourceExternalAdapterMigrationGuardSchemaVersion", SOURCE_SCHEMA_VERSION),
                ReleaseApprovalDigestSupport.line(
                    "consumedByNodeSandboxPlanVersion", NODE_V224_VERSION),
                ReleaseApprovalDigestSupport.line(
                    "consumedByNodeSandboxPlanProfile", NODE_V224_PROFILE),
                ReleaseApprovalDigestSupport.line(
                    "consumedByNodeSandboxPlanState", NODE_V224_STATE),
                ReleaseApprovalDigestSupport.line(
                    "nodeV224ReadyForPlan",
                    nodeV224SandboxPlan.readyForManagedAuditSandboxAdapterDryRunPlan()),
                ReleaseApprovalDigestSupport.line(
                    "nodeV224ConnectsManagedAudit", nodeV224SandboxPlan.connectsManagedAudit()),
                ReleaseApprovalDigestSupport.line(
                ...
                ReleaseApprovalDigestSupport.line(
                    ...
                    executionBoundary.javaManagedAuditStoreWritten()),
                ReleaseApprovalDigestSupport.line(
                    "javaSqlExecuted", executionBoundary.javaSqlExecuted()),
                ReleaseApprovalDigestSupport.line(
  ...
  List<String> warningDigestBoundaryLines(
    ...
    return List.of(
        ReleaseApprovalDigestSupport.line(
            "sandboxAdapterApprovalSchemaGuardDigest", receipt.guardDigest()),
        ReleaseApprovalDigestSupport.line(
            "sandboxAdapterOwnerApprovalArtifactProvidedByJava",
        ...
        ReleaseApprovalDigestSupport.line(
            "sandboxAdapterJavaSqlExecuted", receipt.executionBoundary().javaSqlExecuted()),
        ReleaseApprovalDigestSupport.line(
            "sandboxAdapterQualityGateBuilderOrHelperSplitApplied",
  ...
  private static ReleaseApprovalRehearsalResponseRecords.RehearsalManagedAuditSandboxPlanEvidence
      nodeV224SandboxPlan() {
  ...
  private static ReleaseApprovalRehearsalResponseRecords.RehearsalSandboxCredentialBoundary
    ...
    return new ReleaseApprovalRehearsalResponseRecords.RehearsalSandboxCredentialBoundary(
        true, "ORDEROPS_MANAGED_AUDIT_SANDBOX_CREDENTIAL_HANDLE", false, false, false, false);
  }
