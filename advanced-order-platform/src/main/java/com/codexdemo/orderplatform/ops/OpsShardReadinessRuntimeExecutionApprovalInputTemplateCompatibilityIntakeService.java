...
public class OpsShardReadinessRuntimeExecutionApprovalInputTemplateCompatibilityIntakeService {
    ...
    public OpsShardReadinessRuntimeExecutionApprovalInputTemplateCompatibilityIntakeResponse intake() {
    ...
    private String intakeStatus(
        ...
        boolean sourceComplete = sourceReceipt.templateCompatibilityReceiptPresent()
                && sourceReceipt.templateCompatibilityReceiptComplete()
                && sourceReceipt.sourceJavaInputCanonical()
                && sourceReceipt.nodeTemplateValidatorPresent();
        boolean canonicalInputsStillMissing = !sourceReceipt.nodeApprovedRuntimeWindowPresent()
                && !sourceReceipt.correlatedOperatorApprovalRecordPresent()
                && !sourceReceipt.completeCrossProjectRuntimeExecutionPacketPresent()
                && !sourceReceipt.canonicalApprovalInputsCreatedByJava();
        boolean runtimeStillClosed = !sourceReceipt.runtimeGateApprovalPresent()
        ...
        return sourcePassed && sourceComplete && canonicalInputsStillMissing && runtimeStillClosed ? "passed" : "blocked";
    }
}
