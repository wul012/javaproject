...
final
class ReleaseApprovalSandboxEndpointCredentialResolverCredentialHandleApprovalContractCatalog {
  ...
  private static final List<RequiredFieldTemplate> REQUIRED_FIELDS =
      List.of(
          requiredField(
              "credential_handle",
              "Credential handle",
              "stable non-secret credential handle",
          ...
          requiredField(
              ...
              "Bind the handle review to the signed approval chain."),
          requiredField(
  ...
  private static final List<String> SOURCE_COMPLETED_PREREQUISITE_IDS =
      List.of("java-mini-kv-decision-echo", "signed-human-approval-artifact");
  ...
  static List<RehearsalCredentialHandleApprovalRequiredField> requiredFields() {
    return REQUIRED_FIELDS.stream()
        .map(
            template ->
                new RehearsalCredentialHandleApprovalRequiredField(
                    template.id(),
                    template.label(),
                    true,
  ...
  static List<RehearsalCredentialHandleApprovalProhibitedField> prohibitedFields() {
    return PROHIBITED_FIELDS.stream()
        .map(
            template ->
                new RehearsalCredentialHandleApprovalProhibitedField(
  ...
  static List<RehearsalCredentialHandleApprovalRejectionReason> rejectionReasons() {
    return REJECTION_REASONS.stream()
        .map(
            template ->
                new RehearsalCredentialHandleApprovalRejectionReason(
  ...
  static List<RehearsalCredentialHandleApprovalNoGoBoundary> noGoBoundaries() {
    return NO_GO_BOUNDARIES.stream()
        .map(
            template ->
                new RehearsalCredentialHandleApprovalNoGoBoundary(
  ...
  static List<RehearsalCredentialHandleApprovalUpstreamEchoRequest> upstreamEchoRequests() {
    return UPSTREAM_ECHO_REQUESTS.stream()
        .map(
            template ->
                new RehearsalCredentialHandleApprovalUpstreamEchoRequest(
