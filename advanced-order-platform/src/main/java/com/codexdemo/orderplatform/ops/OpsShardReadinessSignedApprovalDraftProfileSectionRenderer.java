...
final class OpsShardReadinessSignedApprovalDraftProfileSectionRenderer {
    ...
    static List<OpsShardReadinessSignedApprovalDraftProfileSectionRegistryResponse.RenderedSection> render(
        ...
        return sections.stream()
                .map(section -> new OpsShardReadinessSignedApprovalDraftProfileSectionRegistryResponse
                        .RenderedSection(
                                section.order(),
                                section.code(),
                                "### " + section.heading(),
    ...
    private static String markdownBody(
            OpsShardReadinessSignedApprovalDraftProfileSectionRegistryResponse.DraftProfileSection section,
            List<OpsShardReadinessSignedApprovalDraftProfileSectionRegistryResponse.FieldEntry> fieldEntries
    ) {
