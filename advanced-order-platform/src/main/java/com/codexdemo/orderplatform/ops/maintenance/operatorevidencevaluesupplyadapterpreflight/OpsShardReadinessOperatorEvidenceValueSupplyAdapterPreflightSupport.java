...
final class OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightSupport {
  ...
  static OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightResponse response(
    ...
    List<OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightResponse.AdapterSlot>
        slotCopy = List.copyOf(slots);
    List<OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightResponse.AdapterRule>
        ruleCopy = List.copyOf(rules);
    int passedSlotCount =
  ...
  static OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightResponse.AdapterRule rule(
      String code, String category, String rule, String enforcement) {
