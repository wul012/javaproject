...
final class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffLaneCatalog {
  ...
  static List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.OperatorLane>
      lanes(
  ...
  private static OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.OperatorLane
      lane(String lane, int order, String owner, String sourceEvidence, String instruction) {
    return new OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.OperatorLane(
        lane, order, owner, sourceEvidence, true, instruction);
  }
}
