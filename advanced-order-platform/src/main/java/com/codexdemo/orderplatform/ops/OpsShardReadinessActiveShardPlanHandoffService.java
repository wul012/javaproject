...
public class OpsShardReadinessActiveShardPlanHandoffService {
    ...
    static final String ENDPOINT = "/api/v1/ops/shard-readiness/active-shard-plan-handoff";
    static final String FIXTURE_ENDPOINT = "/contracts/java-shard-readiness-active-shard-plan-handoff-v158.fixture.json";
    static final String EVIDENCE_PATH = "e/158/evidence/java-shard-readiness-active-shard-plan-handoff-v158.json";
