...
final
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReviewPackagePreflightFoundationSlotCatalog {
  ...
  static List<
    ...
    return List.of(
        ...
        slot(
            ...
            "operatorIdentity",
            "Expose reviewed operator identity without credential capture.",
        ...
        slot(
            ...
            "operatorRole",
            "Expose reviewed operator role before manual draft materialization.",
        ...
        slot(
            ...
            "captureWindowId",
            "Bind planned capture window id without opening the window.",
        ...
        slot(
            ...
            "Expose capture channel policy while adapters stay disabled.",
        ...
        slot(
            ...
            "Prepare signature algorithm policy for review.",
        ...
        slot(
            ...
            "Keep detached signature material out of band.",
        ...
        slot(
            ...
            "Carry signature redaction policy without raw material.",
        ...
        slot(
            ...
            "Expose source evidence version for later citation.",
