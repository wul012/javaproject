...
public class OpsShardReadinessEchoService {
  ...
  public static final String ENDPOINT = "/api/v1/ops/shard-readiness/echo";
  public static final String FIXTURE_ENDPOINT =
      "/contracts/java-shard-readiness-echo-v174.fixture.json";
  public static final String EVIDENCE_PATH = "e/174/evidence/java-shard-readiness-echo-v174.json";
