    ...
    static List<OpsShardReadinessCodeWalkthroughComplianceRegistryResponse.DocumentationRule>
        ...
        return List.of(
                ...
                rule(
                        "utf8-source",
                        "java-docs",
                        "new walkthrough files are stored as UTF-8 markdown"
                )
        );
    }

    private static OpsShardReadinessCodeWalkthroughComplianceRegistryResponse.DocumentationRule
            rule(String code, String owner, String rule) {
