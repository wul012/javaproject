...
final
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessLaneFoundationLaneCatalog {
  ...
  static List<
    ...
    return List.of(
        lane(
            ...
            "Review request manifest identity before manual package authoring.",
        ...
        lane(
            ...
            "Pin signed approval template digest.",
        ...
        lane(
            ...
            "Pin approval packet review digest.",
        ...
        lane(
            ...
            "operatorIdentity",
            "Review operator identity as alias-only evidence.",
        ...
        lane(
            ...
            "operatorRole",
            "Review operator role without granting authority.",
        ...
        lane(
            ...
            "captureWindowId",
            "Review capture window id without opening runtime.",
        ...
        lane(
            ...
            "Review capture channel policy without write route exposure.",
        ...
        lane(
            ...
            "Review signature algorithm policy without signature material.",
        ...
        lane(
            ...
            "Review detached signature placeholder as empty material.",
        ...
        lane(
            ...
            "signatureMaterialRedactionPolicy",
            "Review signature material redaction policy.",
        ...
        lane(
            ...
            "Pin approval statement digest without statement text.",
        ...
        lane(
            ...
            "Review source evidence version without importing evidence.",
