...
public class OpsShardReadinessRouteCleanupReleaseHandoffService {
    ...
    public OpsShardReadinessRouteCleanupReleaseHandoffResponse handoff() {
        ...
        List<OpsShardReadinessRouteCleanupReleaseHandoffResponse.HandoffItem> items = List.of(
                ...
                item("source-plan-alignment", sourceAlignment.sourcePlan() + ":" + sourceAlignment.status())
        );
