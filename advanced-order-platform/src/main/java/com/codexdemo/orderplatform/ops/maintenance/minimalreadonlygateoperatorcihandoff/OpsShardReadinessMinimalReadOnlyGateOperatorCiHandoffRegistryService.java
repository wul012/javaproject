...
public class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryService {
  ...
  public OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse registry() {
    ...
    var sourceArchives =
        OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffSourceArchiveCatalog.snapshots(
            sourceArchive);
    var lanes =
        OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffLaneCatalog.lanes(sourceArchive);
    var ciBatches = OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffBatchCatalog.batches();
    var boundaryLocks =
        OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffBoundaryLockCatalog.locks();
  ...
  private List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.ScorecardEntry>
    ...
    return List.of(
        ...
        score(
            ...
            sourceArchive.scorecardEntryCount(),
  ...
  private int passedSourceArchiveScorecardEntryCount(
      OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryResponse
          sourceArchive) {
    return (int)
        sourceArchive.scorecard().stream().filter(score -> "passed".equals(score.status())).count();
  }
  ...
  private OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.ScorecardEntry
    ...
    return new OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.ScorecardEntry(
