...
final class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffBatchCatalog {
  ...
  static List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.CiBatchPlan>
      batches() {
    return List.of(
        batch(
  ...
  private static OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.CiBatchPlan
      batch(String batch, int order, String commandFamily, String scope, boolean blocksNextBatch) {
    return new OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.CiBatchPlan(
        batch, order, commandFamily, scope, true, blocksNextBatch);
  }
}
