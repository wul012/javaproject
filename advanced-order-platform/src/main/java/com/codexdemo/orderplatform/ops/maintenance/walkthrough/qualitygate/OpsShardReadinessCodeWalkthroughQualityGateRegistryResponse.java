...
public record OpsShardReadinessCodeWalkthroughQualityGateRegistryResponse(
  ...
  public record ExplanationRubric(
      String section, String mustExplain, String standoutSignal, int minimumEvidencePoints) {}

  public record EvidenceAnchor(
      String anchor, String owner, String source, String requiredProof, boolean runtimeFree) {}

  public record ReviewChecklist(
      String item, String reviewerQuestion, String releaseBlocker, boolean blocksRelease) {}
