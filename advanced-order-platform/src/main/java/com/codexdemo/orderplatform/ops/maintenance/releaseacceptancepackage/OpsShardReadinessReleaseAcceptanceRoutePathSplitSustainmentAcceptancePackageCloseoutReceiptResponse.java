...
public
record OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutReceiptResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record AcceptedCriterion(String name, String evidence, boolean required, String status) {}
}
