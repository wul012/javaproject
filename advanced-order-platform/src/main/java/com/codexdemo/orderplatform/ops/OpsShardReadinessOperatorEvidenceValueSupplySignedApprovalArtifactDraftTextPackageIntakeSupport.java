...
final class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageIntakeSupport {
    ...
    private OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageIntakeSupport() {
    }

    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageIntakeResponse response(
            String version,
            String endpoint,
            String profile,
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageIntakeResponse
                    .IntakeField> fields,
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageIntakeResponse
                    .IntakeGuard> guards,
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageIntakeResponse
        ...
        checks.add("signed-approval-artifact-draft-text-package-intake-field-count-" + fieldCopy.size());
        checks.add("signed-approval-artifact-draft-text-package-intake-passed-field-count-" + passedFieldCount);
        checks.add("signed-approval-artifact-draft-text-package-intake-guard-count-" + guardCopy.size());
        checks.add("signed-approval-artifact-draft-text-package-intake-passed-guard-count-" + passedGuardCount);
        ...
        checks.add("signed-approval-artifact-draft-text-package-intake-source-node-instruction-preflight-"
                + SOURCE_NODE_INSTRUCTION_PREFLIGHT_VERSION);
        checks.add("signed-approval-artifact-draft-text-package-intake-source-java-instruction-preflight-"
        ...
        checks.add("signed-approval-artifact-draft-text-package-intake-no-detached-signature-acceptance");
    ...
    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageIntakeResponse
            .IntakeField field(
                    String code,
                    String versionRange,
