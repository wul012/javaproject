...
final class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightAssuranceLaneCatalog {

    private OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightAssuranceLaneCatalog() {
    }
    ...
    static List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightResponse
            .ComparisonLane> evidenceValuePolicyLanes() {
        return List.of(
                lane("comparison-lane-source-evidence-handle-set", "v1298",
                ...
                lane("comparison-lane-source-evidence-freeze", "v1299",
                ...
                lane("comparison-lane-source-evidence-lineage", "v1300",
                ...
                lane("comparison-lane-operator-value-handle", "v1301",
                ...
                lane("comparison-lane-operator-value-redaction", "v1302",
                ...
                lane("comparison-lane-policy-assertion", "v1303",
                ...
                lane("comparison-lane-review-state", "v1304",
                ...
                lane("comparison-lane-approval-grant-absence", "v1305",
    ...
    static List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparisonPreflightResponse
            .ComparisonLane> executionCloseoutLanes() {
        return List.of(
                lane("comparison-lane-execution-lock", "v1306",
                ...
                lane("comparison-lane-no-runtime-payload", "v1307",
                ...
                lane("comparison-lane-no-write-routing", "v1308",
                ...
                lane("comparison-lane-no-active-shard-router", "v1309",
                ...
                lane("comparison-lane-no-sibling-mutation", "v1310",
                ...
                lane("comparison-lane-archive-closeout", "v1311",
