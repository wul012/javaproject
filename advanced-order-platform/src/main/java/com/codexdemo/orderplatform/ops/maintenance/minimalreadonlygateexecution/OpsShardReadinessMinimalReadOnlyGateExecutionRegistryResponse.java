...
public record OpsShardReadinessMinimalReadOnlyGateExecutionRegistryResponse(
  ...
  public record GateCheck(String code, String group, String evidence, boolean passed) {}
  ...
  public record ArchiveRequirement(
      String artifact, String producer, String evidence, boolean required) {}

  public record OperatorHandoff(String step, String owner, String instruction, boolean manual) {}
