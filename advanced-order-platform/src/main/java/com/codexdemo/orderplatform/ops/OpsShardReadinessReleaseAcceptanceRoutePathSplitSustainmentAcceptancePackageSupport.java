...
final class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageSupport {
    ...
    static OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse response(
            String version,
            String endpoint,
        ...
        var checks = checks(source, sourceSnapshotCopy, lineageCopy, decisionCopy, archiveCopy, reviewCopy,
                ciCopy, runtimeBoundaryCopy, nextChangeCopy, scorecardCopy, markdownCopy);
        String status = status(source, sourceSnapshotCopy, lineageCopy, decisionCopy, archiveCopy, reviewCopy,
                ciCopy, runtimeBoundaryCopy, nextChangeCopy, scorecardCopy, markdownCopy);
    ...
    private static List<String> checks(
        ...
        checks.add("release-acceptance-route-path-split-acceptance-package-node-parallel-plan-"
                + NODE_PARALLEL_PLAN);
        checks.add("release-acceptance-route-path-split-acceptance-package-source-sustainment-version-"
                + source.version());
        checks.add("release-acceptance-route-path-split-acceptance-package-source-sustainment-status-"
                + source.status());
        checks.add("release-acceptance-route-path-split-acceptance-package-source-closeout-version-"
                + source.sourceCloseoutVersion());
        checks.add("release-acceptance-route-path-split-acceptance-package-source-split-version-"
                + source.sourceSplitVersion());
        checks.add("release-acceptance-route-path-split-acceptance-package-source-ownership-count-"
                + source.ownershipRuleCount());
        checks.add("release-acceptance-route-path-split-acceptance-package-source-drift-count-"
                + source.driftGuardCount());
        checks.add("release-acceptance-route-path-split-acceptance-package-source-boundary-count-"
                + source.boundaryGuardCount());
        checks.add("release-acceptance-route-path-split-acceptance-package-source-ci-count-"
                + source.ciGateCount());
        checks.add("release-acceptance-route-path-split-acceptance-package-source-consumer-count-"
                + source.consumerHandoffCount());
        checks.add("release-acceptance-route-path-split-acceptance-package-source-scorecard-count-"
                + source.scorecardEntryCount());
        checks.add("release-acceptance-route-path-split-acceptance-package-source-snapshot-count-"
                + sourceSnapshots.size());
        checks.add("release-acceptance-route-path-split-acceptance-package-lineage-entry-count-"
                + lineage.size());
        checks.add("release-acceptance-route-path-split-acceptance-package-decision-record-count-"
                + decisions.size());
        checks.add("release-acceptance-route-path-split-acceptance-package-accepted-decision-count-"
                + count(decisions, OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse
                .DecisionRecord::accepted));
        checks.add("release-acceptance-route-path-split-acceptance-package-archive-item-count-"
                + archiveItems.size());
        checks.add("release-acceptance-route-path-split-acceptance-package-ready-archive-item-count-"
                + count(archiveItems, OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse
                .ArchiveItem::ready));
        checks.add("release-acceptance-route-path-split-acceptance-package-review-item-count-"
                + reviewItems.size());
        checks.add("release-acceptance-route-path-split-acceptance-package-passed-review-item-count-"
                + count(reviewItems, OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse
                .ReviewItem::passed));
        checks.add("release-acceptance-route-path-split-acceptance-package-ci-evidence-count-"
                + ciEvidence.size());
        checks.add("release-acceptance-route-path-split-acceptance-package-passed-ci-evidence-count-"
                + count(ciEvidence, OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse
                .CiEvidence::passed));
        checks.add("release-acceptance-route-path-split-acceptance-package-runtime-boundary-count-"
                + runtimeBoundaries.size());
        checks.add("release-acceptance-route-path-split-acceptance-package-locked-runtime-boundary-count-"
                + count(runtimeBoundaries,
                OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse
                        .RuntimeBoundary::locked));
        checks.add("release-acceptance-route-path-split-acceptance-package-next-change-rule-count-"
                + nextChangeRules.size());
        checks.add("release-acceptance-route-path-split-acceptance-package-ready-next-change-rule-count-"
                + count(nextChangeRules,
                OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse
                        .NextChangeRule::ready));
        checks.add("release-acceptance-route-path-split-acceptance-package-scorecard-entry-count-"
                + scorecard.size());
        checks.add("release-acceptance-route-path-split-acceptance-package-passed-scorecard-entry-count-"
                + count(scorecard, OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse
                .ScorecardEntry::passed));
        checks.add("release-acceptance-route-path-split-acceptance-package-markdown-section-count-"
                + markdownSections.size());
        checks.add("release-acceptance-route-path-split-acceptance-package-source-route-delegate-owner-held");
        ...
        checks.add("release-acceptance-route-path-split-acceptance-package-no-managed-audit-connection");
        checks.add("release-acceptance-route-path-split-acceptance-package-no-deployment-rollback");
        checks.add("release-acceptance-route-path-split-acceptance-package-no-node-or-minikv-auto-start");
    ...
    private static String status(
        ...
        boolean countsMatch = sourceSnapshots.size() == EXPECTED_SOURCE_SNAPSHOT_COUNT
        ...
        boolean packagePassed = sourceSnapshots.stream().allMatch(snapshot -> "passed".equals(snapshot.status()))
