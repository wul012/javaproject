...
final class ReleaseApprovalSandboxEndpointCredentialResolverPreImplementationPlanIntakeEchoSupport {
  ...
  static final String SOURCE_SPAN = "Node v270 credential resolver pre-implementation plan intake";
  ...
  static RehearsalSandboxEndpointCredentialResolverBlockedDecisionUpstreamEchoVerificationSource
      sourceNodeV269(boolean sourceAccepted, String verificationDigest) {
  ...
  static RehearsalSandboxEndpointCredentialResolverPreImplementationPlanIntakeSourceEcho
      sourceNodeV270(
  ...
  static List<RehearsalSandboxEndpointCredentialResolverPreImplementationBoundary>
  ...
  static RehearsalSandboxEndpointCredentialResolverPlanIntake planIntake(
      RehearsalSandboxEndpointCredentialResolverPreImplementationPlan plan, String intakeDigest) {
  ...
  static RehearsalSandboxEndpointCredentialResolverPreImplementationPlanIntakeChecks checks(
    ...
    return new RehearsalSandboxEndpointCredentialResolverPreImplementationPlanIntakeChecks(
        ...
        !plan.rawEndpointUrlParseAllowed() && !sourceNodeV269.rawEndpointUrlParsed(),
        !plan.secretProviderRuntimeAllowed() && !sourceNodeV269.secretProviderInstantiated(),
        !plan.realResolverImplementationAllowed() && !sourceNodeV269.resolverClientInstantiated(),
        !plan.externalRequestAllowed()
            && !sourceNodeV269.externalRequestSent()
            && !sourceNodeV269.connectsManagedAudit(),
        !plan.schemaMigrationAllowed() && !sourceNodeV269.schemaMigrationExecuted(),
  ...
  static RehearsalSandboxEndpointCredentialResolverPreImplementationPlanIntakeChecks
      checksWithReadiness(
  ...
  static RehearsalSandboxEndpointCredentialResolverPreImplementationPlanIntakeSideEffectBoundary
      sideEffectBoundary() {
  ...
  static boolean planComplete(
    ...
    return NODE_V270_PLAN_VERSION.equals(plan.planVersion())
        ...
        && plan.boundaries().stream()
            .map(RehearsalSandboxEndpointCredentialResolverPreImplementationBoundary::code)
            .toList()
        ...
        && plan.boundaries().stream()
            .allMatch(boundary -> BOUNDARY_STATUS.equals(boundary.status()));
  }

  static boolean planIntakeComplete(
      RehearsalSandboxEndpointCredentialResolverPlanIntake planIntake) {
  ...
  private static boolean hasBoundary(
      RehearsalSandboxEndpointCredentialResolverPreImplementationPlan plan, String code) {
    return plan.boundaries().stream()
        .anyMatch(
            boundary -> code.equals(boundary.code()) && BOUNDARY_STATUS.equals(boundary.status()));
  }
}
