...
public class OpsShardReadinessManualEvidenceWorksheetAssuranceController {
  ...
  private final OpsShardReadinessManualEvidenceWorksheetImporterPreflightService
      importerPreflightService;
  private final OpsShardReadinessManualEvidenceWorksheetRouteProfileSummaryService
      routeProfileSummaryService;
  private final OpsShardReadinessManualEvidenceWorksheetArchivePlanService archivePlanService;
  private final OpsShardReadinessManualEvidenceWorksheetOperatorHandoffService
  ...
  @GetMapping(OpsShardReadinessManualEvidenceWorksheetRoutePaths.MANUAL_EVIDENCE_WORKSHEET_CLOSEOUT)
