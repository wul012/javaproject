...
public record OpsShardReadinessCandidateDocumentHandoffResponse(
  ...
  public record SourceLineage(
      String code, String version, String source, String endpoint, String role, String status) {}
  ...
  public record ArchiveEntry(
      String code, String path, String retention, String purpose, String status) {}

  public record ConsumerRule(String code, String rule, String enforcement, String status) {}
}
