...
final class OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierBoundaryCatalog {
    ...
    static List<OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierResponse.BoundarySnapshot>
            boundaries(RehearsalManagedAuditSandboxConnectionPreconditionReceipt receipt) {
        return List.of(
                boundary("owner-approval", receipt.ownerApprovalBoundary().ownerApprovalArtifactIdField(),
                ...
                boundary("credential-handle", receipt.credentialBoundary().credentialHandleNameField(),
                ...
                boundary("schema-rehearsal", receipt.schemaRehearsalBoundary().schemaRehearsalIdField(),
                ...
                boundary("rollback-path", receipt.rollbackPathBoundary().rollbackPathIdField(),
                ...
                boundary("java-execution", "actualConnectionAttemptedByJava=false",
                        true,
    ...
    private static OpsShardReadinessSandboxConnectionBlockedExecutionContextDossierResponse.BoundarySnapshot boundary(
            String name,
            String evidence,
            boolean required,
            boolean closed
