...
public class OpsShardReadinessRouteCleanupReviewerPacketService {
    ...
    public OpsShardReadinessRouteCleanupReviewerPacketResponse packet() {
        OpsShardReadinessRouteCleanupEvidenceRegisterResponse register = evidenceRegisterService.register();
        ...
        List<OpsShardReadinessRouteCleanupReviewerPacketResponse.ReviewerCheck> checks = List.of(
                check("registered-evidence", "endpoint register is populated",
                ...
                check("latest-version", "packet labels current Java evidence version",
                        OpsShardReadinessRouteCleanupEvidenceAnalyzer.latestJavaVersionLabel())
        );
        boolean passed = register.status().equals("passed")
