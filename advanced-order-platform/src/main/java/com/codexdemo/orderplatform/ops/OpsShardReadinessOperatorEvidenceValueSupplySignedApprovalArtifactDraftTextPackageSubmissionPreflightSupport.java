...
final class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightSupport {
    ...
    private OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightSupport() {
    }
    ...
    response(
            ...
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightResponse
                    .ComparisonControl> comparisonControls,
            List<OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightResponse
                    .SubmissionGate> gates,
        ...
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-slot-count-"
                + slotCopy.size());
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-passed-slot-count-"
                + passedSlotCount);
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-comparison-control-count-"
                + controlCopy.size());
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-passed-comparison-control-count-"
                + passedControlCount);
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-gate-count-"
                + gateCopy.size());
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-source-plan-" + SOURCE_PLAN);
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-source-node-review-"
                + SOURCE_NODE_REVIEW_PREFLIGHT_VERSION);
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-source-java-review-"
                + SOURCE_JAVA_REVIEW_PREFLIGHT_VERSION);
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-no-package-acceptance");
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-no-draft-text-parsing");
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-no-detached-signature-parsing");
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-no-approval-grant");
        checks.add("signed-approval-artifact-draft-text-package-submission-preflight-no-runtime-or-sibling-mutation");
    ...
    static OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightResponse
        ...
        return new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightResponse
                .SubmissionSlot(code, versionRange, submissionSlot, comparisonQuestion, materialComparisonControl,
