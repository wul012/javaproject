    ...
    static List<Item> items() {
        return List.of(
                item("segment-catalog", 471, 472,
                        ...
                        "catalog-maintainer", "split-catalog-readiness"),
                item("continuity", 473, 474,
                        ...
                        "release-reviewer", "version-continuity"),
                item("latest-sibling-report", 475, 476,
                        ...
                        "node-plan-consumer", "latest-sibling-source-plan"),
                item("handoff-pair-audit", 477, 478,
                        ...
                        "handoff-reviewer", "service-route-pairing"),
                item("boundary-drift", 479, 480,
                        ...
                        "runtime-boundary-reviewer", "read-only-boundary"),
                item("source-plan-alignment", 481, 482,
                        ...
                        "roadmap-reviewer", "node-v549-alignment"),
                item("test-budget-plan", 483, 484,
                        ...
                        "ci-reviewer", "non-docker-regression"),
                item("archive-manifest", 485, 486,
                        ...
                        "archive-reviewer", "versioned-evidence-path"),
                item("closeout", 487, 488,
                        ...
                        "operator-handoff-reviewer", "maintenance-closeout")
        );
    }
