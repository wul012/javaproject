...
public
record OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record DraftPreflightGate(String code, String category, String gate, String enforcement) {}
}
