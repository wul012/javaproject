...
final class ReleaseApprovalRehearsalHandoffHintBuilder {
  ...
  ReleaseApprovalRehearsalResponseRecords.RehearsalAuditPersistenceHandoffHint
    ...
    ReleaseApprovalContextHeaderField managedAuditCandidateVersion =
    ...
    ReleaseApprovalContextHeaderField managedAuditCandidateDigest =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField managedAuditSinkMode =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField managedAuditRetentionDays =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField managedAuditRotationPolicy =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    boolean managedAuditRetentionWithinJavaRetention =
        retentionDaysWithinJavaRetention(
            normalizedManagedAuditRetentionDays, retentionFixture.retentionDays());
    ...
    AuditPersistenceHandoffFlags auditPersistenceHandoffFlags =
        AuditPersistenceHandoffFlags.fromReadOnly(
  ...
  ReleaseApprovalRehearsalResponseRecords.RehearsalApprovalRecordHandoffHint
    ...
    List<String> warnings = new ArrayList<>();
    ReleaseApprovalContextHeaderField approvalBindingContractVersion =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField approvalBindingContractDigest =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField approvalRequestId =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField approvalDecisionState =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    ReleaseApprovalContextHeaderField approvalRecordCorrelationId =
        ReleaseApprovalContextHeaderField.normalized(
            warnings,
    ...
    boolean approvalRecordFixtureReadOnly =
        approvalRecordFixture.nodeMayConsume()
    ...
    ApprovalRecordHandoffFlags approvalRecordHandoffFlags =
        ApprovalRecordHandoffFlags.fromReadOnly(
  ...
  ReleaseApprovalRehearsalResponseRecords.RehearsalApprovalHandoffVerificationMarker
    ...
    boolean nodeV211HandoffAccepted =
        ReleaseApprovalContractConstants
                .RELEASE_APPROVAL_REHEARSAL_APPROVAL_RECORD_HANDOFF_HINT_VERSION
                .equals(approvalRecordHandoffHint.hintVersion())
            && ReleaseApprovalUpstreamContractConstants.NODE_V210_APPROVAL_BINDING_CONTRACT_VERSION
                .equals(approvalRecordHandoffHint.approvalBindingContractVersion())
    ...
    boolean readyForNodeV213RestoreDrillPlan =
        nodeV211HandoffAccepted && nodeV211NoWriteBoundaryAccepted;
    ...
    return new ReleaseApprovalRehearsalResponseRecords.RehearsalApprovalHandoffVerificationMarker(
        ...
        ReleaseApprovalUpstreamContractConstants.NODE_V211_MANAGED_AUDIT_PROFILE_VERSION,
        ReleaseApprovalUpstreamContractConstants.NODE_V211_MANAGED_AUDIT_PACKET_STATE,
        ReleaseApprovalUpstreamContractConstants.NODE_V211_MANAGED_AUDIT_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants.NODE_V211_MANAGED_AUDIT_REQUEST_ID,
        ReleaseApprovalUpstreamContractConstants.NODE_V211_MANAGED_AUDIT_PACKET_VERSION,
        ReleaseApprovalUpstreamContractConstants.NODE_V210_APPROVAL_BINDING_CONTRACT_VERSION,
        ".tmp",
        "managed-audit-v211-",
