...
public class OpsEvidenceService {
  ...
  static final String RELEASE_APPROVAL_REHEARSAL_ENDPOINT =
  ...
  static final String
      RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_SIGNED_HUMAN_APPROVAL_ARTIFACT_CONTRACT_ECHO_RECEIPT_VERSION =
  ...
  static final String
      RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_NO_NETWORK_SAFETY_FIXTURE_CONTRACT_ECHO_RECEIPT_VERSION =
  ...
  static final String
      RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_ABORT_ROLLBACK_SEMANTICS_CONTRACT_ECHO_RECEIPT_VERSION =
          "java-release-approval-rehearsal-managed-audit-sandbox-endpoint-credential-resolver-abort-rollback-semantics-contract-echo-receipt.v1";
  ...
  static final String
      RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_RUNTIME_SHELL_POST_DECISION_PLAN_INTAKE_ECHO_RECEIPT_SCHEMA_VERSION =
          "java-release-approval-rehearsal-response-schema.v41";
  ...
  static final String
      RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_SIGNED_HUMAN_APPROVAL_ARTIFACT_CONTRACT_ECHO_RECEIPT_SCHEMA_VERSION =
          "java-release-approval-rehearsal-response-schema.v46";
  ...
  static final String
      RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_NO_NETWORK_SAFETY_FIXTURE_CONTRACT_ECHO_RECEIPT_SCHEMA_VERSION =
          "java-release-approval-rehearsal-response-schema.v49";
  ...
  static final String NODE_V231_MANUAL_SANDBOX_CONNECTION_PREFLIGHT_VERIFICATION_VERSION =
      "Node v231";
  ...
  static final String NODE_V234_MANUAL_SANDBOX_CONNECTION_BLOCKED_EXECUTION_REHEARSAL_VERSION =
      "Node v234";
  ...
  static final String NODE_V236_MANUAL_SANDBOX_CONNECTION_DRY_RUN_REQUEST_ENVELOPE_VERSION =
      "Node v236";
  ...
  static final String NODE_V238_MANUAL_SANDBOX_CONNECTION_OPERATOR_WINDOW_CHECKLIST_VERSION =
      "Node v238";
  ...
  static final String NODE_V239_MANUAL_SANDBOX_CONNECTION_EVIDENCE_VERIFICATION_VERSION =
      "Node v239";
  ...
  static final String NODE_V241_MANUAL_SANDBOX_CONNECTION_DRY_RUN_COMMAND_PACKAGE_VERSION =
      "Node v241";
  ...
  static final String NODE_V257_FAKE_TRANSPORT_PACKET_UPSTREAM_ECHO_VERIFICATION_VERSION =
      "Node v257";
  ...
  static final String NODE_V259_SANDBOX_ENDPOINT_HANDLE_UPSTREAM_ECHO_VERIFICATION_VERSION =
      "Node v259";
  ...
  static final String NODE_V260_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_DECISION_RECORD_VERSION =
      "Node v260";
  ...
  static final String
      NODE_V264_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_TEST_ONLY_SHELL_CONTRACT_VERSION = "Node v264";

  static final String
      NODE_V264_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_TEST_ONLY_SHELL_CONTRACT_PROFILE =
          "managed-audit-manual-sandbox-connection-sandbox-endpoint-credential-resolver-test-only-shell-contract.v1";

  static final String
      NODE_V264_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_TEST_ONLY_SHELL_CONTRACT_ENDPOINT =
          "/api/v1/audit/managed-audit-manual-sandbox-connection-sandbox-endpoint-credential-resolver-test-only-shell-contract";

  static final String
      NODE_V264_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_TEST_ONLY_SHELL_CONTRACT_MARKDOWN_ENDPOINT =
  ...
  static final String
      NODE_V266_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_FAKE_SHELL_ARCHIVE_VERIFICATION_VERSION =
          "Node v266";

  static final String
      NODE_V266_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_FAKE_SHELL_ARCHIVE_VERIFICATION_PROFILE =
          "managed-audit-manual-sandbox-connection-credential-resolver-fake-shell-archive-verification.v1";

  static final String
      NODE_V266_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_FAKE_SHELL_ARCHIVE_VERIFICATION_ENDPOINT =
  ...
  static final String
      NODE_V266_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_FAKE_SHELL_ARCHIVE_VERIFICATION_STATE =
  ...
  static final String
      NODE_V268_CREDENTIAL_RESOLVER_PRODUCTION_READINESS_DECISION_GATE_MARKDOWN_ENDPOINT =
  ...
  static final String
      NODE_V270_CREDENTIAL_RESOLVER_PRE_IMPLEMENTATION_PLAN_INTAKE_MARKDOWN_ENDPOINT =
  ...
  static final String
      NODE_V273_CREDENTIAL_RESOLVER_DISABLED_IMPLEMENTATION_CANDIDATE_REVIEW_VERSION = "Node v273";
  ...
  static final String NODE_V283_CREDENTIAL_RESOLVER_IMPLEMENTATION_PLAN_DRAFT_VERSION = "Node v283";

  static final String NODE_V283_CREDENTIAL_RESOLVER_IMPLEMENTATION_PLAN_DRAFT_PROFILE =
      "managed-audit-manual-sandbox-connection-credential-resolver-implementation-plan-draft.v1";

  static final String NODE_V283_CREDENTIAL_RESOLVER_IMPLEMENTATION_PLAN_DRAFT_ENDPOINT =
      "/api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-implementation-plan-draft";

  static final String NODE_V283_CREDENTIAL_RESOLVER_IMPLEMENTATION_PLAN_DRAFT_MARKDOWN_ENDPOINT =
      "/api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-implementation-plan-draft?format=markdown";
  ...
  static final String
      NODE_V292_CREDENTIAL_RESOLVER_FAKE_HARNESS_READINESS_DECISION_MARKDOWN_ENDPOINT =
  ...
  static final String NODE_V295_CREDENTIAL_RESOLVER_DISABLED_RUNTIME_SHELL_DESIGN_REVIEW_VERSION =
      "Node v295";

  static final String NODE_V295_CREDENTIAL_RESOLVER_DISABLED_RUNTIME_SHELL_DESIGN_REVIEW_PROFILE =
      "managed-audit-manual-sandbox-connection-credential-resolver-disabled-runtime-shell-design-review.v1";

  static final String NODE_V295_CREDENTIAL_RESOLVER_DISABLED_RUNTIME_SHELL_DESIGN_REVIEW_ENDPOINT =
      "/api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-disabled-runtime-shell-design-review";

  static final String
      NODE_V295_CREDENTIAL_RESOLVER_DISABLED_RUNTIME_SHELL_DESIGN_REVIEW_MARKDOWN_ENDPOINT =
  ...
  static final String NODE_V295_CREDENTIAL_RESOLVER_DISABLED_RUNTIME_SHELL_DESIGN_REVIEW_STATE =
  ...
  static final String
      NODE_V304_CREDENTIAL_RESOLVER_RUNTIME_SHELL_CHAIN_STOP_PREREQUISITE_DECISION_RECORD_VERSION =
          "Node v304";

  static final String
      NODE_V304_CREDENTIAL_RESOLVER_RUNTIME_SHELL_CHAIN_STOP_PREREQUISITE_DECISION_RECORD_PROFILE =
          "managed-audit-manual-sandbox-connection-credential-resolver-runtime-shell-chain-stop-or-prerequisite-decision-record.v1";

  static final String
      NODE_V304_CREDENTIAL_RESOLVER_RUNTIME_SHELL_CHAIN_STOP_PREREQUISITE_DECISION_RECORD_ENDPOINT =
  ...
  static final String
      NODE_V304_CREDENTIAL_RESOLVER_RUNTIME_SHELL_CHAIN_STOP_PREREQUISITE_DECISION_RECORD_MARKDOWN_ENDPOINT =
  ...
  static final String NODE_V308_CREDENTIAL_RESOLVER_HUMAN_APPROVAL_ARTIFACT_REVIEW_PACKET_VERSION =
      "Node v308";

  static final String NODE_V308_CREDENTIAL_RESOLVER_HUMAN_APPROVAL_ARTIFACT_REVIEW_PACKET_PROFILE =
      "managed-audit-manual-sandbox-connection-credential-resolver-human-approval-artifact-review-packet.v1";

  static final String NODE_V308_CREDENTIAL_RESOLVER_HUMAN_APPROVAL_ARTIFACT_REVIEW_PACKET_ENDPOINT =
  ...
  static final String NODE_V308_CREDENTIAL_RESOLVER_HUMAN_APPROVAL_ARTIFACT_REVIEW_PACKET_STATE =
  ...
  static final String
      NODE_V314_CREDENTIAL_RESOLVER_SIGNED_HUMAN_APPROVAL_ARTIFACT_CONTRACT_VERSION = "Node v314";

  static final String
      NODE_V314_CREDENTIAL_RESOLVER_SIGNED_HUMAN_APPROVAL_ARTIFACT_CONTRACT_PROFILE =
          "managed-audit-manual-sandbox-connection-credential-resolver-signed-human-approval-artifact-contract-intake.v1";

  static final String
      NODE_V314_CREDENTIAL_RESOLVER_SIGNED_HUMAN_APPROVAL_ARTIFACT_CONTRACT_ENDPOINT =
          "/api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-signed-human-approval-artifact-contract-intake";

  static final String
      NODE_V314_CREDENTIAL_RESOLVER_SIGNED_HUMAN_APPROVAL_ARTIFACT_CONTRACT_MARKDOWN_ENDPOINT =
  ...
  static final String NODE_V314_CREDENTIAL_RESOLVER_SIGNED_HUMAN_APPROVAL_ARTIFACT_CONTRACT_STATE =
      "signed-human-approval-artifact-contract-intake-ready";

  static final String NODE_V317_CREDENTIAL_RESOLVER_CREDENTIAL_HANDLE_APPROVAL_CONTRACT_VERSION =
      "Node v317";

  static final String NODE_V317_CREDENTIAL_RESOLVER_CREDENTIAL_HANDLE_APPROVAL_CONTRACT_PROFILE =
      "managed-audit-manual-sandbox-connection-credential-resolver-credential-handle-approval-contract-intake.v1";

  static final String NODE_V317_CREDENTIAL_RESOLVER_CREDENTIAL_HANDLE_APPROVAL_CONTRACT_ENDPOINT =
      "/api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-credential-handle-approval-contract-intake";

  static final String
      NODE_V317_CREDENTIAL_RESOLVER_CREDENTIAL_HANDLE_APPROVAL_CONTRACT_MARKDOWN_ENDPOINT =
  ...
  static final String NODE_V317_CREDENTIAL_RESOLVER_CREDENTIAL_HANDLE_APPROVAL_CONTRACT_STATE =
  ...
  static final String NODE_V323_CREDENTIAL_RESOLVER_NO_NETWORK_SAFETY_FIXTURE_CONTRACT_VERSION =
      "Node v323";

  static final String NODE_V323_CREDENTIAL_RESOLVER_NO_NETWORK_SAFETY_FIXTURE_CONTRACT_PROFILE =
      "managed-audit-manual-sandbox-connection-credential-resolver-no-network-safety-fixture-contract-intake.v1";

  static final String NODE_V323_CREDENTIAL_RESOLVER_NO_NETWORK_SAFETY_FIXTURE_CONTRACT_ENDPOINT =
      "/api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-no-network-safety-fixture-contract-intake";

  static final String
      NODE_V323_CREDENTIAL_RESOLVER_NO_NETWORK_SAFETY_FIXTURE_CONTRACT_MARKDOWN_ENDPOINT =
  ...
  static final String NODE_V323_CREDENTIAL_RESOLVER_NO_NETWORK_SAFETY_FIXTURE_CONTRACT_STATE =
      "no-network-safety-fixture-contract-intake-ready";

  static final String NODE_V326_CREDENTIAL_RESOLVER_ABORT_ROLLBACK_SEMANTICS_CONTRACT_VERSION =
      "Node v326";

  static final String NODE_V326_CREDENTIAL_RESOLVER_ABORT_ROLLBACK_SEMANTICS_CONTRACT_PROFILE =
      "managed-audit-manual-sandbox-connection-credential-resolver-abort-rollback-semantics-contract-intake.v1";

  static final String NODE_V326_CREDENTIAL_RESOLVER_ABORT_ROLLBACK_SEMANTICS_CONTRACT_ENDPOINT =
      "/api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-abort-rollback-semantics-contract-intake";

  static final String
      NODE_V326_CREDENTIAL_RESOLVER_ABORT_ROLLBACK_SEMANTICS_CONTRACT_MARKDOWN_ENDPOINT =
  ...
  static final String NODE_V326_CREDENTIAL_RESOLVER_ABORT_ROLLBACK_SEMANTICS_CONTRACT_STATE =
