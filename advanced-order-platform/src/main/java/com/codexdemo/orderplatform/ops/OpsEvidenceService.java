...
public class OpsEvidenceService {
    ...
    static final String NODE_V283_CREDENTIAL_RESOLVER_IMPLEMENTATION_PLAN_DRAFT_VERSION =
            "Node v283";
    ...
    static final String NODE_V295_CREDENTIAL_RESOLVER_DISABLED_RUNTIME_SHELL_DESIGN_REVIEW_MARKDOWN_ENDPOINT =
    ...
    static final String NODE_V296_CREDENTIAL_RESOLVER_DISABLED_RUNTIME_SHELL_UPSTREAM_ECHO_VERIFICATION_VERSION =
            "Node v296";

    static final String NODE_V296_CREDENTIAL_RESOLVER_DISABLED_RUNTIME_SHELL_UPSTREAM_ECHO_VERIFICATION_PROFILE =
    ...
    static final String
            NODE_V317_CREDENTIAL_RESOLVER_CREDENTIAL_HANDLE_APPROVAL_CONTRACT_VERSION =
                    "Node v317";

    static final String
            NODE_V317_CREDENTIAL_RESOLVER_CREDENTIAL_HANDLE_APPROVAL_CONTRACT_PROFILE =
                    "managed-audit-manual-sandbox-connection-credential-resolver-credential-handle-approval-contract-intake.v1";

    static final String
            NODE_V317_CREDENTIAL_RESOLVER_CREDENTIAL_HANDLE_APPROVAL_CONTRACT_ENDPOINT =
    ...
    static final String
            NODE_V323_CREDENTIAL_RESOLVER_NO_NETWORK_SAFETY_FIXTURE_CONTRACT_VERSION =
                    "Node v323";

    static final String
            NODE_V323_CREDENTIAL_RESOLVER_NO_NETWORK_SAFETY_FIXTURE_CONTRACT_PROFILE =
                    "managed-audit-manual-sandbox-connection-credential-resolver-no-network-safety-fixture-contract-intake.v1";

    static final String
            NODE_V323_CREDENTIAL_RESOLVER_NO_NETWORK_SAFETY_FIXTURE_CONTRACT_ENDPOINT =
    ...
    static final String
            NODE_V323_CREDENTIAL_RESOLVER_NO_NETWORK_SAFETY_FIXTURE_CONTRACT_STATE =
    ...
    static final String NODE_V326_CREDENTIAL_RESOLVER_ABORT_ROLLBACK_SEMANTICS_CONTRACT_MARKDOWN_ENDPOINT =
    ...
    private OpsEvidenceResponse.HealthProbe healthProbe(boolean staticSampleOnly) {
        ...
        additionalProbeEndpoints.add(OpsShardReadinessEvidenceIndexService.ENDPOINT);
        ...
        additionalProbeEndpoints.add(OpsShardReadinessEvidenceIndexService.FIXTURE_ENDPOINT);
    ...
    private OpsEvidenceResponse.ReadOnlyWindow readOnlyWindow(boolean readyForReadOnlyLiveProbe) {
        ...
        allowedProbeEndpoints.add("GET " + OpsShardReadinessEvidenceIndexService.ENDPOINT);
        ...
        allowedProbeEndpoints.add("GET " + OpsShardReadinessEvidenceIndexService.FIXTURE_ENDPOINT);
    ...
    private List<String> evidenceEndpoints() {
        ...
        endpoints.add(OpsShardReadinessEvidenceIndexService.ENDPOINT);
        ...
        endpoints.add(OpsShardReadinessEvidenceIndexService.FIXTURE_ENDPOINT);
