...
final class OpsShardReadinessMinimalReadOnlyGateExecutionRegistryRenderer {
  ...
  static List<OpsShardReadinessMinimalReadOnlyGateExecutionRegistryResponse.MarkdownSection> render(
    ...
    List<OpsShardReadinessMinimalReadOnlyGateExecutionRegistryResponse.MarkdownSection> sections =
        new ArrayList<>();
    sections.add(
        OpsShardReadinessMinimalReadOnlyGateExecutionReadTargetRenderer.render(readTargets));
    sections.add(OpsShardReadinessMinimalReadOnlyGateExecutionGateRenderer.render(gateChecks));
    sections.addAll(
        OpsShardReadinessMinimalReadOnlyGateExecutionArchiveRenderer.render(
            boundaryRules, ciBatches, archiveRequirements, operatorHandoffs));
