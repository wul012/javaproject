...
final class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffBoundaryLockCatalog {
  ...
  static List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.BoundaryLock>
      locks() {
    return List.of(
  ...
  private static OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.BoundaryLock
      lock(String code, String behavior) {
    return new OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse.BoundaryLock(
