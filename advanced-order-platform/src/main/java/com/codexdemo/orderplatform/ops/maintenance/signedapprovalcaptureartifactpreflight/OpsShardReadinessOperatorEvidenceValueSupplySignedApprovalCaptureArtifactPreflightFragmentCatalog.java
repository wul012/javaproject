...
import com.codexdemo.orderplatform.ops.OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightChannelSignaturePolicyService;
...
import com.codexdemo.orderplatform.ops.OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightFailClosedLockService;
import com.codexdemo.orderplatform.ops.OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightOperatorInputMirrorService;
import com.codexdemo.orderplatform.ops.OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightRedactionProvenanceBindingService;
import com.codexdemo.orderplatform.ops.OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightReviewDigestBindingService;
import com.codexdemo.orderplatform.ops.OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightSourceEvidenceMirrorService;
import com.codexdemo.orderplatform.ops.OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightStatementJustificationService;
import com.codexdemo.orderplatform.ops.OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightTemplateDigestBindingService;
import com.codexdemo.orderplatform.ops.OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightTimingWindowService;
import java.util.List;

final
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCaptureArtifactPreflightFragmentCatalog {
  ...
  static List<
    ...
    return List.of(
        fragment(
            ...
            "capture.requestId",
            "request",
            "Map artifact preflight request id fragment.",
            "request id cannot materialize artifact",
            "ARTIFACT_PREFLIGHT_REQUEST_ID_SEAL",
            "node-v1086-artifact-preflight",
            "artifact-request-id",
        ...
        fragment(
            ...
            "capture.preflightDigest",
            "digest",
            "Bind source capture preflight digest fragment.",
            "capture digest cannot create signed approval",
            "ARTIFACT_PREFLIGHT_CAPTURE_PREFLIGHT_DIGEST_SEAL",
            "node-v1061-capture-preflight",
            "capture-preflight-digest",
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightCloseoutService
                .ENDPOINT),
        fragment(
            ...
            "template.digest",
            "digest",
            "Bind signed approval template digest fragment.",
            "template digest cannot create artifact body",
        ...
        fragment(
            ...
            "review.digest",
            "digest",
            "Bind approval packet review digest fragment.",
        ...
        fragment(
            ...
            "operator",
            "Map operator identity artifact fragment.",
            "operator identity remains alias-only",
            "ARTIFACT_PREFLIGHT_OPERATOR_IDENTITY_SEAL",
            "node-v1086-artifact-preflight",
            "operator-identity-fragment",
        ...
        fragment(
            ...
            "capture-window",
            "Map capture window id artifact fragment.",
            "window id cannot open runtime",
        ...
        fragment(
            ...
            "capture-policy",
            "Map capture channel policy artifact fragment.",
            "channel policy cannot expose write route",
            "ARTIFACT_PREFLIGHT_CHANNEL_POLICY_SEAL",
            "node-v1086-artifact-preflight",
            "channel-policy-fragment",
        ...
        fragment(
            ...
            "signature",
            "Map signature material redaction fragment.",
            "redaction fragment keeps raw signature absent",
            "ARTIFACT_PREFLIGHT_SIGNATURE_REDACTION_SEAL",
            "node-v1086-artifact-preflight",
            "signature-redaction-fragment",
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightChannelSignaturePolicyService
                .ENDPOINT),
        fragment(
            "SIGNED_APPROVAL_CAPTURE_ARTIFACT_PREFLIGHT_APPROVAL_STATEMENT_DIGEST",
            "approval.statementDigestPlaceholder",
            "statement",
        ...
        fragment(
            ...
            "evidence.version",
            "evidence",
            "Map source evidence version fragment.",
            "version fragment cannot import evidence",
        ...
        fragment(
            ...
            "evidence.fileId",
            "evidence",
            "Map source evidence file fragment.",
            "file fragment cannot read file contents",
        ...
        fragment(
            ...
            "evidence.snippetId",
            "evidence",
            "Map source evidence snippet fragment.",
            "snippet fragment cannot import payload",
            "ARTIFACT_PREFLIGHT_SOURCE_SNIPPET_SEAL",
            "node-v1086-artifact-preflight",
            "source-snippet-fragment",
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightSourceEvidenceMirrorService
                .ENDPOINT),
        fragment(
        ...
        fragment(
            ...
            "value.shapeBinding",
            "value",
            "Map value shape artifact fragment.",
            "value shape cannot accept operator value body",
        ...
        fragment(
            ...
            "lock",
            "Map no raw secret artifact lock.",
        ...
        fragment(
            ...
            "locks.approvalGrant",
            "lock",
            "Map no approval grant artifact lock.",
        ...
        fragment(
            ...
            "locks.zeroValueImport",
            "lock",
            "Map zero value import artifact lock.",
            "value import remains zero",
            "ARTIFACT_PREFLIGHT_ZERO_VALUE_IMPORT_SEAL",
            "node-v1086-artifact-preflight",
            "zero-value-import-lock",
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightFailClosedLockService
                .ENDPOINT),
        fragment(
            ...
            "locks.noWriteRoute",
            "lock",
            "Map no write route artifact lock.",
        ...
        fragment(
            ...
            "lock",
            "Map sibling non-mutation artifact lock.",
        ...
        fragment(
            ...
            "closeout.boundary",
            "closeout",
            "Map artifact preflight closeout boundary.",
            "next step requires separate artifact draft plan",
            "ARTIFACT_PREFLIGHT_CLOSEOUT_SEAL",
            "node-v1086-artifact-preflight",
            "artifact-preflight-closeout",
            OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightCloseoutService
                .ENDPOINT));
  }
  ...
  static List<
          OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCaptureArtifactPreflightResponse
              .ArtifactFragment>
      fragments(int fromInclusive, int toExclusive) {
