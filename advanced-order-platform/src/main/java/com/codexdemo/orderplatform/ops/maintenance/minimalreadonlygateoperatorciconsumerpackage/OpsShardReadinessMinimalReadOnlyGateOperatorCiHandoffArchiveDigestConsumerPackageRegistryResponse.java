...
public
record OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageRegistryResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record ManifestEntry(String name, String value, boolean required, String status) {}

  public record ConsumerAudience(
      String audience, String owner, String packet, boolean ready, String status) {}

  public record PackageSection(
      String section, String owner, String sourceEvidence, boolean ready, String status) {}

  public record AcceptanceCriterion(String code, String evidence, boolean passed, String status) {}
  ...
  public record HandoffChecklistItem(
      int order, String item, String owner, boolean ready, String status) {}
