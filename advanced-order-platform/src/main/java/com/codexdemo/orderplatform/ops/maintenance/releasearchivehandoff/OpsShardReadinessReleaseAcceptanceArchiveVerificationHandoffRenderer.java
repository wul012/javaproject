...
final class OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffRenderer {
  ...
  static List<OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffResponse.MarkdownSection>
      render(
          List<
    ...
    return List.of(
        ...
        OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffArtifactRenderer.render(
            artifactCrossChecks),
        OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffRouteRenderer.render(
            routeHandoffs),
        ...
        OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffBoundaryRenderer.render(
            boundaryGuards),
        OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffRetentionRenderer.render(
            retentionGuards),
        OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffCloseoutRenderer.render(
            closeoutHandoffs),
        OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffScorecardRenderer.render(
            scorecard));
  }
}
