...
final class OpsShardReadinessComparedEvidenceCandidateBlueprintCloseoutSectionCatalog {
    ...
    static List<OpsShardReadinessComparedEvidenceCandidateBlueprintResponse.CandidateSection> closeoutSections() {
        return List.of(
                OpsShardReadinessComparedEvidenceCandidateBlueprintSupport.section("exclusion-boundary",
                        "Node v1360", "closeout",
                ...
                OpsShardReadinessComparedEvidenceCandidateBlueprintSupport.section("candidate-blueprint-closeout",
                        "Node v1361", "closeout",
