...
final class ReleaseApprovalManagedAuditAdapterBoundaryReceiptBuilder {
  ...
  private static final String NODE_V214_STATE = "verified-restore-drill-archive";
  ...
  private static final String NODE_V215_PROFILE = "managed-audit-dry-run-adapter-candidate.v1";
  ...
  ReleaseApprovalRehearsalResponseRecords.RehearsalManagedAuditAdapterBoundaryReceipt build(
    ...
    boolean sourceMarkerAccepted =
        ReleaseApprovalContractConstants
                ...
                .equals(approvalHandoffVerificationMarker.markerVersion())
