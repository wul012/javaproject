...
final
class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutReceiptCriteriaCatalog {
  ...
  static List<
    ...
    return List.of(
        criterion(
            "acceptance-package-passed",
            source.endpoint() + ":" + source.status(),
            "passed".equals(source.status())),
        criterion(
            "lineage-complete",
            "lineage-count=" + source.lineageEntryCount(),
            source.lineageEntryCount() == 3),
        criterion(
            "decisions-accepted",
            "decision-count=" + source.decisionRecordCount(),
        ...
        criterion(
            "archive-ready",
            "archive-items=" + source.archiveItemCount(),
        ...
        criterion(
            "ci-evidence-passed",
            "ci-evidence=" + source.ciEvidenceCount(),
            source.ciEvidence().stream()
                .allMatch(
                    OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse
                        ...
                        ::passed)),
        criterion(
            "runtime-boundaries-locked",
            "runtime-boundaries=" + source.runtimeBoundaryCount(),
            source.runtimeBoundaries().stream()
                .allMatch(
                    OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageResponse
                        ...
                        ::locked)),
        criterion(
            "next-change-rules-ready",
            "next-change-rules=" + source.nextChangeRuleCount(),
  ...
  OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCloseoutReceiptResponse
          .AcceptedCriterion
      criterion(String name, String evidence, boolean accepted) {
