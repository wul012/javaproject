...
final
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparedPackageEvidenceIntakeSupport {
  ...
  OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageComparedPackageEvidenceIntakeResponse
    ...
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-slot-count-"
            + slotCopy.size());
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-guard-count-"
            + guardCopy.size());
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-source-plan-"
            + SOURCE_PLAN);
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-source-node-"
            + SOURCE_NODE_ACCEPTANCE_PRECHECK_VERSION);
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-source-java-"
            + SOURCE_JAVA_ACCEPTANCE_PRECHECK_VERSION);
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-no-evidence-fabrication");
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-no-evidence-acceptance");
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-no-draft-text-parsing");
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-no-signature-parsing");
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-no-approval-grant");
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-no-runtime");
    checks.add(
        "signed-approval-artifact-draft-text-package-compared-package-evidence-intake-no-sibling-mutation");
