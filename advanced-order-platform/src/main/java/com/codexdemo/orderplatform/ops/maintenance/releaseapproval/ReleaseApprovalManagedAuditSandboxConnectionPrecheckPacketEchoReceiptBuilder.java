...
final class ReleaseApprovalManagedAuditSandboxConnectionPrecheckPacketEchoReceiptBuilder {
  ...
  private static final String OPERATOR_WINDOW_FIELD = "ORDEROPS_MANAGED_AUDIT_OPERATOR_WINDOW";
  private static final String ROLLBACK_PATH_FIELD = "ORDEROPS_MANAGED_AUDIT_ROLLBACK_PATH_ID";
  private static final String ABORT_MARKER_FIELD = "ORDEROPS_MANAGED_AUDIT_MANUAL_ABORT";
  private static final String TIMEOUT_POLICY_FIELD = "timeoutPolicy";
  private static final String PACKET_MODE = "manual-sandbox-connection-read-only-precheck-packet";
  ...
  private static final List<String> ECHOED_PRECHECK_ITEM_IDS =
      List.of(
  ...
  private static final List<String> WARNING_DIGEST_WARNING_INPUT_NAMES =
      List.of("managedAuditSandboxConnectionPrecheckPacketEchoReceiptWarnings");
  ...
  ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionPrecheckPacketShape
        packetShape = packetShape();
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionPrecheckPacketFieldEcho
        fieldEcho = fieldEcho();
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            .RehearsalSandboxConnectionPrecheckPacketExecutionBoundary
            ...
            List.of(
                ...
                ReleaseApprovalDigestSupport.line(
                    ...
                    ReleaseApprovalUpstreamContractConstants
                        .NODE_V245_MANUAL_SANDBOX_CONNECTION_PRECHECK_PACKET_PROFILE),
                ...
                ReleaseApprovalDigestSupport.line(
                    "precheckItemCount", packetShape.precheckItemCount()),
                ReleaseApprovalDigestSupport.line(
                    "disabledByDefault", packetShape.disabledByDefault()),
                ReleaseApprovalDigestSupport.line("dryRunOnly", packetShape.dryRunOnly()),
                ReleaseApprovalDigestSupport.line(
                    "echoedPrecheckItemIds", ECHOED_PRECHECK_ITEM_IDS),
                ReleaseApprovalDigestSupport.line(
                    "ownerApprovalArtifactField", fieldEcho.ownerApprovalArtifactField()),
                ReleaseApprovalDigestSupport.line(
                    "credentialHandleReviewField", fieldEcho.credentialHandleReviewField()),
                ReleaseApprovalDigestSupport.line(
                    "schemaMigrationRehearsalIdField", fieldEcho.schemaMigrationRehearsalIdField()),
                ReleaseApprovalDigestSupport.line(
                    "operatorWindowField", fieldEcho.operatorWindowField()),
                ReleaseApprovalDigestSupport.line(
                    "rollbackPathField", fieldEcho.rollbackPathField()),
                ReleaseApprovalDigestSupport.line("abortMarkerField", fieldEcho.abortMarkerField()),
                ReleaseApprovalDigestSupport.line(
                    "timeoutPolicyField", fieldEcho.timeoutPolicyField()),
                ReleaseApprovalDigestSupport.line("timeoutBudgetMs", fieldEcho.timeoutBudgetMs()),
                ReleaseApprovalDigestSupport.line(
                    "carriesCredentialValue", javaExecutionBoundary.carriesCredentialValue()),
                ReleaseApprovalDigestSupport.line(
    ...
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        ...
        ReleaseApprovalContractConstants
            .RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_CONNECTION_DRY_RUN_COMMAND_PACKAGE_ECHO_RECEIPT_SCHEMA_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V245_MANUAL_SANDBOX_CONNECTION_PRECHECK_PACKET_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V245_MANUAL_SANDBOX_CONNECTION_PRECHECK_PACKET_PROFILE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V245_MANUAL_SANDBOX_CONNECTION_PRECHECK_PACKET_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V245_MANUAL_SANDBOX_CONNECTION_PRECHECK_PACKET_STATE,
        ReleaseApprovalUpstreamContractConstants
  ...
  List<String> warningDigestBoundaryLines(
    ...
    return List.of(
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionPrecheckPacketEchoReceiptDigest", receipt.receiptDigest()),
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionPrecheckPacketPrecheckItemCount",
        ...
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionPrecheckPacketDryRunOnly", receipt.packetShape().dryRunOnly()),
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionPrecheckPacketCarriesCredentialValue",
  ...
  private static ReleaseApprovalRehearsalSandboxConnectionResponseRecords
          .RehearsalSandboxConnectionPrecheckPacketShape
      packetShape() {
