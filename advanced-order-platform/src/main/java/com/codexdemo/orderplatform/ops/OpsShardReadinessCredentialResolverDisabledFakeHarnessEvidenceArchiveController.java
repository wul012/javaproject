...
public class OpsShardReadinessCredentialResolverDisabledFakeHarnessEvidenceArchiveController {
    ...
    private final OpsShardReadinessCredentialResolverDisabledFakeHarnessEvidenceArchiveService service;
    ...
    @GetMapping(OpsShardReadinessCredentialResolverRoutePaths
