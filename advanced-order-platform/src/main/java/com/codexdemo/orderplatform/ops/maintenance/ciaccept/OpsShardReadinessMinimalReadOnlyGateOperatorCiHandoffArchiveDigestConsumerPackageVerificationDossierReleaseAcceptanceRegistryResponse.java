...
public
record OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceRegistryResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record SignoffLane(
      String receiver, String owner, String evidence, boolean ready, String status) {}
  ...
  public record ReplayDecision(
      String code, String decision, String evidence, boolean passed, String status) {}
