...
final
class OpsShardReadinessSandboxConnectionPrecheckUpstreamReceiptVerificationManifestVerificationCatalog {
  ...
  static List<
    ...
    return List.of(
        ...
        gate(
            ...
            sourceReceipts.stream()
                .allMatch(source -> source.receiptDigest().startsWith("sha256:"))),
        gate(
