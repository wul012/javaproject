...
public
record OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightCloseoutResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record Guardrail(
      String code, String category, String rule, String enforcement, String status) {}

  public record RouteEvidence(
      String code, String route, String purpose, String method, String status) {}
}
