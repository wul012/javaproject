...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverTestOnlyShellEchoRecords.RehearsalSandboxEndpointCredentialResolverTestOnlyShellContract;
...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverTestOnlyShellEchoRecords.RehearsalSandboxEndpointCredentialResolverTestOnlyShellGuardCondition;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverTestOnlyShellEchoRecords.RehearsalSandboxEndpointCredentialResolverTestOnlyShellProbe;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverTestOnlyShellEchoRecords.RehearsalSandboxEndpointCredentialResolverTestOnlyShellRequestShape;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverTestOnlyShellEchoRecords.RehearsalSandboxEndpointCredentialResolverTestOnlyShellResponseShape;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverTestOnlyShellEchoRecords.RehearsalSandboxEndpointCredentialResolverTestOnlyShellSourceEcho;
...
final class ReleaseApprovalSandboxEndpointCredentialResolverTestOnlyShellContractBuilder {
  ...
  private static final String PROBE_REQUEST_ID =
  ...
  private static final List<String> REQUEST_SHAPE_FIELDS =
      List.of(
          "requestId",
          "operation",
          "credentialHandle",
  ...
  private static final List<String> RESPONSE_SHAPE_FIELDS =
      List.of(
          "requestId",
          "status",
          "code",
  ...
  private static final List<String> FAILURE_CLASS_CODES =
      List.of(
          "RESOLVER_DISABLED",
  ...
  private static final List<String> GUARD_CONDITION_CODES =
      List.of(
          "SOURCE_V263_READY",
          "FAKE_RESOLVER_ONLY",
  ...
  private static RehearsalSandboxEndpointCredentialResolverTestOnlyShellRequestShape
      requestShape() {
    return new RehearsalSandboxEndpointCredentialResolverTestOnlyShellRequestShape(
        REQUEST_SHAPE_FIELDS, true, false, true, false, true, true, false);
  }

  private static RehearsalSandboxEndpointCredentialResolverTestOnlyShellResponseShape
      responseShape() {
    return new RehearsalSandboxEndpointCredentialResolverTestOnlyShellResponseShape(
        RESPONSE_SHAPE_FIELDS, true, false, false, false, false, false, false, false, false, false);
  }

  private static List<RehearsalSandboxEndpointCredentialResolverTestOnlyShellFailureMapping>
      failureMapping() {
    return FAILURE_CLASS_CODES.stream()
        .map(
            code ->
                new RehearsalSandboxEndpointCredentialResolverTestOnlyShellFailureMapping(
                    code,
                    "TEST_ONLY_" + code,
                    "RESOLVER_DISABLED".equals(code)
                        ? "return-fake-failure"
  ...
  private static List<RehearsalSandboxEndpointCredentialResolverTestOnlyShellGuardCondition>
      guardConditions() {
    return List.of(
        guard(
            "SOURCE_V263_READY",
            "Node v263 disabled precheck upstream echo verification must be ready."),
        guard("FAKE_RESOLVER_ONLY", "Only fake in-memory resolver is allowed in v264."),
        guard(
            "CREDENTIAL_HANDLE_ONLY",
            "Requests may carry credential handles only, never credential values."),
        guard(
            "ENDPOINT_HANDLE_ONLY",
            "Requests may carry endpoint handles only, never raw endpoint URLs."),
        guard(
            "RESOLVER_POLICY_HANDLE_REQUIRED",
            "Resolver policy handle must be present as a handle only."),
        guard(
            "APPROVAL_MARKER_REQUIRED",
            "Approval marker must be present before any later resolver work."),
        ...
        guard(
            "NO_EXTERNAL_REQUEST",
            "The test-only shell must not send external managed audit requests."),
