...
final class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveArtifactManifestCatalog {

    private OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveArtifactManifestCatalog() {
    }
    ...
    static List<OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
            .ArtifactManifestEntry> manifest(
        ...
        return List.of(
                ...
                entry("evidence-chain-passed", String.valueOf(source.passedEvidenceChainEntryCount()), true),
                entry("signoff-lanes-ready", String.valueOf(source.readySignoffLaneCount()), true),
                entry("ci-replay-lanes-read-only", String.valueOf(source.readOnlyCiReplayLaneCount()), true),
                entry("closeout-checkpoints-ready", String.valueOf(source.readyCloseoutCheckpointCount()), true)
        );
    }
    ...
    private static OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
            .ArtifactManifestEntry entry(String name, String value, boolean required) {
