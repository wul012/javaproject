...
final
class ReleaseApprovalSandboxEndpointCredentialResolverProductionReadinessBlockedDecisionEchoSupport {
  ...
  private static final List<String> MISSING_REQUIREMENT_CODES =
  ...
  static RehearsalSandboxEndpointCredentialResolverProductionReadinessBlockedDecisionSourceEcho
      sourceNodeV268(boolean sourceAccepted) {
  ...
  static RehearsalSandboxEndpointCredentialResolverPreImplementationRequirements
  ...
  static RehearsalSandboxEndpointCredentialResolverProductionReadinessDecision
      productionReadinessDecision(String decisionDigest) {
  ...
  static RehearsalSandboxEndpointCredentialResolverProductionReadinessDecisionChecks decisionChecks(
    ...
    return new RehearsalSandboxEndpointCredentialResolverProductionReadinessDecisionChecks(
        ...
        !source.executionAllowed() && !source.schemaMigrationExecuted(),
  ...
  static RehearsalSandboxEndpointCredentialResolverProductionReadinessSideEffectBoundary
      sideEffectBoundary() {
