...
final
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessLaneSupport {
  ...
  OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessLaneResponse
    ...
    checks.add(
        "signed-approval-artifact-draft-readiness-lane-passed-blocker-count-" + passedBlockerCount);
    ...
    checks.add(
        "signed-approval-artifact-draft-readiness-lane-source-node-preflight-"
            + SOURCE_NODE_DRAFT_PREFLIGHT_VERSION);
    checks.add(
        "signed-approval-artifact-draft-readiness-lane-source-java-preflight-"
  ...
  OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessLaneResponse
    ...
    return new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessLaneResponse
        .ControlBlocker(code, category, blocker, rejectionCode, enforcement, "passed");
  }
