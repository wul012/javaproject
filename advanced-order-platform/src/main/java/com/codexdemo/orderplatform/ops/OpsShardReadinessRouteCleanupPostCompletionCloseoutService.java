...
@Service
public class OpsShardReadinessRouteCleanupPostCompletionCloseoutService {
    ...
    public OpsShardReadinessRouteCleanupPostCompletionCloseoutResponse closeout() {
        OpsShardReadinessRouteCleanupCompletionAuditDigestResponse digest = completionAuditDigestService.digest();
        ...
        boolean passed = digest.status().equals("passed")
