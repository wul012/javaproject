...
final class OpsShardReadinessCodeWalkthroughComplianceVersionCatalog {
    ...
    static List<OpsShardReadinessCodeWalkthroughComplianceRegistryResponse.VersionEntry>
            versions() {
        return List.of(
                version(1728, "route-owner", "route path owner for the compliance registry"),
                version(1729, "route-delegate", "shared route delegate exposed through OpsShardReadinessRoutePaths"),
                ...
                version(1732, "archive-range-catalog", "historical and continuation archive ranges recorded"),
    ...
    private static OpsShardReadinessCodeWalkthroughComplianceRegistryResponse.VersionEntry
            version(int version, String slug, String focus) {
