...
public
record OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftAuthoringReadinessResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record AuthoringGate(String code, String category, String gate, String enforcement) {}
}
