...
public record OpsShardReadinessScreenshotExplanationArchiveRegistryResponse(
  ...
  public record ArchiveSegmentPlan(
      String segment, String path, String versionRange, String purpose, boolean active) {}

  public record NamingRule(String code, String pattern, String rationale, boolean required) {}
