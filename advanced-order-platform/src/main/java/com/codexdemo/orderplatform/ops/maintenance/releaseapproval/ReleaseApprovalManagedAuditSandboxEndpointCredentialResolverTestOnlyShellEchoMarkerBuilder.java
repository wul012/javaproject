...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverTestOnlyShellEchoRecords.RehearsalSandboxEndpointCredentialResolverTestOnlyShellSideEffectBoundary;
...
final
class ReleaseApprovalManagedAuditSandboxEndpointCredentialResolverTestOnlyShellEchoMarkerBuilder {
  ...
  private static final List<String> NODE_WARNING_CODES =
      List.of("TEST_ONLY_SHELL_NOT_A_REAL_RESOLVER", "UPSTREAM_ECHO_REQUIRED_NEXT");
  ...
  RehearsalManagedAuditSandboxEndpointCredentialResolverTestOnlyShellEchoMarker build(
    ...
    RehearsalSandboxEndpointCredentialResolverTestOnlyShellContract resolverShellContract =
        ReleaseApprovalSandboxEndpointCredentialResolverTestOnlyShellContractBuilder.build(
            sourceNodeV263);
    RehearsalSandboxEndpointCredentialResolverTestOnlyShellSideEffectBoundary sideEffectBoundary =
        sideEffectBoundary();
    EchoReadiness readiness =
        EchoReadiness.from(sourceNodeV263, resolverShellContract, sideEffectBoundary);
  ...
  List<String> warningDigestWarningLines(
    ...
    return ReleaseApprovalDigestSupport.warningLines(
        WARNING_DIGEST_WARNING_INPUT_NAME, marker.markerWarnings());
  }
  ...
  boolean noCredentialConnectionWriteOrAutoStartProved(
      RehearsalManagedAuditSandboxEndpointCredentialResolverTestOnlyShellEchoMarker marker) {
    return ReleaseApprovalSandboxEndpointCredentialResolverTestOnlyShellContractBuilder.noEffects(
            marker.resolverShellContract())
  ...
  private static RehearsalSandboxEndpointCredentialResolverTestOnlyShellSideEffectBoundary
      sideEffectBoundary() {
