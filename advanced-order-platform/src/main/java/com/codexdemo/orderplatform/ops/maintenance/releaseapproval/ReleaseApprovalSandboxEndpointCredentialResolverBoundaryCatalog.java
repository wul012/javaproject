...
final class ReleaseApprovalSandboxEndpointCredentialResolverBoundaryCatalog {
  ...
  record ImplementationPlanUpstreamEchoRequirementTemplate(
      String id, String project, String expectedVersion, String requirement) {}
  ...
  private static final List<ImplementationPlanInterfaceBoundaryTemplate>
      IMPLEMENTATION_PLAN_INTERFACE_BOUNDARY_TEMPLATES =
          List.of(
  ...
  private static final List<ImplementationPlanUpstreamEchoRequirementTemplate>
      JAVA_V121_IMPLEMENTATION_PLAN_ECHO_REQUIREMENT_TEMPLATES =
          List.of(
  ...
  private static final List<ImplementationPlanUpstreamEchoRequirementTemplate>
      MINI_KV_V126_IMPLEMENTATION_PLAN_RECEIPT_REQUIREMENT_TEMPLATES =
          List.of(
              new ImplementationPlanUpstreamEchoRequirementTemplate(
  ...
  static List<ImplementationPlanInterfaceBoundaryTemplate>
  ...
  static List<String> prohibitedRuntimeActionsFor(String code) {
    return switch (code) {
      ...
      case "OPERATOR_APPROVAL" ->
          List.of("execute-without-operator-marker", "auto-approve-operation");
  ...
  static String approvalRequiredEvidenceAllowedFor(String code) {
    return switch (code) {
      ...
      default ->
          throw new IllegalArgumentException("Unknown approval-required boundary code: " + code);
    };
  }
  ...
  static ApprovalRequiredImplementationTemplate approvalRequiredImplementationTemplateFor(
      String code) {
    return switch (code) {
      case "CREDENTIAL_HANDLE" ->
          new ApprovalRequiredImplementationTemplate(
              "security",
              List.of(
                  "credential-handle-review-id",
                  "credential-value-redaction-contract",
      ...
      case "ENDPOINT_HANDLE" ->
          new ApprovalRequiredImplementationTemplate(
              ...
              List.of(
                  "parse-raw-endpoint-url", "render-raw-endpoint-url", "connect-managed-audit"));
      case "OPERATOR_APPROVAL" ->
          new ApprovalRequiredImplementationTemplate(
              "operator",
              List.of(
      ...
      case "SCHEMA_MIGRATION_POLICY" ->
          new ApprovalRequiredImplementationTemplate(
              ...
              List.of("execute-schema-migration", "execute-sql", "mutate-managed-audit-schema"));
      case "AUDIT_LEDGER_WRITE_POLICY" ->
          new ApprovalRequiredImplementationTemplate(
              "node",
              List.of(
              ...
              List.of("write-approval-ledger", "write-managed-audit-state", "write-storage"));
      default ->
          throw new IllegalArgumentException("Unknown approval-required boundary code: " + code);
    };
  }
