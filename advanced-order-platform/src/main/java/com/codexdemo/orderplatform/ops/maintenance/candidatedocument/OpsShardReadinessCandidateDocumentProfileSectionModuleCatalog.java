...
final class OpsShardReadinessCandidateDocumentProfileSectionModuleCatalog {
  ...
  static List<OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.ModuleEntry>
      modules() {
    return List.of(
        module(
            219,
  ...
  private static OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.ModuleEntry
