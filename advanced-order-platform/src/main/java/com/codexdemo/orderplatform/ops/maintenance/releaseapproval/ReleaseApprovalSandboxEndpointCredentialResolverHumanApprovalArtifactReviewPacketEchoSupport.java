...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPacketEchoRecords.RehearsalHumanApprovalArtifactReviewChecks;
...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPacketEchoRecords.RehearsalHumanApprovalArtifactReviewNecessityProof;
...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPacketEchoRecords.RehearsalHumanApprovalArtifactReviewPacket;
...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPacketEchoRecords.RehearsalHumanApprovalArtifactReviewSideEffectBoundary;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPacketEchoRecords.RehearsalHumanApprovalArtifactReviewSourceNodeV307Echo;
...
final
class ReleaseApprovalSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPacketEchoSupport {
  ...
  private
  ReleaseApprovalSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPacketEchoSupport() {}
  ...
  RehearsalManagedAuditSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPacketEchoReceipt
    ...
    RehearsalHumanApprovalArtifactReviewPacket reviewPacket =
        reviewPacket(sourceNodeV307, necessityProof);
    ...
    String receiptDigest =
        receiptDigest(
            source, sourceNodeV307, reviewPacket, necessityProof, checks, boundary, readiness);
  ...
  private static RehearsalHumanApprovalArtifactReviewChecks checks(
    ...
    boolean contractOnly =
        reviewPacket.reviewMode().equals("human-approval-artifact-review-packet-contract-only")
    ...
    return ReleaseApprovalDigestSupport.digest(
        List.of(
            ...
            ReleaseApprovalDigestSupport.line(
                "sourceNodeV306ArtifactDigest", source.artifactIntakePlan().artifactDigest()),
            ReleaseApprovalDigestSupport.line(
                "upstreamEchoAligned",
                source.readyForNodeV307ApprovalPrerequisiteArtifactUpstreamEchoVerification())));
  }
        ...
        List.of(
            ReleaseApprovalDigestSupport.line(
                ...
                ReleaseApprovalUpstreamContractConstants
                    .NODE_V308_CREDENTIAL_RESOLVER_HUMAN_APPROVAL_ARTIFACT_REVIEW_PACKET_PROFILE),
            ReleaseApprovalDigestSupport.line(
                "nodeV307Digest", sourceNodeV307.verificationDigest()),
  ...
  private static List<String> receiptWarnings(EchoWorkflowReadiness readiness) {
    return ReleaseApprovalDigestSupport.warnings(
        ...
        readiness.warningIfMissing(
            "reviewPacketContractEchoed", "REVIEW_PACKET_CONTRACT_NOT_ECHOED"),
