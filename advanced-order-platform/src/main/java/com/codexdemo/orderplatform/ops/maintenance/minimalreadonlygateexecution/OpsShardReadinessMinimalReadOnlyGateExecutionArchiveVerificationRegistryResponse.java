...
public record OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistryResponse(
  ...
  public record ReadTargetVerification(
      String target, String commandOrRoute, String sourceStatus, boolean archived, String status) {}

  public record GateCheckVerification(
      String code, String group, boolean sourcePassed, boolean archived, String status) {}

  public record BoundaryVerification(
      String code, String forbiddenAction, boolean allowed, boolean denied, String status) {}

  public record CiBatchVerification(
      String name, int order, String commandFamily, boolean archived, String status) {}

  public record OperatorHandoffVerification(
      String step, String owner, boolean manual, String status) {}
