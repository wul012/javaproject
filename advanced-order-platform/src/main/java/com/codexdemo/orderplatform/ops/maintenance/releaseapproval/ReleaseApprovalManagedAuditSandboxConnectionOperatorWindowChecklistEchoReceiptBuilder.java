...
final class ReleaseApprovalManagedAuditSandboxConnectionOperatorWindowChecklistEchoReceiptBuilder {
  ...
  private static final List<String> WARNING_DIGEST_WARNING_INPUT_NAMES =
      List.of("managedAuditSandboxConnectionOperatorWindowChecklistEchoReceiptWarnings");
  ...
  ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        ...
        credentialBoundary =
            CredentialBoundaryFlags.handleOnly().toBoundary(CREDENTIAL_HANDLE_NAME_FIELD);
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    boolean noExecutionEffects =
        noWriteCredentialConnectionSchemaRollbackOrServiceStartProved(
            approvalBoundary, credentialBoundary, javaExecutionBoundary);
            ...
            List.of(
                ...
                ReleaseApprovalDigestSupport.line(
                    ...
                    ReleaseApprovalUpstreamContractConstants
                        .NODE_V238_MANUAL_SANDBOX_CONNECTION_OPERATOR_WINDOW_CHECKLIST_PROFILE),
    ...
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        ...
        ReleaseApprovalContractConstants
            .RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_CONNECTION_DRY_RUN_ENVELOPE_ECHO_RECEIPT_SCHEMA_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V238_MANUAL_SANDBOX_CONNECTION_OPERATOR_WINDOW_CHECKLIST_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V238_MANUAL_SANDBOX_CONNECTION_OPERATOR_WINDOW_CHECKLIST_PROFILE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V238_MANUAL_SANDBOX_CONNECTION_OPERATOR_WINDOW_CHECKLIST_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V238_MANUAL_SANDBOX_CONNECTION_OPERATOR_WINDOW_CHECKLIST_STATE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V239_MANUAL_SANDBOX_CONNECTION_EVIDENCE_VERIFICATION_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V239_MANUAL_SANDBOX_CONNECTION_EVIDENCE_VERIFICATION_PROFILE,
        true,
  ...
  List<String> warningDigestBoundaryLines(
    ...
    return List.of(
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionOperatorWindowChecklistEchoReceiptDigest", receipt.receiptDigest()),
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionOperatorWindowChecklistCredentialValueIncluded",
  ...
  boolean noWriteCredentialConnectionSchemaRollbackOrServiceStartProved(
    ...
    return noWriteCredentialConnectionSchemaRollbackOrServiceStartProved(
        receipt.approvalBoundary(), receipt.credentialBoundary(), receipt.javaExecutionBoundary());
  }
  ...
  private record ApprovalBoundaryFlags(
    ...
    static ApprovalBoundaryFlags requiredOperatorWindowApprovals() {
      return new ApprovalBoundaryFlags(
          REQUIRED_APPROVAL_COUNT, true, true, true, true, true, true, true, true, false, false);
    }
