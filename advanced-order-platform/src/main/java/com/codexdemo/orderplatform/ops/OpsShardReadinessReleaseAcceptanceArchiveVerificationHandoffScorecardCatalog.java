...
final class OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffScorecardCatalog {
    ...
    static List<OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffResponse.ScorecardEntry> scorecard(
            List<OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffResponse.SourceArchiveSnapshot> snapshots,
            ...
            List<OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffResponse.CloseoutHandoff> closeouts
    ) {
        return List.of(
    ...
    private static int readyCloseouts(
        ...
        return (int) closeouts.stream()
                .filter(OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffResponse.CloseoutHandoff::ready)
                .count();
    }

    private static OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffResponse.ScorecardEntry score(
            String name,
            int expected,
            int actual
    ) {
