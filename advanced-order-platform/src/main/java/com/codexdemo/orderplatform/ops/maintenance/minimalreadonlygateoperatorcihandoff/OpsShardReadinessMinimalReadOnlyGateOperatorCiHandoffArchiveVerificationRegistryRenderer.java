...
final
class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveVerificationRegistryRenderer {
  ...
  static List<
    ...
    return List.of(
        ...
        OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveArtifactRenderer.render(
            artifacts),
        OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveLaneRenderer.render(lanes),
