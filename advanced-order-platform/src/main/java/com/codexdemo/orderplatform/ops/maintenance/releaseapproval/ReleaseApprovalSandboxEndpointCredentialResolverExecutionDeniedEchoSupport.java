...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverExecutionDeniedEchoRecords.RehearsalSandboxEndpointCredentialResolverExecutionDeniedChecks;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverExecutionDeniedEchoRecords.RehearsalSandboxEndpointCredentialResolverExecutionDeniedDecision;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverExecutionDeniedEchoRecords.RehearsalSandboxEndpointCredentialResolverExecutionDeniedSideEffectBoundary;
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverExecutionDeniedEchoRecords.RehearsalSandboxEndpointCredentialResolverExecutionDeniedSourceEcho;
...
final class ReleaseApprovalSandboxEndpointCredentialResolverExecutionDeniedEchoSupport {
  ...
  private static final List<String> DENIAL_REASON_CODES =
      List.of(
  ...
  private static final List<String> NO_GO_CONDITION_CODES =
      List.of(
  ...
  private static final List<String> PROHIBITED_ACTIONS =
      List.of(
  ...
  private static final List<String> NODE_WARNING_CODES =
      List.of("FAKE_HARNESS_READINESS_REMAINS_BLOCKED", "DIRECT_EXECUTION_DENIED_ECHO_SUPPLIED");
  ...
  static RehearsalManagedAuditSandboxEndpointCredentialResolverExecutionDeniedEchoReceipt build(
    ...
    RehearsalSandboxEndpointCredentialResolverExecutionDeniedDecision decision = decision();
    ...
    String receiptDigest =
        receiptDigest(sourceReceipt, sourceEcho, decision, checks, sideEffectBoundary, readiness);
    ...
    return new RehearsalManagedAuditSandboxEndpointCredentialResolverExecutionDeniedEchoReceipt(
        ...
        ReleaseApprovalUpstreamContractConstants
            .NODE_V292_CREDENTIAL_RESOLVER_FAKE_HARNESS_READINESS_DECISION_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V292_CREDENTIAL_RESOLVER_FAKE_HARNESS_READINESS_DECISION_PROFILE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V292_CREDENTIAL_RESOLVER_FAKE_HARNESS_READINESS_DECISION_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V292_CREDENTIAL_RESOLVER_FAKE_HARNESS_READINESS_DECISION_MARKDOWN_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V292_CREDENTIAL_RESOLVER_FAKE_HARNESS_READINESS_DECISION_STATE,
        ReleaseApprovalUpstreamContractConstants
  ...
  private static RehearsalSandboxEndpointCredentialResolverExecutionDeniedChecks checks(
      ...
      RehearsalSandboxEndpointCredentialResolverExecutionDeniedSideEffectBoundary
          sideEffectBoundary) {
    boolean sourceReady =
        sourceEcho.implementationPlanEchoReady() && sourceEcho.javaV121MiniKvV126EchoReady();
    boolean sourceStillBlocked =
  ...
  private static EchoWorkflowReadiness readiness(
    ...
    return workflowReadiness(
        ...
        workflowStep(
            "nodeV292ReadinessBlockedDecisionEchoed", checks.nodeV292ReadinessDecisionBlocked()),
        workflowStep(
            "fakeHarnessExecutionDeniedEchoed",
            decision.fakeHarnessExecutionDenied() && checks.fakeHarnessRuntimeDenied()),
        ...
        workflowStep(
            ...
            checks.approvalLedgerWriteDenied()
                && checks.sqlExecutionDenied()
                && checks.schemaMigrationDenied()),
        workflowStep(
            "noAutoStartBoundaryEchoed",
            checks.automaticUpstreamStartDenied()
                && !sideEffectBoundary.javaStartedNodeMiniKvOrHarness()),
        workflowStep(
            "sourceStillBlocked", !sourceEcho.readyForManagedAuditResolverImplementation()));
  }
        ...
        List.of(
            ReleaseApprovalDigestSupport.line(
                ...
                ReleaseApprovalContractConstants
                    .RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_ENDPOINT_CREDENTIAL_RESOLVER_EXECUTION_DENIED_ECHO_RECEIPT_VERSION),
            ReleaseApprovalDigestSupport.line(
                "sourceImplementationPlanEchoReceiptVersion", sourceReceipt.receiptVersion()),
            ReleaseApprovalDigestSupport.line(
                "sourceImplementationPlanEchoReceiptDigest", sourceReceipt.receiptDigest()),
  ...
  private static List<String> receiptWarnings(EchoWorkflowReadiness readiness) {
    return ReleaseApprovalDigestSupport.warnings(
        readiness.warningIfMissing(
            "sourceImplementationPlanEchoed", "SOURCE_IMPLEMENTATION_PLAN_NOT_READY"),
        readiness.warningIfMissing(
            "nodeV292ReadinessBlockedDecisionEchoed",
            "NODE_V292_FAKE_HARNESS_READINESS_NOT_BLOCKED"),
        readiness.warningIfMissing(
            "fakeHarnessExecutionDeniedEchoed", "FAKE_HARNESS_EXECUTION_DENIED_ECHO_MISSING"),
        readiness.warningIfMissing(
            "noSqlOrLedgerWriteEchoed", "EXECUTION_DENIED_WRITE_BOUNDARY_OPEN"));
  }

  static final class ReceiptBuilder {

    RehearsalManagedAuditSandboxEndpointCredentialResolverExecutionDeniedEchoReceipt build(
        RehearsalManagedAuditSandboxEndpointCredentialResolverImplementationPlanEchoReceipt
            sourceReceipt) {
      return ReleaseApprovalSandboxEndpointCredentialResolverExecutionDeniedEchoSupport.build(
          sourceReceipt);
    }
