...
final class OpsShardReadinessComparedEvidenceEvaluationPreflightSourceArtifactRuleCatalog {
    ...
    static List<OpsShardReadinessComparedEvidenceEvaluationPreflightResponse.EvaluationRule> sourceArtifactRules() {
        return List.of(
                OpsShardReadinessComparedEvidenceEvaluationPreflightSupport.rule("source-intake-readiness",
                        "Node v1332", "source artifact",
                        ...
                        OpsShardReadinessComparedPackageReviewEndpointRefs.CATALOG),
                OpsShardReadinessComparedEvidenceEvaluationPreflightSupport.rule("evidence-artifact-shape",
                        "Node v1333", "source artifact",
                ...
                OpsShardReadinessComparedEvidenceEvaluationPreflightSupport.rule("operator-provenance",
                        "Node v1334", "source artifact",
                        "Require operator provenance as a handle, not an identity switch.",
                        "reject-evaluation-operator-provenance-missing",
                        OpsShardReadinessComparedPackageReviewEndpointRefs.SOURCE_EVIDENCE),
                OpsShardReadinessComparedEvidenceEvaluationPreflightSupport.rule("manual-submission-reference",
                        "Node v1335", "source artifact",
                        ...
                        OpsShardReadinessComparedPackageReviewEndpointRefs.SOURCE_EVIDENCE),
                OpsShardReadinessComparedEvidenceEvaluationPreflightSupport.rule("offline-comparison-result",
                        "Node v1336", "source artifact",
                        "Require offline comparison result as a reference-only candidate field.",
                        "reject-evaluation-offline-comparison-result-missing",
                        OpsShardReadinessComparedPackageReviewEndpointRefs.COMPARISON_OUTCOME)
        );
    }
}
