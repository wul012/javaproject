...
public class OpsShardReadinessRouteCleanupArchivePlanService {
    ...
    public OpsShardReadinessRouteCleanupArchivePlanResponse plan() {
        ...
        List<OpsShardReadinessRouteCleanupArchivePlanResponse.ArchiveArtifact> artifacts = List.of(
                artifact("catalog-json", "json", OpsShardReadinessRouteCleanupEvidenceService.ENDPOINT,
                        root + "/route-cleanup-evidence-catalog-v" + version + ".json"),
                artifact("phase-summary-json", "json", OpsShardReadinessRouteCleanupPhaseSummaryService.ENDPOINT,
                        root + "/route-cleanup-phase-summary-v" + version + ".json"),
                artifact("boundary-matrix-json", "json", OpsShardReadinessRouteCleanupBoundaryMatrixService.ENDPOINT,
                        root + "/route-cleanup-boundary-matrix-v" + version + ".json"),
                artifact("handoff-checklist-json", "json", OpsShardReadinessRouteCleanupHandoffChecklistService.ENDPOINT,
