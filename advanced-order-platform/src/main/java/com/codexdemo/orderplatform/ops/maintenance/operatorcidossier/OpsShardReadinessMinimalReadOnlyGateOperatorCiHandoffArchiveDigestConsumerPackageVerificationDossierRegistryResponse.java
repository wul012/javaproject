...
public
record OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierRegistryResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record ProvenanceEntry(String name, String value, boolean required, String status) {}

  public record SectionDigest(String heading, int lineCount, boolean required, String status) {}
  ...
  public record AcceptanceGate(
      String code, String evidence, String verifyingArtifact, boolean passed, String status) {}

  public record BoundaryAudit(
      String code, String lockedBehavior, boolean locked, String auditEvidence, String status) {}

  public record ReleaseChecklistItem(
      int order, String item, String owner, String releaseEvidence, boolean ready, String status) {}

  public record HandoffReceipt(
      String receiver, String sourceEvidence, String receiptType, boolean ready, String status) {}
