...
public class OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffService {
    ...
    public OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffResponse registry() {
        ...
        var verificationRequirements =
                OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffRequirementCatalog
                        .requirements(source);
        var artifactCrossChecks =
                OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffArtifactCatalog.crossChecks(source);
        var routeHandoffs =
                OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffRouteCatalog.handoffs(source);
        var operatorInstructions =
                OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffOperatorCatalog.instructions(source);
        var ciProofs =
        ...
        var closeoutHandoffs =
                OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffCloseoutCatalog.handoffs(source);
        var scorecard =
