...
public class OpsShardReadinessV1ContractConsumerHandoffBundleService {
  ...
  public static final String ENDPOINT_CATALOG_SNAPSHOT_FREEZE_EVIDENCE_PATH =
      "e/209/evidence/java-shard-readiness-v208-endpoint-catalog-snapshot-freeze-v209.json";

  public static final String ENDPOINT_CATALOG_HISTORICAL_COMPATIBILITY_EVIDENCE_PATH =
