...
public class OpsShardReadinessRuntimeExecutionLiveReadGateService {
    ...
    private final OpsShardReadinessRuntimeExecutionApprovalInputValueValidationService valueValidationService;
    ...
    private String gateStatus(
        ...
        boolean smokeNotAttempted = !sourceReceipt.executionAttempted()
