...
public class OpsShardReadinessRuntimeExecutionArtifactCandidateService {
    ...
    static final String ENDPOINT = "/api/v1/ops/shard-readiness/runtime-execution-artifact-candidate";
    ...
    private String candidateStatus(OpsShardReadinessDeclaredOperatorLifecycleResponse sourceLifecycle) {
