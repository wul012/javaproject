...
final class ReleaseApprovalManagedAuditSandboxConnectionOperatorHandoffMarkerBuilder {
  ...
  private static final List<String> WARNING_DIGEST_WARNING_INPUT_NAMES =
      List.of("managedAuditSandboxConnectionOperatorHandoffMarkerWarnings");
  ...
  ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        ...
        sandboxConnectionWindowBoundary = sandboxConnectionWindowBoundary();
    ReleaseApprovalRehearsalSandboxConnectionResponseRecords
            ...
            List.of(
                ...
                ReleaseApprovalDigestSupport.line(
                    ...
                    ReleaseApprovalUpstreamContractConstants
                        .NODE_V228_MANUAL_SANDBOX_CONNECTION_OPERATOR_PACKET_PROFILE),
                ReleaseApprovalDigestSupport.line(
                    "consumedByNodeOperatorPacketState",
                    ReleaseApprovalUpstreamContractConstants
                        .NODE_V228_MANUAL_SANDBOX_CONNECTION_OPERATOR_PACKET_STATE),
                ReleaseApprovalDigestSupport.line(
                    "ownerApprovalArtifactIdField",
                    operatorPacketBoundary.ownerApprovalArtifactIdField()),
                ReleaseApprovalDigestSupport.line(
                    "schemaRehearsalIdField", operatorPacketBoundary.schemaRehearsalIdField()),
                ReleaseApprovalDigestSupport.line(
                    "credentialHandleNameField", credentialBoundary.credentialHandleNameField()),
                ReleaseApprovalDigestSupport.line(
                    "rollbackPathIdField", rollbackPathBoundary.rollbackPathIdField()),
                ReleaseApprovalDigestSupport.line(
                    "manualAbortMarkerField", rollbackPathBoundary.manualAbortMarkerField()),
                ReleaseApprovalDigestSupport.line(
                    "timeoutBudgetMs", rollbackPathBoundary.timeoutBudgetMs()),
                ReleaseApprovalDigestSupport.line(
    ...
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        ...
        ReleaseApprovalContractConstants
            .RELEASE_APPROVAL_REHEARSAL_MANAGED_AUDIT_SANDBOX_ADAPTER_APPROVAL_SCHEMA_GUARD_SCHEMA_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V227_MANUAL_SANDBOX_CONNECTION_EVIDENCE_CHECKLIST_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V227_MANUAL_SANDBOX_CONNECTION_EVIDENCE_CHECKLIST_PROFILE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V228_MANUAL_SANDBOX_CONNECTION_OPERATOR_PACKET_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V228_MANUAL_SANDBOX_CONNECTION_OPERATOR_PACKET_PROFILE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V228_MANUAL_SANDBOX_CONNECTION_OPERATOR_PACKET_ENDPOINT,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V228_MANUAL_SANDBOX_CONNECTION_OPERATOR_PACKET_STATE,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V229_MANUAL_SANDBOX_CONNECTION_PACKET_VERIFICATION_VERSION,
        ReleaseApprovalUpstreamContractConstants
            .NODE_V229_MANUAL_SANDBOX_CONNECTION_PACKET_VERIFICATION_PROFILE,
        true,
  ...
  List<String> warningDigestWarningLines(
    ...
    return List.of(
        ReleaseApprovalDigestSupport.line(
            "managedAuditSandboxConnectionOperatorHandoffMarkerWarnings", marker.markerWarnings()));
  }
  ...
  List<String> warningDigestBoundaryLines(
    ...
    return List.of(
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionOperatorHandoffMarkerDigest", marker.markerDigest()),
        ReleaseApprovalDigestSupport.line(
            "sandboxConnectionOperatorWindowOpenedByJava",
  ...
  private static ReleaseApprovalRehearsalSandboxConnectionResponseRecords
      ...
      sandboxConnectionWindowBoundary() {
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        .RehearsalSandboxConnectionWindowBoundary(true, false, false, false, false, false);
  }
  ...
  private static ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        .RehearsalSandboxConnectionCredentialBoundary(
        "ORDEROPS_MANAGED_AUDIT_SANDBOX_CREDENTIAL_HANDLE", true, false, false, false, false);
  }
  ...
  private static ReleaseApprovalRehearsalSandboxConnectionResponseRecords
    ...
    return new ReleaseApprovalRehearsalSandboxConnectionResponseRecords
        .RehearsalSandboxConnectionSchemaRehearsalBoundary(
        "ORDEROPS_MANAGED_AUDIT_SCHEMA_REHEARSAL_ID", true, false, false, false);
  }
