...
final class OpsShardReadinessCandidateDocumentSubmissionPrecheckSupport {
    ...
    static final String PRECHECK_STATE = "waiting-for-reviewed-real-compared-package-evidence-candidate-document";
    ...
    static OpsShardReadinessCandidateDocumentSubmissionPrecheckResponse response(
        ...
        checks.add("candidate-document-submission-precheck-source-node-" + SOURCE_NODE_REQUEST_PACKAGE_VERSION);
        checks.add("candidate-document-submission-precheck-source-java-request-package-" + sourcePackage.version());
        checks.add("candidate-document-submission-precheck-source-java-handoff-" + sourceHandoff.version());
        ...
        checks.add("candidate-document-submission-precheck-requested-field-count-" + REQUESTED_CANDIDATE_FIELD_COUNT);
