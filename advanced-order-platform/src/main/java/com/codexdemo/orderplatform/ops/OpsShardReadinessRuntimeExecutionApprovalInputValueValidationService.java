...
public class OpsShardReadinessRuntimeExecutionApprovalInputValueValidationService {
    ...
    public OpsShardReadinessRuntimeExecutionApprovalInputValueValidationResponse validation() {
        OpsShardReadinessRuntimeExecutionApprovalInputTemplateCompatibilityIntakeResponse sourceReceipt =
                compatibilityIntakeService.intake();
    ...
    private String validationStatus(
        ...
        boolean runtimeNotStartedByJava = !sourceReceipt.startsJavaService()
