...
final class OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffSupport {
  ...
  static OpsShardReadinessReleaseAcceptanceArchiveVerificationHandoffResponse response(
    ...
    checks.add(
        "release-acceptance-archive-verification-handoff-archive-verification-plan-"
            + ARCHIVE_VERIFICATION_PLAN);
    checks.add(
        "release-acceptance-archive-verification-handoff-operator-plan-" + OPERATOR_HANDOFF_PLAN);
    checks.add(
        "release-acceptance-archive-verification-handoff-source-archive-version-"
            + source.version());
    checks.add(
        "release-acceptance-archive-verification-handoff-source-archive-state-"
            + source.archiveRegistryState());
    checks.add(
        "release-acceptance-archive-verification-handoff-source-count-" + sourceArchiveCopy.size());
    checks.add(
        "release-acceptance-archive-verification-handoff-requirement-count-"
            + requirementCopy.size());
    checks.add(
        "release-acceptance-archive-verification-handoff-passed-requirement-count-"
            + passedRequirementCount);
    checks.add(
        "release-acceptance-archive-verification-handoff-artifact-count-" + artifactCopy.size());
    checks.add(
        "release-acceptance-archive-verification-handoff-passed-artifact-count-"
            + passedArtifactCount);
    checks.add("release-acceptance-archive-verification-handoff-route-count-" + routeCopy.size());
    checks.add(
        "release-acceptance-archive-verification-handoff-ready-route-count-" + readyRouteCount);
    checks.add(
        "release-acceptance-archive-verification-handoff-operator-count-" + operatorCopy.size());
    checks.add(
        "release-acceptance-archive-verification-handoff-ready-operator-count-"
            + readyOperatorCount);
    checks.add("release-acceptance-archive-verification-handoff-ci-proof-count-" + ciCopy.size());
    checks.add(
        "release-acceptance-archive-verification-handoff-passed-ci-proof-count-" + passedCiCount);
    checks.add(
        "release-acceptance-archive-verification-handoff-boundary-count-" + boundaryCopy.size());
    checks.add(
        "release-acceptance-archive-verification-handoff-locked-boundary-count-"
            + lockedBoundaryCount);
    checks.add(
        "release-acceptance-archive-verification-handoff-retention-count-" + retentionCopy.size());
    checks.add(
        "release-acceptance-archive-verification-handoff-ready-retention-count-"
            + readyRetentionCount);
    checks.add(
        "release-acceptance-archive-verification-handoff-closeout-count-" + closeoutCopy.size());
    checks.add(
        "release-acceptance-archive-verification-handoff-ready-closeout-count-"
            + readyCloseoutCount);
    checks.add(
        "release-acceptance-archive-verification-handoff-scorecard-count-" + scorecardCopy.size());
    checks.add(
        "release-acceptance-archive-verification-handoff-passed-scorecard-count-"
            + passedScorecardCount);
    checks.add(
        "release-acceptance-archive-verification-handoff-markdown-section-count-"
            + markdownCopy.size());
