...
public class OpsShardReadinessRouteCleanupPolicyGuardService {
    ...
    public OpsShardReadinessRouteCleanupPolicyGuardResponse guard() {
        ...
        List<OpsShardReadinessRouteCleanupPolicyGuardResponse.GuardRule> rules = List.of(
        ...
        boolean passed = snapshot.status().equals("passed")
                && register.status().equals("passed")
                && rules.stream().noneMatch(OpsShardReadinessRouteCleanupPolicyGuardResponse.GuardRule::allowed);
