...
public
record OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftTextPackageSubmissionPreflightResponse(
    String project,
    String version,
    boolean readOnly,
  ...
  public record SubmissionGate(String code, String category, String gate, String enforcement) {}
}
