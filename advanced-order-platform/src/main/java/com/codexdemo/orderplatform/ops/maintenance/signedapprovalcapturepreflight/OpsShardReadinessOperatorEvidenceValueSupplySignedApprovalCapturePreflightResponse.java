...
public record OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCapturePreflightResponse(
  ...
  public record CaptureAttestation(
      String code, String category, String attestation, String enforcement, String status) {}

  public record CapturePolicy(String code, String category, String policy, String enforcement) {}
}
