    ...
    static String failedMessages(List<FailedEventMessageResponse> messages) {
        ...
        messages.forEach(message -> appendRow(
                ...
                List.of(
                        ...
                        value(message.replayApprovalStatus()),
                        value(message.replayApprovalReason()),
                        value(message.replayApprovalRequestedBy()),
                        value(message.replayApprovalRequestedAt()),
                        value(message.replayApprovalReviewedBy()),
                        value(message.replayApprovalReviewedAt()),
                        value(message.replayApprovalReviewNote()),
