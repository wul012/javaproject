...
public class FailedEventMessageController {
  ...
  public PagedResponse<FailedEventMessageResponse> searchFailedMessages(
    ...
    return failedEventMessageService.searchFailedMessages(
  ...
  public ResponseEntity<String> exportFailedMessages(
      ...
      @RequestParam(required = false) Integer limit) {
    String csv =
        failedEventMessageService.exportFailedMessagesCsv(
            new FailedEventMessageSearchCriteria(
                status,
                eventType,
                aggregateType,
  ...
  public PagedResponse<FailedEventReplayAttemptResponse> searchReplayAttempts(
      ...
      @RequestParam(required = false) String sort,
      @RequestParam(required = false) Integer limit) {
    return failedEventMessageService.searchReplayAttempts(
  ...
  public ResponseEntity<String> exportManagementHistory(
      ...
      @RequestParam(required = false) Integer limit) {
    String csv =
        failedEventMessageService.exportManagementHistoryCsv(
            new FailedEventManagementHistorySearchCriteria(
                failedEventMessageId,
                previousStatus,
                newStatus,
  ...
  public PagedResponse<FailedEventReplayApprovalHistoryResponse> searchReplayApprovalHistory(
      ...
      @RequestParam(required = false) String sort,
      @RequestParam(required = false) Integer limit) {
    return failedEventMessageService.searchReplayApprovalHistory(
  ...
  public ResponseEntity<String> exportReplayApprovalHistory(
      ...
      @RequestParam(required = false) Integer limit) {
    String csv =
        failedEventMessageService.exportReplayApprovalHistoryCsv(
            new FailedEventReplayApprovalHistorySearchCriteria(
                failedEventMessageId,
                action,
                operatorId,
  ...
  public FailedEventOperatorContextResponse resolveOperatorContext(
  ...
  public FailedEventManagementBatchResponse markManagementStatus(
      @RequestHeader HttpHeaders headers,
      @Valid @RequestBody MarkFailedEventManagementRequest request) {
  ...
  public FailedEventMessageResponse replayFailedMessage(
      @PathVariable Long id,
      @RequestHeader HttpHeaders headers,
      @Valid @RequestBody(required = false) ReplayFailedEventRequest request) {
  ...
  public FailedEventMessageResponse requestReplayApproval(
      @PathVariable Long id,
      @RequestHeader HttpHeaders headers,
      @Valid @RequestBody(required = false) RequestFailedEventReplayApprovalRequest request) {
    return failedEventMessageService.requestReplayApproval(
        id,
        request,
        operatorContextResolver.resolve(
            headers, FailedEventOperatorAction.REQUEST_REPLAY_APPROVAL));
  }
  ...
  public FailedEventMessageResponse reviewReplayApproval(
      @PathVariable Long id,
      @RequestHeader HttpHeaders headers,
      @Valid @RequestBody(required = false) ReviewFailedEventReplayApprovalRequest request) {
