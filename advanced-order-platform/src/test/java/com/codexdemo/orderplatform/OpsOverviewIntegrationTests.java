...
class OpsOverviewIntegrationTests {
    ...
    void releaseApprovalRehearsalReturnsReadOnlyLiveAggregation() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/ops/release-approval-rehearsal"))
                ...
                .andExpect(jsonPath("$.liveReadinessHint.readOnlyEndpointVersion")
                        .value("java-release-approval-rehearsal-response-schema.v35"))
    ...
    @Test
    void releaseApprovalRehearsalExposesSandboxEndpointCredentialResolverApprovalRequiredImplementationReadinessEchoReceipt()
            throws Exception {
        mockMvc.perform(get("/api/v1/ops/release-approval-rehearsal")
