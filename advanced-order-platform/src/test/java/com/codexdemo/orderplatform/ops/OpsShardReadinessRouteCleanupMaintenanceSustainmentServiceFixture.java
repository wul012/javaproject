...
final class OpsShardReadinessRouteCleanupMaintenanceSustainmentServiceFixture {
    ...
    static OpsShardReadinessRouteCleanupMaintenanceHandoffAcceptanceDigestService handoffDigestService() {
    ...
    static OpsShardReadinessRouteCleanupMaintenanceArchiveRetentionCalendarService archiveRetentionService() {
        return new OpsShardReadinessRouteCleanupMaintenanceArchiveRetentionCalendarService();
    }

    static OpsShardReadinessRouteCleanupMaintenanceTestEvidenceRollupService testEvidenceRollupService() {
        return new OpsShardReadinessRouteCleanupMaintenanceTestEvidenceRollupService();
    }

    static OpsShardReadinessRouteCleanupMaintenanceOperationsScorecardService operationsScorecardService() {
