...
class OpsEvidenceServiceSignedHumanApprovalArtifactContractEchoTests
  ...
  void releaseApprovalRehearsalAddsSignedHumanApprovalArtifactContractEchoReceiptForNodeV315() {
    ...
    assertThat(receipt.sourceHumanApprovalArtifactReviewPostEchoDecisionGateEchoReceiptVersion())
        .isEqualTo(
            rehearsal
                ...
                .receiptVersion());
    assertThat(
            receipt.sourceHumanApprovalArtifactReviewPostEchoDecisionGateEchoReceiptSchemaVersion())
    ...
    assertThat(receipt.sourceHumanApprovalArtifactReviewPostEchoDecisionGateEchoReceiptDigest())
        .isEqualTo(
            rehearsal
                .managedAuditSandboxEndpointCredentialResolverHumanApprovalArtifactReviewPostEchoDecisionGateEchoReceipt()
                .receiptDigest());
    assertThat(receipt.consumedByNodeSignedHumanApprovalArtifactContractVersion())
        .isEqualTo("Node v314");
    ...
    assertThat(receipt.necessityProof().consumer())
        .isEqualTo("Java v145 + mini-kv v138, then Node v315");
