...
class OpsEvidenceServiceAbortRollbackSemanticsContractEchoTests
  ...
  void releaseApprovalRehearsalAddsAbortRollbackSemanticsContractEchoReceiptForNodeV327() {
    ...
    assertThat(receipt.sourceNoNetworkSafetyFixtureContractEchoReceiptDigest())
        .isEqualTo(
            rehearsal
                .managedAuditSandboxEndpointCredentialResolverNoNetworkSafetyFixtureContractEchoReceipt()
                .receiptDigest());
    assertThat(receipt.consumedByNodeAbortRollbackSemanticsContractVersion())
        .isEqualTo("Node v326");
    ...
    assertThat(receipt.prerequisiteTransition().completedPrerequisiteCountBeforeV326())
        .isEqualTo(5);
    assertThat(receipt.prerequisiteTransition().remainingPrerequisiteCountBeforeV326())
        .isEqualTo(1);
    ...
    assertThat(receipt.necessityProof().consumer())
        .isEqualTo("Java v150 + mini-kv v142, then Node v327");
