...
class OpsShardReadinessScreenshotExplanationArchiveRegistryControllerTests {
    ...
    void registryRouteExposesScreenshotExplanationArchivePolicy() {
        ...
        var response = new OpsShardReadinessScreenshotExplanationArchiveRegistryController(
                OpsShardReadinessScreenshotExplanationArchiveRegistryTestSupport.service())
                .registry();
