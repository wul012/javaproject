...
class OpsShardReadinessReleaseAcceptanceRoutePathSplitSustainmentAcceptancePackageCatalogTests {
    ...
    void acceptancePackageEvidenceIsReady() {
        ...
        assertThat(response.archiveItems())
                .allSatisfy(item -> assertThat(item.ready()).isTrue());
        assertThat(response.reviewItems())
                .allSatisfy(item -> assertThat(item.passed()).isTrue());
        assertThat(response.ciEvidence())
                .allSatisfy(item -> assertThat(item.passed()).isTrue());
        ...
        assertThat(response.nextChangeRules())
                .allSatisfy(rule -> assertThat(rule.ready()).isTrue());
