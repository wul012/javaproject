...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverDisabledImplementationCandidateEchoRecords;
...
class OpsEvidenceServiceCredentialResolverDisabledImplementationCandidateEchoTests
  ...
  void
    ...
    assertThat(
            receipt.consumedByNodeCredentialResolverDisabledImplementationCandidateReviewVersion())
        .isEqualTo("Node v273");
    assertThat(
            receipt.consumedByNodeCredentialResolverDisabledImplementationCandidateReviewProfile())
        .isEqualTo(
            "managed-audit-manual-sandbox-connection-credential-resolver-disabled-implementation-candidate-review.v1");
    assertThat(
            receipt.consumedByNodeCredentialResolverDisabledImplementationCandidateReviewEndpoint())
        .isEqualTo(
            "/api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-disabled-implementation-candidate-review");
    assertThat(
            receipt
                .consumedByNodeCredentialResolverDisabledImplementationCandidateReviewMarkdownEndpoint())
        .isEqualTo(
    ...
    assertThat(
            receipt
                .sourceNodeCredentialResolverPreImplementationPlanIntakeUpstreamEchoVerificationVersion())
        .isEqualTo("Node v272");
    assertThat(
            receipt
                .sourceNodeCredentialResolverPreImplementationPlanIntakeUpstreamEchoVerificationProfile())
        .isEqualTo(
    ...
    assertThat(receipt.sourceSpan())
        .isEqualTo("Node v273 disabled implementation candidate review");
    ...
    assertThat(
            receipt.sourceNodeV273().sourceNodeV272().readyForPlanIntakeUpstreamEchoVerification())
        .isTrue();
    assertThat(receipt.sourceNodeV273().sourceNodeV272().readOnlyUpstreamEchoVerification())
        .isTrue();
    ...
    assertThat(receipt.sourceNodeV273().sourceNodeV272().miniKvV119NonParticipationReady())
        .isTrue();
    ...
    assertThat(receipt.approvalRequiredBoundaryExplanations())
        .allMatch(
            explanation ->
                explanation.evidenceAllowed().equals("approval-required-read-only-evidence")
    ...
    assertThat(receipt.sideEffectBoundary().readyForManagedAuditSandboxAdapterConnection())
        .isFalse();
    ...
    assertThat(receipt.nodeRecommendationCodes())
        .containsExactly(
            "RUN_PARALLEL_JAVA_V113_MINI_KV_V120", "VERIFY_WITH_NODE_V274_AFTER_UPSTREAM_ECHO");
