...
class OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionCatalogTests {
    ...
    void sectionCatalogSplitsSubmissionAndComparedEvidenceGroups() {
        ...
        assertThat(response.sections())
                ...
                .hasSize(5)
                .allSatisfy(section -> assertThat(section.rendererOwner())
                        .isEqualTo("signed-approval-draft-text-package-submission-profile-section-renderer"));
        assertThat(response.sections())
                .filteredOn(section -> section.rendererGroup().equals("compared-evidence"))
                .hasSize(4)
                .allSatisfy(section -> assertThat(section.rendererOwner())
                        .isEqualTo("signed-approval-draft-text-package-compared-evidence-profile-section-renderer"));
    }
    ...
    void sectionHeadingsRemainRouteFacingAndStable() {
        ...
        assertThat(response.sections())
                .extracting(OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryResponse
                        .TextPackageProfileSection::heading)
                .containsExactly(
