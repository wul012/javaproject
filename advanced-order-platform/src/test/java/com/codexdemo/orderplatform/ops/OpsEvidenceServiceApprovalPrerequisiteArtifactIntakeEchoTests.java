...
class OpsEvidenceServiceApprovalPrerequisiteArtifactIntakeEchoTests
  ...
  void releaseApprovalRehearsalAddsApprovalPrerequisiteArtifactIntakeEchoReceiptForNodeV307() {
    ...
    assertThat(receipt.readyForNodeV307ApprovalPrerequisiteArtifactUpstreamEchoVerification())
        .isTrue();
