...
class OpsShardReadinessOperatorEvidenceValueDraftFoundationServiceTests {
  ...
  void buildsValueDraftCatalogWithTwentyFiveBlockedDraftSlots() {
    ...
    assertThat(catalog.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/operator-evidence-value-draft-catalog");
    assertThat(catalog.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-draft-catalog.v1");
    ...
    assertThat(catalog.slots())
        ...
        .startsWith(
            "VALUE_DRAFT_01_SOURCE_WORKSHEET_CLOSEOUT", "VALUE_DRAFT_02_PREFLIGHT_SLOT_COUNT")
  ...
  void buildsSlotTemplateWithoutOperatorValues() {
    ...
    assertThat(template.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/operator-evidence-value-draft-slot-template");
    assertThat(template.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-draft-slot-template.v1");
  ...
  void buildsValueBoundaryWithActualValuesNotSupplied() {
    ...
    assertThat(boundary.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/operator-evidence-value-draft-value-boundary");
    assertThat(boundary.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-draft-value-boundary.v1");
  ...
  void buildsInstructionSetForBlockedImportDraftSlots() {
    ...
    assertThat(instructions.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/operator-evidence-value-draft-instruction-set");
    assertThat(instructions.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-draft-instruction-set.v1");
    ...
    assertThat(instructions.checks())
        .contains(
  ...
  void buildsSafetyGateMatrixWithoutSecretOrSyntheticValues() {
    ...
    assertThat(matrix.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/operator-evidence-value-draft-safety-gate-matrix");
    assertThat(matrix.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-draft-safety-gate-matrix.v1");
  ...
  void buildsSourceMappingRegistryFromPreflightEndpointsOnly() {
    ...
    assertThat(registry.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-draft-source-mapping-registry.v1");
