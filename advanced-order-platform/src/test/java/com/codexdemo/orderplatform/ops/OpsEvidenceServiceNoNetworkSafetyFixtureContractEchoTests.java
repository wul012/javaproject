...
class OpsEvidenceServiceNoNetworkSafetyFixtureContractEchoTests
  ...
  void releaseApprovalRehearsalAddsNoNetworkSafetyFixtureContractEchoReceiptForNodeV324() {
    ...
    assertThat(receipt.sourceEndpointHandleAllowlistApprovalContractEchoReceiptDigest())
        .isEqualTo(
            rehearsal
                .managedAuditSandboxEndpointCredentialResolverEndpointHandleAllowlistApprovalContractEchoReceipt()
                .receiptDigest());
    assertThat(receipt.consumedByNodeNoNetworkSafetyFixtureContractVersion())
        .isEqualTo("Node v323");
    ...
    assertThat(receipt.necessityProof().consumer())
        .isEqualTo("Java v149 + mini-kv v141, then Node v324");

    assertThat(receipt.checks().sourceNodeV322Ready()).isTrue();
    assertThat(receipt.checks().sourceJavaV147EndpointHandleAllowlistApprovalContractReady())
        .isTrue();
