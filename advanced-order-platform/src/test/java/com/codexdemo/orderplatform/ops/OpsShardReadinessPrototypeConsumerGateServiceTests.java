...
class OpsShardReadinessPrototypeConsumerGateServiceTests {
  ...
  void buildsPrototypeConsumerGateCatalogFromHandoffCloseout() {
    ...
    assertThat(catalog.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-consumer-gate-catalog");
    assertThat(catalog.profile())
        .isEqualTo("java-shard-readiness-prototype-consumer-gate-catalog.v1");
    assertThat(catalog.sourceHandoffVersion()).isEqualTo("Java v447");
    assertThat(catalog.sourceHandoffEndpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-handoff-closeout");
  ...
  void buildsSourceInventoryEvidenceForNodeConsumerGate() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-consumer-gate-source-inventory");
    assertThat(evidence.profile())
        .isEqualTo("java-shard-readiness-prototype-consumer-gate-source-inventory.v1");
    ...
    assertThat(evidence.evidenceRefs())
        .contains(
            "prototype-handoff-closeout:/api/v1/ops/shard-readiness/prototype-handoff-closeout");
  ...
  void buildsMinimalFieldChecklistEvidence() {
    OpsShardReadinessPrototypeConsumerGateEvidenceResponse evidence =
        service().minimalFieldChecklist();

    assertThat(evidence.version()).isEqualTo("Java v453");
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-consumer-gate-minimal-field-checklist");
    assertThat(evidence.profile())
        .isEqualTo("java-shard-readiness-prototype-consumer-gate-minimal-field-checklist.v1");
  ...
  void buildsRouteTopologyPreviewEvidence() {
    OpsShardReadinessPrototypeConsumerGateEvidenceResponse evidence =
        service().routeTopologyPreview();

    assertThat(evidence.version()).isEqualTo("Java v455");
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-consumer-gate-route-topology-preview");
    assertThat(evidence.profile())
        .isEqualTo("java-shard-readiness-prototype-consumer-gate-route-topology-preview.v1");
    assertThat(evidence.checks())
        .contains(
  ...
  void buildsBoundaryMatrixEvidenceForConsumerGate() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-consumer-gate-boundary-matrix");
    assertThat(evidence.profile())
        .isEqualTo("java-shard-readiness-prototype-consumer-gate-boundary-matrix.v1");
    assertThat(evidence.checks())
        .contains(
  ...
  void buildsDigestAcceptanceEvidence() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-consumer-gate-digest-acceptance");
    assertThat(evidence.profile())
        .isEqualTo("java-shard-readiness-prototype-consumer-gate-digest-acceptance.v1");
    assertThat(evidence.checks())
        .contains(
  ...
  void buildsCiBatchPlanEvidence() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-consumer-gate-ci-batch-plan");
    assertThat(evidence.profile())
        .isEqualTo("java-shard-readiness-prototype-consumer-gate-ci-batch-plan.v1");
    assertThat(evidence.checks())
        .contains(
  ...
  void buildsArchiveManifestEvidence() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-consumer-gate-archive-manifest");
    assertThat(evidence.profile())
        .isEqualTo("java-shard-readiness-prototype-consumer-gate-archive-manifest.v1");
  ...
  void buildsOperatorSignoffEvidence() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-consumer-gate-operator-signoff");
    assertThat(evidence.profile())
        .isEqualTo("java-shard-readiness-prototype-consumer-gate-operator-signoff.v1");
    assertThat(evidence.evidencePath())
        .isEqualTo(
  ...
  void closesOutPrototypeConsumerGateEvidenceRunForNodeV370() {
    ...
    assertThat(closeout.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-consumer-gate-closeout");
    assertThat(closeout.profile())
        .isEqualTo("java-shard-readiness-prototype-consumer-gate-closeout.v1");
    assertThat(closeout.evidencePath())
        .isEqualTo(
    ...
    assertThat(OpsShardReadinessPrototypeConsumerGateEvidenceCatalog.entries())
        .allSatisfy(
            entry -> {
              ...
              assertThat(evidence.sourceHandoffEndpoint())
                  .isEqualTo("/api/v1/ops/shard-readiness/prototype-handoff-closeout");
              assertThat(evidence.sourceHandoffEvidencePath())
                  .isEqualTo(
