...
class OpsShardReadinessRouteCleanupMaintenanceDependencyBoundaryMapServiceTests {
    ...
    void buildsDependencyBoundaryMapFromUpkeepCatalog() {
        ...
        assertThat(map.endpoint()).isEqualTo(
                "/api/v1/ops/shard-readiness/route-cleanup-maintenance-dependency-boundary-map");
        assertThat(map.profile()).isEqualTo(
        ...
        assertThat(map.boundaries())
                .extracting(OpsShardReadinessRouteCleanupMaintenanceDependencyBoundaryMapResponse
        ...
        assertThat(map.boundaries()).allSatisfy(boundary -> {
