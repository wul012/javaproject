...
class OpsShardReadinessRouteCleanupMaintenanceRemediationQueueServiceTests {
    ...
    void buildsReadOnlyRemediationQueuePreview() {
        ...
        assertThat(queue.endpoint()).isEqualTo(
                "/api/v1/ops/shard-readiness/route-cleanup-maintenance-remediation-queue");
        assertThat(queue.profile()).isEqualTo(
        ...
        assertThat(queue.items())
                .extracting(OpsShardReadinessRouteCleanupMaintenanceRemediationQueueResponse.QueueItem::name)
                .containsExactly(
