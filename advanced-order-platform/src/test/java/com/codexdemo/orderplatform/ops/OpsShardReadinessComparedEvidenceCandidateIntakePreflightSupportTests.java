...
class OpsShardReadinessComparedEvidenceCandidateIntakePreflightSupportTests {
    ...
    void buildsWaitingForRealDocumentStateWithoutImportsOrEvaluation() {
        var response = OpsShardReadinessComparedEvidenceCandidateIntakePreflightSupport.response(
                "Java v1065",
        ...
        assertThat(response.intakeState()).isEqualTo("waiting-for-real-compared-package-evidence-candidate-document");
