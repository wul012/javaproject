...
class OpsEvidenceServiceCredentialResolverPreImplementationPlanIntakeEchoTests
  ...
  void
    ...
    assertThat(
            receipt
                .sourceNodeCredentialResolverProductionReadinessBlockedDecisionUpstreamEchoVerificationVersion())
        .isEqualTo("Node v269");
    ...
    assertThat(
        ...
        .isTrue();
    assertThat(receipt.sourceNodeV270().sourceNodeV269().verificationDigest())
        .startsWith("sha256:");
    ...
    assertThat(receipt.sourceNodeV270().sourceNodeV269().miniKvV118NonParticipationReady())
        .isTrue();
    assertThat(receipt.sourceNodeV270().sourceNodeV269().blockedDecisionAligned()).isTrue();
    assertThat(receipt.sourceNodeV270().sourceNodeV269().missingRequirementBlockersAligned())
        .isTrue();
    ...
    assertThat(receipt.readyForNodeV272CredentialResolverPreImplementationPlanVerification())
        .isTrue();
    ...
    assertThat(receipt.nodeRecommendationCodes())
        .containsExactly(
            "RUN_V271_STATUS_ROUTES_QUALITY_BRANCH", "RUN_PARALLEL_JAVA_V112_MINI_KV_V119");
