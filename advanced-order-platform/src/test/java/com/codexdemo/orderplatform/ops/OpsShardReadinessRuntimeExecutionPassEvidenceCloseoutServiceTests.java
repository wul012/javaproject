...
class OpsShardReadinessRuntimeExecutionPassEvidenceCloseoutServiceTests {
    ...
    void buildsJavaPassEvidenceCloseoutWithoutRerunningSmoke() {
        ...
        assertThat(receipt.receiptId()).isEqualTo("java-runtime-execution-pass-evidence-closeout-receipt-v170");
        ...
        assertThat(receipt.evidencePath())
                .isEqualTo("e/170/evidence/java-shard-readiness-runtime-execution-pass-evidence-closeout-v170.json");
