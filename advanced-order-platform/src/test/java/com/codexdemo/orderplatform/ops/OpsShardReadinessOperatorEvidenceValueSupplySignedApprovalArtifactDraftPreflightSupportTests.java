...
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightSupportTests {
    ...
    void buildsDraftPreflightResponseWithoutCreatingManualDraft() {
        var response = OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightSupport.response(
                "Java v785",
                "/ops/shard-readiness/draft-preflight-sample",
                "sample.signed-approval-artifact-draft-preflight.v1",
                List.of(OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightSupport.field(
                        "FIELD_01", "ARTIFACT_DRAFT_READINESS_01_REQUEST_ID", "request",
                        "require request id draft field", "request field cannot create manual draft",
                        ...
                        OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessCloseoutService
                                .ENDPOINT)),
                List.of(OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightSupport.guard(
                        "ARTIFACT_DRAFT_PREFLIGHT_REQUEST_ID_GUARD", "request",
                        "guard request id as metadata only", "reject-manual-draft-materialization", "fail-closed")),
                List.of(OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightSupport.gate(
                        "DRAFT_PREFLIGHT_GATE_01", "draft", "manual draft remains unavailable", "fail-closed")),
