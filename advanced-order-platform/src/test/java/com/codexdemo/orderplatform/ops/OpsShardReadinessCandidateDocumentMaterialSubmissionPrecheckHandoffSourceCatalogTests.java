...
class OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffSourceCatalogTests {
    ...
    void sourceLineagePinsNodePlanAndJavaPrecheck() {
        ...
        assertThat(lineage)
                .extracting(OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffResponse.SourceLineage::order)
                .containsExactly(1, 2, 3, 4, 5, 6);
        assertThat(lineage)
                .extracting(OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffResponse.SourceLineage::code)
                .containsExactly(
        ...
        assertThat(lineage)
                .extracting(OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffResponse.SourceLineage::status)
                .containsOnly("passed");
    }

    @Test
    void moduleCatalogStaysShortAndOrdered() {
        assertThat(OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffModuleCatalog.modules())
                .extracting(OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffResponse.ModuleEntry::order)
                .containsExactly(214, 215, 216, 217, 218);
        assertThat(OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffModuleCatalog.modules())
                .extracting(OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckHandoffResponse.ModuleEntry::code)
                .contains(
