...
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightGateCatalogTests {
    ...
    void listsDraftPreflightGatesWithManualDraftLocked() {
        var gates = OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftPreflightGateCatalog
                .allGates();
        ...
        assertThat(gates).anySatisfy(gate -> assertThat(gate.code()).contains("NO_DRAFT_MATERIALIZATION"));
    }
}
