...
import com.codexdemo.orderplatform.ops.maintenance.releaseapproval.ReleaseApprovalSandboxEndpointCredentialResolverTestOnlyShellEchoRecords.RehearsalSandboxEndpointCredentialResolverTestOnlyShellFailureMapping;
...
class OpsEvidenceServiceCredentialResolverEarlyEchoTests
  ...
  void releaseApprovalRehearsalAddsSandboxEndpointCredentialResolverDisabledPrecheckEchoMarker() {
    ...
    assertThat(
            marker
                .consumedByNodeSandboxEndpointCredentialResolverDisabledPrecheckMarkdownEndpoint())
        .isEqualTo(
    ...
    assertThat(
            marker
                .nextNodeSandboxEndpointCredentialResolverDisabledPrecheckUpstreamEchoVerificationVersion())
        .isEqualTo("Node v263");
    assertThat(marker.nodeV263MayConsume()).isTrue();
    assertThat(marker.precheckMode())
        .isEqualTo("sandbox-endpoint-credential-resolver-disabled-precheck-only");
    assertThat(marker.sourceSpan())
        .isEqualTo("Node v261 credential resolver upstream echo verification");
    ...
    assertThat(marker.sourceNodeV261().sourceSpan())
        .isEqualTo("Node v260 + Java v105 + mini-kv v114");
    ...
    assertThat(marker.sourceNodeV261().readyForNodeV262CredentialResolverDisabledPrecheck())
        .isTrue();
    assertThat(marker.disabledPrecheck().precheckDigest()).startsWith("sha256:");
    assertThat(marker.disabledPrecheck().precheckMode())
        .isEqualTo("sandbox-endpoint-credential-resolver-disabled-precheck-only");
    assertThat(marker.disabledPrecheck().resolverImplementationStatus())
        .isEqualTo("not-implemented");
    assertThat(marker.disabledPrecheck().secretProviderImplementationStatus())
        .isEqualTo("not-implemented");
    ...
    assertThat(marker.disabledPrecheck().dryRunResponseShape().readyState())
        .isEqualTo("sandbox-endpoint-credential-resolver-disabled-precheck-ready");
    assertThat(marker.disabledPrecheck().dryRunResponseShape().resolverClientInstantiated())
        .isFalse();
    assertThat(marker.disabledPrecheck().dryRunResponseShape().secretProviderInstantiated())
        .isFalse();
  ...
  void releaseApprovalRehearsalAddsSandboxEndpointCredentialResolverTestOnlyShellEchoMarker() {
    ...
    assertThat(
            marker
                .nextNodeSandboxEndpointCredentialResolverTestOnlyShellUpstreamEchoVerificationVersion())
        .isEqualTo("Node v265");
    assertThat(marker.nodeV265MayConsume()).isTrue();
    assertThat(marker.shellMode()).isEqualTo("test-only-fake-resolver-contract");
    assertThat(marker.sourceSpan())
        .isEqualTo("Node v264 credential resolver test-only shell contract");
    ...
    assertThat(marker.sourceNodeV263().sourceSpan())
        .isEqualTo("Node v262 + Java v106 + mini-kv v115");
    ...
    assertThat(marker.sourceNodeV263().readyForNodeV264CredentialResolverTestOnlyShellContract())
        .isTrue();
    ...
    assertThat(marker.resolverShellContract().shellMode())
        .isEqualTo("test-only-fake-resolver-contract");
    ...
    assertThat(marker.resolverShellContract().requestShape().resolverPolicyHandleRequired())
        .isTrue();
    ...
    assertThat(marker.resolverShellContract().responseShape().resolverClientInstantiated())
        .isFalse();
    assertThat(marker.resolverShellContract().responseShape().secretProviderInstantiated())
        .isFalse();
    ...
    assertThat(marker.resolverShellContract().failureMapping())
        .allMatch(
            mapping -> mapping.shellFailureCode().startsWith("TEST_ONLY_") && !mapping.retryable());
    ...
    assertThat(marker.resolverShellContract().fakeResolverProbe().resolverKind())
        .isEqualTo("fake-in-memory");
    assertThat(marker.resolverShellContract().fakeResolverProbe().acceptedByFakeResolver())
        .isTrue();
    ...
    assertThat(marker.resolverShellContract().fakeResolverProbe().credentialValueLoaded())
        .isFalse();
    ...
    assertThat(marker.resolverShellContract().fakeResolverProbe().schemaMigrationExecuted())
        .isFalse();
    assertThat(marker.resolverShellContract().fakeResolverProbe().productionRecordWritten())
        .isFalse();
    assertThat(marker.resolverShellContract().fakeResolverProbe().probeDigest())
        .startsWith("sha256:");
  ...
  void releaseApprovalRehearsalAddsSandboxEndpointCredentialResolverFakeShellArchiveEchoReceipt() {
    ...
    assertThat(
            receipt
                .consumedByNodeSandboxEndpointCredentialResolverFakeShellArchiveVerificationVersion())
        .isEqualTo("Node v266");
    assertThat(
            receipt
    ...
    assertThat(
            receipt
                .consumedByNodeSandboxEndpointCredentialResolverFakeShellArchiveVerificationEndpoint())
        .isEqualTo(
            "/api/v1/audit/managed-audit-manual-sandbox-connection-credential-resolver-fake-shell-archive-verification");
    assertThat(
            receipt
                .consumedByNodeSandboxEndpointCredentialResolverFakeShellArchiveVerificationState())
    ...
    assertThat(
            receipt
                .sourceNodeSandboxEndpointCredentialResolverTestOnlyShellUpstreamEchoVerificationVersion())
        .isEqualTo("Node v265");
    assertThat(
            receipt
                .sourceNodeSandboxEndpointCredentialResolverTestOnlyShellUpstreamEchoVerificationState())
        .isEqualTo(
            "sandbox-endpoint-credential-resolver-test-only-shell-upstream-echo-verification-ready");
    assertThat(
            receipt
                .nextNodeSandboxEndpointCredentialResolverFakeShellArchiveUpstreamEchoVerificationVersion())
        .isEqualTo("Node v267");
    ...
    assertThat(receipt.archiveEvidence().sourceVersions())
        .containsExactly("Node v264", "Node v265");
    ...
    assertThat(receipt.archiveVerification().archiveVerificationRerunsFakeShellBehavior())
        .isFalse();
