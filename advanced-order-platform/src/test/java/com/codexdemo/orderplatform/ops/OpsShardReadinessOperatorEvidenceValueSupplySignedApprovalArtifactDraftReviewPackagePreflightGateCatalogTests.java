...
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReviewPackagePreflightGateCatalogTests {
    ...
    void listsReviewPackageGatesWithDraftAuthoringLocked() {
        var gates = OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReviewPackagePreflightGateCatalog
                .allGates();
        ...
        assertThat(gates).anySatisfy(gate -> assertThat(gate.code()).contains("NEXT_STEP_HUMAN_DRAFT_PLAN"));
    }
}
