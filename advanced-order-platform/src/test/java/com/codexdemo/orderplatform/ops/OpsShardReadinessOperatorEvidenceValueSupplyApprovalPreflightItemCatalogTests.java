...
class OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightItemCatalogTests {
    ...
    void catalogsTwentyFiveApprovalPacketItemsMappedToValueSupplySlots() {
        ...
        assertThat(OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightItemCatalog.allItems())
                .extracting(
                        OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightResponse.ApprovalItem::sourceEnvelopeSlot)
                .startsWith("VALUE_SUPPLY_01_ENVELOPE_ID")
                .endsWith("VALUE_SUPPLY_25_CLOSEOUT_LOCKS_HELD");

        assertThat(OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightItemCatalog.allItems())
                .extracting(
                        OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightResponse.ApprovalItem::sourceEndpoint)
    ...
    void returnsStageSlicesForFocusedApprovalPreflightServices() {
        assertThat(OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightItemCatalog.items(8, 12))
                .extracting(OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightResponse.ApprovalItem::packetStage)
                .containsOnly("redaction");

        assertThat(OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightItemCatalog.items(19, 22))
                .extracting(OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightResponse.ApprovalItem::packetStage)
