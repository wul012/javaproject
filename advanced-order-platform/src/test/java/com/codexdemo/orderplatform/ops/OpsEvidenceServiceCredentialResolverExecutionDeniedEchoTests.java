...
class OpsEvidenceServiceCredentialResolverExecutionDeniedEchoTests
  ...
  void releaseApprovalRehearsalAddsDirectExecutionDeniedEchoReceiptForNodeV293() {
    ...
    assertThat(
            receipt.consumedByNodeCredentialResolverFakeHarnessReadinessDecisionMarkdownEndpoint())
    ...
    assertThat(
            receipt
                .nextNodeCredentialResolverFakeHarnessReadinessBlockedDecisionUpstreamEchoVerificationVersion())
        .isEqualTo("Node v293");
    assertThat(
            receipt
                .nextNodeCredentialResolverFakeHarnessReadinessBlockedDecisionUpstreamEchoVerificationProfile())
        .isEqualTo(
    ...
    assertThat(
            receipt
                .nextNodeCredentialResolverFakeHarnessReadinessBlockedDecisionUpstreamEchoVerificationState())
        .isEqualTo(
    ...
    assertThat(receipt.executionDeniedDecision().managedAuditResolverImplementationDenied())
        .isTrue();
    ...
    assertThat(receipt.executionDeniedDecision().nodeV293MayConsumeWithoutRuntimeExecution())
        .isTrue();
