...
class OpsShardReadinessRouteCleanupMaintenanceFreshnessWindowServiceTests {
  ...
  void buildsFreshnessWindowFromVersionedCatalog() {
    ...
    assertThat(window.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/route-cleanup-maintenance-freshness-window");
    assertThat(window.profile())
        .isEqualTo("java-shard-readiness-route-cleanup-maintenance-freshness-window.v1");
