...
class OpsShardReadinessCandidateDocumentSubmissionPrecheckControllerTests {
  ...
  void precheckRouteExposesReadOnlyRouteEvidence() {
    assertThat(OpsShardReadinessCandidateDocumentRoutePaths.CANDIDATE_DOCUMENT_SUBMISSION_PRECHECK)
    ...
    assertThat(response.artifacts())
        .extracting(
            OpsShardReadinessCandidateDocumentSubmissionPrecheckResponse.Artifact::reference)
