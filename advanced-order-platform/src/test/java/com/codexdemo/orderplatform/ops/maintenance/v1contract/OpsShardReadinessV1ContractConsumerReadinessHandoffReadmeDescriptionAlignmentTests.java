...
import static com.codexdemo.orderplatform.ops.maintenance.v1contract.OpsShardReadinessV1ContractConsumerReadinessHandoffTextArchiveTestSupport.normalizeScopeText;
import static com.codexdemo.orderplatform.ops.maintenance.v1contract.OpsShardReadinessV1ContractConsumerReadinessHandoffTextArchiveTestSupport.readmeLines;
...
class OpsShardReadinessV1ContractConsumerReadinessHandoffReadmeDescriptionAlignmentTests {
  ...
  void keepsEveryCatalogReadmeEntryDescriptiveAndScopeAligned() throws IOException {
    ...
    for (OpsShardReadinessV1ContractConsumerReadinessHandoffPostHandoffEvidenceCatalog.Receipt
      ...
      assertThat(normalizeScopeText(line))
          .as("README line for v" + receipt.version())
