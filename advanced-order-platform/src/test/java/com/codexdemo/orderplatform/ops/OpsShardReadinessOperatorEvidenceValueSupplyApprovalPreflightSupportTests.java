    ...
    void buildsDraftApprovalPreflightResponseWithoutCapturingApprovalOrValues() {
        OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightResponse response =
                OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightSupport.response(
                        ...
                        List.of(OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightSupport.item(
                        ...
                        List.of(OpsShardReadinessOperatorEvidenceValueSupplyApprovalPreflightSupport.policy(
        ...
        assertThat(response.items().get(0).evidenceFileId()).isEqualTo("java-v658-value-supply-closeout");
