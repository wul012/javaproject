...
class OpsShardReadinessRouteCleanupMaintenanceOperatorReviewPacketServiceTests {
    ...
    void buildsOperatorReviewPacketFromTypedMaintenanceServices() {
        OpsShardReadinessRouteCleanupMaintenanceOperatorReviewPacketResponse packet = service().packet();

        assertThat(packet.version()).isEqualTo("Java v501");
        assertThat(packet.endpoint()).isEqualTo(
                "/api/v1/ops/shard-readiness/route-cleanup-maintenance-operator-review-packet");
        ...
        assertThat(packet.sections())
                .extracting(OpsShardReadinessRouteCleanupMaintenanceOperatorReviewPacketResponse
                        .ReviewSection::name)
                .containsExactly(
                        "upkeep-catalog",
        ...
        assertThat(packet.sections()).allSatisfy(section -> {
