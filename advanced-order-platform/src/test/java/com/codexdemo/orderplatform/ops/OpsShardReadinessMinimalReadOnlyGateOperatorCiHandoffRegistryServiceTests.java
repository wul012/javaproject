...
class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryServiceTests {

    @Test
    void buildsOperatorCiHandoffFromArchiveVerificationRegistry() {
        var response = OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryTestSupport
                .registry();
        ...
        assertThat(response.sourceArchiveEndpoint()).isEqualTo(
    ...
    void carriesFocusedGroupedBuildSmokeOrder() {
        ...
        assertThat(response.sourceArchiveSnapshotCount()).isEqualTo(
        ...
        assertThat(response.operatorLanes())
                .extracting(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffRegistryResponse
                        .OperatorLane::lane)
    ...
    void verifiesBoundaryLocksAndScorecard() {
        ...
        assertThat(response.scorecard()).allSatisfy(score -> assertThat(score.status()).isEqualTo("passed"));
    }
}
