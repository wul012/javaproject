...
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCaptureArtifactPreflightAssuranceServiceTests {
    ...
    void exposesSignatureSealWithoutSignatureMaterial() {
        var response = new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCaptureArtifactPreflightSignatureSealService()
                .seal();
    ...
    void exposesArchivePlanWithoutFileWrites() {
        var response = new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCaptureArtifactPreflightArchivePlanService()
                .plan();
    ...
    void closesOutArtifactPreflightWithAllLocksHeld() {
        var response = new OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCaptureArtifactPreflightCloseoutService()
                .closeout();
