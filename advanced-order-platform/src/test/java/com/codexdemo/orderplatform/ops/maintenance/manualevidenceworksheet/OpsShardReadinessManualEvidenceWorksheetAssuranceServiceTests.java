...
class OpsShardReadinessManualEvidenceWorksheetAssuranceServiceTests {
  ...
  void buildsImporterPreflightWithoutImportExecution() {
    ...
    assertThat(preflight.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/manual-evidence-worksheet-importer-preflight");
    assertThat(preflight.profile())
        .isEqualTo("java-shard-readiness-manual-evidence-worksheet-importer-preflight.v1");
  ...
  void buildsRouteProfileSummaryForWorksheetRoutes() {
    ...
    assertThat(summary.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/manual-evidence-worksheet-route-profile-summary");
    assertThat(summary.profile())
        .isEqualTo("java-shard-readiness-manual-evidence-worksheet-route-profile-summary.v1");
  ...
  void buildsArchivePlanWithoutWritingFiles() {
    ...
    assertThat(plan.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/manual-evidence-worksheet-archive-plan");
    assertThat(plan.profile())
        .isEqualTo("java-shard-readiness-manual-evidence-worksheet-archive-plan.v1");
    ...
    assertThat(plan.items())
        .extracting(OpsShardReadinessManualEvidenceWorksheetResponse.WorksheetItem::name)
        .containsExactly(
            "route-json-capture", "digest-record", "artifact-location", "no-file-write");
  ...
  void buildsOperatorHandoffWithSeparatedOwners() {
    ...
    assertThat(handoff.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/manual-evidence-worksheet-operator-handoff");
    assertThat(handoff.profile())
        .isEqualTo("java-shard-readiness-manual-evidence-worksheet-operator-handoff.v1");
  ...
  void buildsCiBudgetWithFullMavenGateLast() {
    ...
    assertThat(budget.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/manual-evidence-worksheet-ci-budget");
    assertThat(budget.profile())
        .isEqualTo("java-shard-readiness-manual-evidence-worksheet-ci-budget.v1");
  ...
  void buildsCloseoutForManualEvidenceWorksheetBatch() {
    ...
    assertThat(closeout.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/manual-evidence-worksheet-closeout");
    assertThat(closeout.profile())
        .isEqualTo("java-shard-readiness-manual-evidence-worksheet-closeout.v1");
