    ...
    void exposesStableSegmentBoundariesForSplitEvidenceCatalog() {
        ...
        assertThat(OpsShardReadinessRouteCleanupEvidenceAnalyzer.segments())
                .allSatisfy(segment -> {
                    ...
                    assertThat(segment.lastJavaVersion()).isGreaterThanOrEqualTo(segment.firstJavaVersion());
        ...
        assertThat(OpsShardReadinessRouteCleanupEvidenceAnalyzer.segments())
                .satisfies(segments -> {
                    ...
                    assertThat(segments.stream().mapToInt(
                            OpsShardReadinessRouteCleanupEvidenceAnalyzer.Segment::entryCount).sum())
