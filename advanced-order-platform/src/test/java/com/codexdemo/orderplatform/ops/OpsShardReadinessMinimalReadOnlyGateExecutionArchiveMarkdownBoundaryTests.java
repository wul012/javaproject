...
class OpsShardReadinessMinimalReadOnlyGateExecutionArchiveMarkdownBoundaryTests {
    ...
    void aggregateArchiveChecksRemainStableAndBoundaryFocused() {
        ...
        assertThat(response.artifactVerificationCount()).isEqualTo(response.passedArtifactVerificationCount());
        assertThat(response.readTargetVerificationCount()).isEqualTo(response.passedReadTargetVerificationCount());
        assertThat(response.gateCheckVerificationCount()).isEqualTo(response.passedGateCheckVerificationCount());
