...
class OpsShardReadinessRuntimeExecutionPacketContributionServiceTests {
    ...
    void buildsJavaSideRuntimeExecutionPacketContributionWithoutCrossProjectApproval() {
        ...
        assertThat(contribution.contributionScope()).isEqualTo("java-side-runtime-execution-packet-contribution");
        ...
        assertThat(contribution.serviceOwnerConfirmation()).isEqualTo("java-platform-operator-confirmed");
        ...
        assertThat(contribution.evidencePath())
                .isEqualTo("e/163/evidence/java-shard-readiness-runtime-execution-packet-contribution-v163.json");
