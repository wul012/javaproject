...
class OpsEvidenceServiceCredentialHandleApprovalContractEchoTests
  ...
  void releaseApprovalRehearsalAddsCredentialHandleApprovalContractEchoReceiptForNodeV318() {
    ...
    assertThat(receipt.sourceSignedHumanApprovalArtifactContractEchoReceiptDigest())
        .isEqualTo(
            rehearsal
                .managedAuditSandboxEndpointCredentialResolverSignedHumanApprovalArtifactContractEchoReceipt()
                .receiptDigest());
    assertThat(receipt.consumedByNodeCredentialHandleApprovalContractVersion())
        .isEqualTo("Node v317");
    ...
    assertThat(receipt.necessityProof().consumer())
        .isEqualTo("Java v146 + mini-kv v139, then Node v318");
    ...
    assertThat(receipt.readyForNodeV318CredentialHandleApprovalContractUpstreamEchoVerification())
        .isTrue();
