...
class OpsEvidenceServiceReleaseApprovalRehearsalAdapterGuardOverviewTests
  ...
  void buildsReleaseApprovalRehearsalAdapterGuardOverviewForDefaultRequest() {
    ...
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().receiptVersion())
        .isEqualTo("java-release-approval-rehearsal-ops-evidence-service-quality-split-receipt.v1");
    assertThat(
            rehearsal
    ...
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().receiptResponsibilityDocumented())
        .isTrue();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().digestResponsibilityDocumented())
        .isTrue();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().hintResponsibilityDocumented())
        .isTrue();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().renderResponsibilityDocumented())
        .isTrue();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().recordResponsibilityDocumented())
        .isTrue();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().firstSafeSplitApplied()).isFalse();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().broadServiceSplitDeferred())
        .isTrue();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().apiShapeChanged()).isFalse();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().approvalDecisionCreated())
        .isFalse();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().approvalLedgerWritten()).isFalse();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().approvalRecordPersisted())
        .isFalse();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().managedAuditStoreWritten())
        .isFalse();
    ...
    assertThat(
        ...
        .isFalse();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().readyForProductionAudit())
        .isFalse();
    assertThat(rehearsal.opsEvidenceServiceQualitySplitReceipt().readyForProductionWindow())
        .isFalse();
    assertThat(
            rehearsal.opsEvidenceServiceQualitySplitReceipt().nodeMayTreatAsProductionAuditRecord())
        .isFalse();
    ...
    assertThat(
            rehearsal
                .managedAuditAdapterImplementationGuardReceipt()
                .consumedByNodeDisabledShellEndpoint())
    ...
    assertThat(rehearsal.managedAuditAdapterImplementationGuardReceipt().nodeV221MayConsume())
        .isTrue();
    assertThat(
            rehearsal.managedAuditAdapterImplementationGuardReceipt().nodeV220DisabledShellReady())
        .isTrue();
    assertThat(
            rehearsal
                .managedAuditAdapterImplementationGuardReceipt()
    ...
    assertThat(
        ...
        .isFalse();
    assertThat(
            rehearsal.managedAuditAdapterImplementationGuardReceipt().javaApprovalDecisionCreated())
        .isFalse();
    assertThat(
            rehearsal.managedAuditAdapterImplementationGuardReceipt().javaApprovalLedgerWritten())
        .isFalse();
    assertThat(
            rehearsal.managedAuditAdapterImplementationGuardReceipt().javaApprovalRecordPersisted())
        .isFalse();
    assertThat(
            rehearsal
                .managedAuditAdapterImplementationGuardReceipt()
        ...
        .isFalse();
    assertThat(rehearsal.managedAuditAdapterImplementationGuardReceipt().javaSqlExecuted())
        .isFalse();
    assertThat(rehearsal.managedAuditAdapterImplementationGuardReceipt().javaDeploymentTriggered())
        .isFalse();
    assertThat(rehearsal.managedAuditAdapterImplementationGuardReceipt().javaRollbackTriggered())
        .isFalse();
    assertThat(rehearsal.managedAuditAdapterImplementationGuardReceipt().javaRestoreExecuted())
        .isFalse();
    assertThat(
            rehearsal
                .managedAuditAdapterImplementationGuardReceipt()
        ...
        .isFalse();
    assertThat(rehearsal.managedAuditAdapterImplementationGuardReceipt().readyForProductionAudit())
        .isFalse();
    assertThat(rehearsal.managedAuditAdapterImplementationGuardReceipt().readyForProductionWindow())
        .isFalse();
    assertThat(
            rehearsal
                .managedAuditAdapterImplementationGuardReceipt()
    ...
    assertThat(rehearsal.managedAuditAdapterImplementationGuardReceipt().guardDigest())
        .startsWith("sha256:");
    assertThat(
            rehearsal.managedAuditAdapterImplementationGuardReceipt().acceptedAdapterShellChecks())
        .contains(
    ...
    assertThat(
            rehearsal
                .managedAuditAdapterImplementationGuardReceipt()
                .forbiddenImplementationOperations())
        .contains(
    ...
    assertThat(rehearsal.managedAuditExternalAdapterMigrationGuardReceipt().nodeV223MayConsume())
        .isTrue();
    assertThat(
            rehearsal
                .managedAuditExternalAdapterMigrationGuardReceipt()
        ...
        .isTrue();
    assertThat(
            rehearsal.managedAuditExternalAdapterMigrationGuardReceipt().nodeV222ReadOnlyReport())
        .isTrue();
    assertThat(
            rehearsal
                .managedAuditExternalAdapterMigrationGuardReceipt()
    ...
    assertThat(
        ...
        .isTrue();
    assertThat(
            rehearsal.managedAuditExternalAdapterMigrationGuardReceipt().credentialReviewRequired())
        .isTrue();
    assertThat(
            rehearsal
                .managedAuditExternalAdapterMigrationGuardReceipt()
    ...
    assertThat(
            rehearsal
                ...
                .javaManagedAuditStoreWritten())
        .isFalse();
    assertThat(rehearsal.managedAuditExternalAdapterMigrationGuardReceipt().javaSqlExecuted())
        .isFalse();
    assertThat(
            rehearsal.managedAuditExternalAdapterMigrationGuardReceipt().javaDeploymentTriggered())
        .isFalse();
    ...
    assertThat(
        ...
        .isFalse();
    assertThat(
            rehearsal.managedAuditExternalAdapterMigrationGuardReceipt().readyForProductionAudit())
        .isFalse();
    assertThat(
            rehearsal.managedAuditExternalAdapterMigrationGuardReceipt().readyForProductionWindow())
        .isFalse();
    assertThat(
            rehearsal
                .managedAuditExternalAdapterMigrationGuardReceipt()
    ...
    assertThat(
            rehearsal.managedAuditExternalAdapterMigrationGuardReceipt().credentialBoundaryClaims())
        .contains(
    ...
    assertThat(
            rehearsal.managedAuditExternalAdapterMigrationGuardReceipt().nodeVerificationActions())
        .contains(
    ...
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
                .nextNodePackageVersion())
        .isEqualTo("Node v225");
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
                .nextNodePackageProfile())
        .isEqualTo("managed-audit-sandbox-adapter-dry-run-package.v1");
    assertThat(
            rehearsal.managedAuditSandboxAdapterApprovalSchemaGuardReceipt().nodeV225MayConsume())
        .isTrue();
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
                .nodeV224SandboxPlan()
                .readyForManagedAuditSandboxAdapterDryRunPlan())
        .isTrue();
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
                .nodeV224SandboxPlan()
                .readyForManagedAuditSandboxAdapterDryRunPackage())
        .isFalse();
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
    ...
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
                .schemaRehearsalBoundary()
                .schemaMigrationChecklistRequired())
        .isTrue();
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
    ...
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
                .qualityGateBoundary()
                .qualityGatesAreHardAcceptanceCriteria())
        .isTrue();
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
    ...
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
                .qualityGateBoundary()
                .receiptFieldsGroupedByBoundary())
        .isTrue();
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
                .qualityGateBoundary()
                .opsEvidenceServiceOnlyWiresReceipt())
        .isTrue();
    assertThat(
            rehearsal
                .managedAuditSandboxAdapterApprovalSchemaGuardReceipt()
