...
class OpsShardReadinessComparedEvidenceCandidateBlueprintSupportTests {
  ...
  void buildsReadOnlyCandidateBlueprintWithoutRealCandidateImport() {
    var response =
        OpsShardReadinessComparedEvidenceCandidateBlueprintSupport.response(
            "Java v1055",
            "/ops/shard-readiness/test",
            "test-profile",
            OpsShardReadinessComparedEvidenceCandidateBlueprintSourceSectionCatalog
                .sourceSections(),
    ...
    assertThat(response.checks())
        .contains(
            "unit-extra-check", "compared-evidence-candidate-blueprint-source-java-Java v1054");
  }
}
