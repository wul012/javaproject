...
class OpsShardReadinessComparedEvidenceCandidateBlueprintServiceTests {
  ...
  void exposesScopedCandidateBlueprintSlicesWithoutImports() {
    assertSlice(
        new OpsShardReadinessComparedEvidenceCandidateBlueprintSourceService().source(),
        "Java v1061",
        3);
    assertSlice(
        new OpsShardReadinessComparedEvidenceCandidateBlueprintComparisonService().comparison(),
        "Java v1062",
        3);
    assertSlice(
        new OpsShardReadinessComparedEvidenceCandidateBlueprintPolicyService().policy(),
        "Java v1063",
        2);
    assertSlice(
        new OpsShardReadinessComparedEvidenceCandidateBlueprintCloseoutService().closeout(),
        "Java v1064",
        2);
  }
