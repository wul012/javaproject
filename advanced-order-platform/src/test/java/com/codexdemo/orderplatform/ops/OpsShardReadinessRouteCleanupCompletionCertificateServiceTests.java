...
class OpsShardReadinessRouteCleanupCompletionCertificateServiceTests {
    ...
    void buildsReadOnlyCompletionCertificateFromCloseoutEvidence() {
        ...
        assertThat(OpsShardReadinessRouteCleanupEvidenceAnalyzer.latestJavaVersion()).isGreaterThanOrEqualTo(388);
        ...
        assertThat(certificate.certificateClaims())
                .extracting(OpsShardReadinessRouteCleanupCompletionCertificateResponse.CertificateClaim::name)
                .containsExactly(
                        "completion-index",
                        "third-run-closeout",
                        "final-archive-plan",
