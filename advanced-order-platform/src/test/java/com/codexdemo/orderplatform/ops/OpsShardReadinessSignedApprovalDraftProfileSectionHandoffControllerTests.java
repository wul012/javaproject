...
class OpsShardReadinessSignedApprovalDraftProfileSectionHandoffControllerTests {
    ...
    void handoffRouteExposesReadOnlySignedApprovalDraftProfileSectionHandoff() {
        ...
        var response = new OpsShardReadinessSignedApprovalDraftProfileSectionHandoffController(
                OpsShardReadinessSignedApprovalDraftProfileSectionHandoffTestSupport.service()).handoff();
