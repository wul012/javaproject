...
class ManifestCatalogTests {
  ...
  void sourceReceiptRetainsNodeV245ToV246ContractWithoutProductionUse() {
    ...
    assertThat(source.receiptVersion())
        .isEqualTo(
    ...
    assertThat(source.nextNodeProfile())
        .isEqualTo(
    ...
    assertThat(source.warnings())
        .contains("NODE_V246_SOURCE_DRY_RUN_COMMAND_PACKAGE_ECHO_RECEIPT_NOT_READY");
