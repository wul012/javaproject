...
class OpsShardReadinessOperatorEvidenceValueSupplyFoundationServiceTests {
  ...
  void buildsValueSupplyCatalogWithTwentyFiveDisabledEnvelopeSlots() {
    ...
    assertThat(catalog.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/operator-evidence-value-supply-catalog");
    assertThat(catalog.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-supply-catalog.v1");
    ...
    assertThat(catalog.slots())
        ...
        .startsWith("VALUE_SUPPLY_01_ENVELOPE_ID", "VALUE_SUPPLY_02_OPERATOR_REFERENCE")
  ...
  void buildsEnvelopeTemplateWithMetadataOnlyFoundationSlots() {
    ...
    assertThat(template.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/operator-evidence-value-supply-envelope-template");
    assertThat(template.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-supply-envelope-template.v1");
  ...
  void buildsRedactionPolicyThatBlocksSecretCarryingFields() {
    ...
    assertThat(policy.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/operator-evidence-value-supply-redaction-policy");
    assertThat(policy.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-supply-redaction-policy.v1");
  ...
  void buildsMissingValuePolicyThatDoesNotDefaultBlankOrManualValues() {
    ...
    assertThat(policy.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-supply-missing-value-policy.v1");
  ...
  void buildsProvenanceRequirementForSourceEvidenceReferences() {
    OpsShardReadinessOperatorEvidenceValueSupplyResponse requirement =
        new OpsShardReadinessOperatorEvidenceValueSupplyProvenanceRequirementService()
            .requirement();

    assertThat(requirement.version()).isEqualTo("Java v644");
    assertThat(requirement.endpoint())
        .isEqualTo(
            "/api/v1/ops/shard-readiness/operator-evidence-value-supply-provenance-requirement");
    assertThat(requirement.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-supply-provenance-requirement.v1");
  ...
  void buildsSourceEvidenceGuardForFreshSiblingAndFallbackReferences() {
    ...
    assertThat(guard.profile())
        .isEqualTo("java-shard-readiness-operator-evidence-value-supply-source-evidence-guard.v1");
