...
class OpsShardReadinessRouteCleanupMaintenanceHandoffPairAuditServiceTests {
  ...
  void auditsHandoffSuiteServiceRoutePairsAndDocumentedRouteOnlyExceptions() {
    ...
    assertThat(audit.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/route-cleanup-maintenance-handoff-pair-audit");
    assertThat(audit.profile())
        .isEqualTo("java-shard-readiness-route-cleanup-maintenance-handoff-pair-audit.v1");
    ...
    assertThat(audit.documentedRouteOnlyEntries())
        .containsExactly(
            "handoff-suite-closeout-route", "handoff-suite-completion-certificate-route");
