...
class OpsShardReadinessRouteCleanupMaintenanceVersionLineageServiceTests {
    ...
    void buildsVersionLineageSummaryForServiceRoutePairs() {
        ...
        assertThat(lineage.endpoint()).isEqualTo(
                "/api/v1/ops/shard-readiness/route-cleanup-maintenance-version-lineage");
        assertThat(lineage.profile()).isEqualTo(
                "java-shard-readiness-route-cleanup-maintenance-version-lineage.v1");
