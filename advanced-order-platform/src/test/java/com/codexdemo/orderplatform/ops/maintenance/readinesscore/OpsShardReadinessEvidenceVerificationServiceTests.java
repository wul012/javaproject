...
class OpsShardReadinessEvidenceVerificationServiceTests {
  ...
  void verifiesFrozenShardReadinessEvidenceIndex() {
    ...
    assertThat(verification.verifiedEvidenceVersions()).containsExactly("Java v153", "Java v154");
    ...
    assertThat(verification.checks()).allSatisfy(check -> assertThat(check.passed()).isTrue());
