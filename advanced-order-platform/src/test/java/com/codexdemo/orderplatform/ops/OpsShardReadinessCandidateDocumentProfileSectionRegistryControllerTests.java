...
class OpsShardReadinessCandidateDocumentProfileSectionRegistryControllerTests {
    ...
    void registryRouteExposesReadOnlyProfileSectionRegistry() {
        ...
        var response = new OpsShardReadinessCandidateDocumentProfileSectionRegistryController(
                OpsShardReadinessCandidateDocumentProfileSectionRegistryTestSupport.service()).registry();
