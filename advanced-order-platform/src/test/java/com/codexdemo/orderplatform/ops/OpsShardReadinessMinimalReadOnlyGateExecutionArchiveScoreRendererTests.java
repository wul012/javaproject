...
class OpsShardReadinessMinimalReadOnlyGateExecutionArchiveScoreRendererTests {
    ...
    void verifiesCiHandoffAndScorecardCounts() {
        ...
        assertThat(response.ciBatchVerificationCount()).isEqualTo(
                OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistrySupport
                        .EXPECTED_CI_BATCH_VERIFICATION_COUNT);
        assertThat(response.passedCiBatchVerificationCount()).isEqualTo(response.ciBatchVerificationCount());
        assertThat(response.operatorHandoffVerificationCount()).isEqualTo(
                OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistrySupport
        ...
        assertThat(response.scorecardEntryCount()).isEqualTo(
                OpsShardReadinessMinimalReadOnlyGateExecutionArchiveVerificationRegistrySupport
