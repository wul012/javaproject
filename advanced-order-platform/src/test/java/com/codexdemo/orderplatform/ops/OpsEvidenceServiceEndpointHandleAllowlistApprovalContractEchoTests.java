...
class OpsEvidenceServiceEndpointHandleAllowlistApprovalContractEchoTests
  ...
  void releaseApprovalRehearsalAddsEndpointHandleAllowlistApprovalContractEchoReceiptForNodeV321() {
    ...
    assertThat(receipt.sourceCredentialHandleApprovalContractEchoReceiptDigest())
        .isEqualTo(
            rehearsal
                .managedAuditSandboxEndpointCredentialResolverCredentialHandleApprovalContractEchoReceipt()
                .receiptDigest());
    assertThat(receipt.consumedByNodeEndpointHandleAllowlistApprovalContractVersion())
        .isEqualTo("Node v320");
    ...
    assertThat(
            receipt
                .nextNodeEndpointHandleAllowlistApprovalContractUpstreamEchoVerificationVersion())
        .isEqualTo("Node v321");
    ...
    assertThat(receipt.necessityProof().consumer())
        .isEqualTo("Java v147 + mini-kv v140, then Node v321");
    ...
    assertThat(
        ...
        .isTrue();
    assertThat(receipt.sideEffectBoundary().endpointHandleAllowlistApprovalContractEchoOnly())
        .isTrue();
    assertThat(receipt.sideEffectBoundary().readOnlyEndpointHandleAllowlistApprovalContract())
        .isTrue();
