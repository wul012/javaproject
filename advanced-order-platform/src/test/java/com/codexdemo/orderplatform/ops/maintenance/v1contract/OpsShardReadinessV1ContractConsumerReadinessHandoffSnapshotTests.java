  ...
  void freezesV225ConsumerReadinessHandoffSnapshot() {
    ...
    assertThat(handoff.handoffGuardEvidence())
        .containsExactlyElementsOf(
            OpsShardReadinessV1ContractConsumerReadinessHandoffSnapshot.v225HandoffGuardEvidence());
    assertThat(handoff.handoffChecks())
        .containsExactlyElementsOf(
            OpsShardReadinessV1ContractConsumerReadinessHandoffSnapshot.v225HandoffChecks(digest));
