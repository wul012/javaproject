...
class OpsEvidenceServiceReleaseApprovalRehearsalOverviewTests
  ...
  void buildsReleaseApprovalRehearsalOverviewForDefaultRequest() {
    ...
    assertThat(rehearsal.requestContext().requestId())
        .isEqualTo("rehearsal-request-id-not-supplied");
    assertThat(rehearsal.requestContext().requestIdSource()).isEqualTo("NOT_SUPPLIED");
    assertThat(rehearsal.requestContext().operatorIdentity())
        .isEqualTo("operator-identity-not-supplied");
    assertThat(rehearsal.requestContext().operatorIdentitySource()).isEqualTo("NOT_SUPPLIED");
    assertThat(rehearsal.requestContext().auditCorrelationId())
        .isEqualTo("audit-correlation-id-not-supplied");
    ...
    assertThat(rehearsal.requestContext().acceptedReadOnlyHeaders())
        .containsExactly("X-Rehearsal-Request-Id", "X-Operator-Identity", "X-Audit-Correlation-Id");
    ...
    assertThat(rehearsal.operatorWindowHint().operatorId())
        .isEqualTo("orderops-operator-id-not-supplied");
    assertThat(rehearsal.operatorWindowHint().operatorIdSource()).isEqualTo("NOT_SUPPLIED");
    assertThat(rehearsal.operatorWindowHint().operatorRoles())
        .isEqualTo("orderops-roles-not-supplied");
    ...
    assertThat(rehearsal.operatorWindowHint().operatorVerifiedClaimSource())
    ...
    assertThat(rehearsal.operatorWindowHint().approvalCorrelationIdSource())
        .isEqualTo("NOT_SUPPLIED");
    ...
    assertThat(rehearsal.ciEvidenceHint().manifestDigest())
        .isEqualTo("ci-manifest-digest-not-supplied");
    assertThat(rehearsal.ciEvidenceHint().manifestDigestSource()).isEqualTo("NOT_SUPPLIED");
    assertThat(rehearsal.ciEvidenceHint().manifestEndpoint())
        .isEqualTo("ci-manifest-endpoint-not-supplied");
    ...
    assertThat(rehearsal.artifactRetentionHint().ciUploadContractVersionSource())
        .isEqualTo("NOT_SUPPLIED");
    assertThat(rehearsal.artifactRetentionHint().ciUploadContractDigest())
        .isEqualTo("ci-upload-contract-digest-not-supplied");
    assertThat(rehearsal.artifactRetentionHint().ciUploadContractDigestSource())
        .isEqualTo("NOT_SUPPLIED");
    ...
    assertThat(rehearsal.liveReadinessHint().sourcePreflightVersionSource())
        .isEqualTo("NOT_SUPPLIED");
    assertThat(rehearsal.liveReadinessHint().sourcePreflightDigest())
        .isEqualTo("runtime-preflight-digest-not-supplied");
    assertThat(rehearsal.liveReadinessHint().sourcePreflightDigestSource())
        .isEqualTo("NOT_SUPPLIED");
    ...
    assertThat(rehearsal.liveReadinessHint().allowedReadTargets())
        .containsExactly("GET /actuator/health", "GET /api/v1/ops/release-approval-rehearsal");
