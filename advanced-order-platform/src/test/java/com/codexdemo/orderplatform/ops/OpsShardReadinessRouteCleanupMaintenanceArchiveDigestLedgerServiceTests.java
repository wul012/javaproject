...
class OpsShardReadinessRouteCleanupMaintenanceArchiveDigestLedgerServiceTests {
    ...
    void buildsStableArchiveDigestLedgerFromUpkeepCatalogFields() {
        ...
        assertThat(ledger.endpoint()).isEqualTo(
                "/api/v1/ops/shard-readiness/route-cleanup-maintenance-archive-digest-ledger");
        ...
        assertThat(ledger.entries())
                .extracting(OpsShardReadinessRouteCleanupMaintenanceArchiveDigestLedgerResponse
                        .LedgerEntry::digest)
