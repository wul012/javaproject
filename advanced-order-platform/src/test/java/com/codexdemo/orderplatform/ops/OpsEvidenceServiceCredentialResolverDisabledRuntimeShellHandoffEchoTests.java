...
class OpsEvidenceServiceCredentialResolverDisabledRuntimeShellHandoffEchoTests
  ...
  void releaseApprovalRehearsalAddsReadOnlyDisabledRuntimeShellHandoffEchoReceiptForNodeV296() {
    ...
    assertThat(
            receipt
                .consumedByNodeCredentialResolverDisabledRuntimeShellDesignReviewMarkdownEndpoint())
    ...
    assertThat(
            receipt.nextNodeCredentialResolverDisabledRuntimeShellUpstreamEchoVerificationVersion())
        .isEqualTo("Node v296");
    assertThat(
            receipt.nextNodeCredentialResolverDisabledRuntimeShellUpstreamEchoVerificationProfile())
        .isEqualTo(
            "managed-audit-manual-sandbox-connection-credential-resolver-disabled-runtime-shell-upstream-echo-verification.v1");
    assertThat(
            receipt.nextNodeCredentialResolverDisabledRuntimeShellUpstreamEchoVerificationState())
    ...
    assertThat(
            receipt.designReviewEcho().recommendsParallelUpstreamEchoBeforeRuntimeImplementation())
        .isTrue();
    ...
    assertThat(receipt.checks().readyForNodeV296DisabledRuntimeShellUpstreamEchoVerification())
        .isTrue();
