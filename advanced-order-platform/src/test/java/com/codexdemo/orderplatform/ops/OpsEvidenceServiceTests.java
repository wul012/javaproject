...
class OpsEvidenceServiceTests {
    ...
    @Test
    void releaseApprovalRehearsalAddsSandboxEndpointCredentialResolverApprovalRequiredImplementationReadinessEchoReceipt() {
        OpsEvidenceService service = readOnlyFixtureService();
        ...
        assertThat(receipt.sourceNodeApprovalRequiredBoundaryUpstreamEchoVerificationProfile())
                .isEqualTo(
        ...
        assertThat(receipt.sourceNodeV281().reviewState())
                .isEqualTo("credential-resolver-approval-required-implementation-readiness-review-ready");
        ...
        assertThat(receipt.sourceNodeV281().connectsManagedAudit()).isFalse();
        assertThat(receipt.sourceNodeV281().credentialValueRead()).isFalse();
        assertThat(receipt.sourceNodeV281().approvalLedgerWritten()).isFalse();
        ...
        assertThat(receipt.sourceNodeV281().summary().warningCount()).isEqualTo(2);
        assertThat(receipt.sourceNodeV281().summary().recommendationCount()).isEqualTo(2);

        assertThat(receipt.sourceNodeV275().sourceVersion()).isEqualTo("Node v275");
        ...
        assertThat(receipt.sourceNodeV275().approvalRequiredBoundaryCount()).isEqualTo(6);
        ...
        assertThat(receipt.sourceNodeV275().approvalRequiredBoundaryScopeAligned()).isTrue();
        assertThat(receipt.sourceNodeV275().prohibitedRuntimeActionsAligned()).isTrue();
        assertThat(receipt.sourceNodeV275().realResolverImplementationAllowed()).isFalse();
        assertThat(receipt.sourceNodeV275().executionAllowed()).isFalse();
        assertThat(receipt.sourceNodeV275().credentialValueRead()).isFalse();
        assertThat(receipt.sourceNodeV275().rawEndpointUrlParsed()).isFalse();
        assertThat(receipt.sourceNodeV275().connectsManagedAudit()).isFalse();
        assertThat(receipt.sourceNodeV275().approvalLedgerWritten()).isFalse();
        assertThat(receipt.sourceNodeV275().automaticUpstreamStart()).isFalse();

        assertThat(receipt.readinessReview().reviewMode())
                .isEqualTo("node-v281-approval-required-implementation-readiness-review-only");
        assertThat(receipt.readinessReview().readinessStage()).isEqualTo("pre-implementation-echo-ready");
        ...
        assertThat(receipt.boundaryReadiness()).hasSize(6);
        ...
        assertThat(receipt.checks().allBoundariesEchoReadyForMiniKvV122()).isTrue();
        assertThat(receipt.checks().allBoundariesStillBlockedForRuntimeImplementation()).isTrue();
        assertThat(receipt.checks()
                .readyForManagedAuditManualSandboxConnectionCredentialResolverApprovalRequiredImplementationReadinessReview())
                .isTrue();

        assertThat(receipt.sideEffectBoundary().implementationReadinessReviewOnly()).isTrue();
        assertThat(receipt.sideEffectBoundary().readyForManagedAuditResolverImplementation()).isFalse();
        assertThat(receipt.sideEffectBoundary().executionAllowed()).isFalse();
        assertThat(receipt.sideEffectBoundary().credentialValueRead()).isFalse();
        assertThat(receipt.sideEffectBoundary().rawEndpointUrlParsed()).isFalse();
        assertThat(receipt.sideEffectBoundary().externalRequestSent()).isFalse();
