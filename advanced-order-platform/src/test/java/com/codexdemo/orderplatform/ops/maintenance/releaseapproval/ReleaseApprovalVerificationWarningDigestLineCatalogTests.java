...
class ReleaseApprovalVerificationWarningDigestLineCatalogTests
  ...
  void collectsWarningAndBoundaryLinesInExpectedEchoOrder() {
    ...
    List<String> warningLines =
        ReleaseApprovalVerificationWarningDigestLineCatalog.warningLines(builders, receipts);
    List<String> boundaryLines =
        ReleaseApprovalVerificationWarningDigestLineCatalog.boundaryLines(builders, receipts);
    ...
    assertThat(boundaryLines.getFirst()).startsWith("sandboxAdapterApprovalSchemaGuardDigest=");
    ...
    assertThat(boundaryLines.getLast())
        .isEqualTo(
            "sandboxEndpointCredentialResolverAbortRollbackSemanticsContractAutomaticUpstreamStart=false");
  }
  ...
  private static ReleaseApprovalVerificationWarningDigestLineCatalog.Builders builders() {
    return new ReleaseApprovalVerificationWarningDigestLineCatalog.Builders(
        ...
        new EndpointPreflightBuilder(),
        new DecisionMarkerBuilder(),
        new DisabledPrecheckBuilder(),
