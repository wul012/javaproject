...
class OpsShardReadinessRouteCleanupFinalDigestServiceTests {
    ...
    void buildsFinalDigestForConsumerHandoffSources() {
        ...
        assertThat(OpsShardReadinessRouteCleanupEvidenceAnalyzer.latestJavaVersion()).isGreaterThanOrEqualTo(362);
        ...
        assertThat(digest.digestProfile()).isEqualTo("java-shard-readiness-route-cleanup-final-digest.v1");
