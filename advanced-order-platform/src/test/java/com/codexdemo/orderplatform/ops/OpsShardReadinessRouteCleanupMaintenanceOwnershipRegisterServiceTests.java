...
class OpsShardReadinessRouteCleanupMaintenanceOwnershipRegisterServiceTests {
    ...
    void buildsOwnershipRegisterFromUpkeepCatalogConsumers() {
        ...
        assertThat(register.endpoint()).isEqualTo(
                "/api/v1/ops/shard-readiness/route-cleanup-maintenance-ownership-register");
        assertThat(register.profile()).isEqualTo(
        ...
        assertThat(register.owners()).allSatisfy(owner -> {
