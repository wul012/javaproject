...
class OpsShardReadinessCandidateDocumentMaterialSubmissionPrecheckServiceTests {
  ...
  void buildsReadOnlySubmissionPrecheckFromMaterialRequest() {
    ...
    assertThat(response.sourceMaterialRequestEndpoint())
        .endsWith("candidate-document-material-request");
    ...
    assertThat(response.validators())
        .allSatisfy(
            validator -> {
              ...
              assertThat(validator.rejectionCode())
                  .startsWith("reject-material-submission-precheck-");
