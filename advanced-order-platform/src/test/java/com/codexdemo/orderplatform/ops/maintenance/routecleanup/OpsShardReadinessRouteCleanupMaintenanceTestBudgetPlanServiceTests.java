...
class OpsShardReadinessRouteCleanupMaintenanceTestBudgetPlanServiceTests {
  ...
  void buildsReadOnlyMaintenanceTestBudgetPlan() {
    ...
    assertThat(plan.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/route-cleanup-maintenance-test-budget-plan");
    assertThat(plan.profile())
        .isEqualTo("java-shard-readiness-route-cleanup-maintenance-test-budget-plan.v1");
