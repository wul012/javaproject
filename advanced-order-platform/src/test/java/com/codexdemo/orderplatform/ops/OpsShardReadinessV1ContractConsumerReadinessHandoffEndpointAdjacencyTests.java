...
class OpsShardReadinessV1ContractConsumerReadinessHandoffEndpointAdjacencyTests {
    ...
    void keepsReadinessHandoffAdjacentAfterEvidenceDigestInV1ConsumerPairs() {
        ...
        assertThat(liveEndpoints.indexOf(OpsShardReadinessV1ContractConsumerReadinessHandoffService.ENDPOINT))
                .isEqualTo(liveEndpoints.indexOf(OpsShardReadinessV1ContractConsumerEvidenceDigestService.ENDPOINT) + 1);
        assertThat(fixtureEndpoints.indexOf(OpsShardReadinessV1ContractConsumerReadinessHandoffService.FIXTURE_ENDPOINT))
                .isEqualTo(
