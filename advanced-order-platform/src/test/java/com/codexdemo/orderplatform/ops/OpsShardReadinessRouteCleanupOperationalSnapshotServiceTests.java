...
class OpsShardReadinessRouteCleanupOperationalSnapshotServiceTests {
    ...
    void buildsReadOnlyOperationalSnapshotWithoutRuntimeExecution() {
        ...
        assertThat(OpsShardReadinessRouteCleanupEvidenceAnalyzer.latestJavaVersion()).isGreaterThanOrEqualTo(372);
        ...
        assertThat(snapshot.latestVersion()).isEqualTo(OpsShardReadinessRouteCleanupEvidenceAnalyzer.latestJavaVersion());
