...
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCaptureArtifactPreflightSupportTests {
    ...
    void buildsArtifactPreflightResponseWithoutMaterializingArtifactOrGrant() {
        var response = OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCaptureArtifactPreflightSupport
                .response(
                        "Java v735",
                        "/ops/shard-readiness/artifact-sample",
                        "sample.artifact-preflight.v1",
                        List.of(OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalCaptureArtifactPreflightSupport
                                .fragment(
                                        "FRAGMENT_01",
