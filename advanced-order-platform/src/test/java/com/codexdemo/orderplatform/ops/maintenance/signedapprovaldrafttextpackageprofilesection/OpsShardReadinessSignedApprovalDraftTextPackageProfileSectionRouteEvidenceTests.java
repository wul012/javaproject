...
class OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRouteEvidenceTests {
  ...
  void endpointProfileAndRegistryStateMatchPublishedRoute() {
    ...
    assertThat(response.endpoint())
        .isEqualTo(
            OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryService.ENDPOINT);
    assertThat(response.profile())
        .isEqualTo(
            OpsShardReadinessSignedApprovalDraftTextPackageProfileSectionRegistryService.PROFILE);
