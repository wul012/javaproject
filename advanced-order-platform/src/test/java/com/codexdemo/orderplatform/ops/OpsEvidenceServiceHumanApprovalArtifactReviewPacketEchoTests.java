...
class OpsEvidenceServiceHumanApprovalArtifactReviewPacketEchoTests
  ...
  void releaseApprovalRehearsalAddsHumanApprovalArtifactReviewPacketEchoReceiptForNodeV309() {
    ...
    assertThat(receipt.necessityProof().whyV307CannotBeReused()).contains("missing-field checks");
    ...
    assertThat(receipt.readyForNodeV309HumanApprovalArtifactReviewPacketUpstreamEchoVerification())
        .isTrue();
