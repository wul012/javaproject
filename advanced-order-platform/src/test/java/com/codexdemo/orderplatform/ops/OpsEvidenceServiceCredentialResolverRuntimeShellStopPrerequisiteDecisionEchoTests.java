...
class OpsEvidenceServiceCredentialResolverRuntimeShellStopPrerequisiteDecisionEchoTests
  ...
  void releaseApprovalRehearsalAddsRuntimeShellStopPrerequisiteDecisionEchoReceiptForNodeV305() {
    ...
    assertThat(
            receipt.consumedByNodeRuntimeShellChainStopPrerequisiteDecisionRecordMarkdownEndpoint())
    ...
    assertThat(
            receipt
                .sourcePostDecisionPlanIntakeEcho()
                .readyForNodeV302PostDecisionPlanIntakeUpstreamEchoVerification())
        .isTrue();
    ...
    assertThat(
            receipt.sourcePostDecisionPlanIntakeEcho().rejectedRuntimeImplementationOptionCount())
        .isEqualTo(1);
    ...
    assertThat(receipt.checks().readyForNodeV305StopPrerequisiteUpstreamEchoVerification())
        .isTrue();
    ...
    assertThat(receipt.nodeRecommendationCodes())
        .containsExactly("RUN_JAVA_V141_AND_MINIKV_V134_IN_PARALLEL", "KEEP_RUNTIME_SHELL_BLOCKED");
