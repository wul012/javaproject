...
class OpsShardReadinessRouteCleanupMaintenanceSourcePlanAlignmentServiceTests {
    ...
    void snapshotsMaintenanceAlignmentToNodeV549SourcePlan() {
        ...
        assertThat(alignment.endpoint()).isEqualTo(
                "/api/v1/ops/shard-readiness/route-cleanup-maintenance-source-plan-alignment");
        assertThat(alignment.profile()).isEqualTo(
