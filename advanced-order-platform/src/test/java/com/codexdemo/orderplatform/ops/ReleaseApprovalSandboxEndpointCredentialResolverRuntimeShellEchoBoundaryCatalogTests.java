...
class ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellEchoBoundaryCatalogTests
    ...
    void centralizesRuntimeShellDecisionRecordBoundaryNamesAndLines() {
        ...
        List<String> inputNames = ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellEchoBoundaryCatalog
                .decisionRecordWarningDigestBoundaryInputNames();
        List<String> boundaryLines = ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellEchoBoundaryCatalog
        ...
        assertThat(boundaryLines.getLast())
                .isEqualTo("sandboxEndpointCredentialResolverRuntimeShellDecisionRecordAutomaticUpstreamStart=false");
    }
    ...
    private static void assertRuntimeShellBoundaryClosed(
            com.codexdemo.orderplatform.ops.ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellDecisionRecordEchoRecords
    ...
    private static void assertRuntimeShellBoundaryClosed(
            com.codexdemo.orderplatform.ops.ReleaseApprovalSandboxEndpointCredentialResolverRuntimeShellPostDecisionPlanIntakeEchoRecords
