...
class OpsShardReadinessCandidateDocumentProfileSectionCatalogTests {
    ...
    void sectionsUseStableHeadingsAndRendererOwner() {
        ...
        assertThat(response.sections())
                .extracting(OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.ProfileSection::heading)
                .containsExactly(
        ...
        assertThat(response.sections())
                .extracting(OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.ProfileSection::fieldEntryCount)
                .containsOnly(5);
        assertThat(response.sections())
                .extracting(OpsShardReadinessCandidateDocumentProfileSectionRegistryResponse.ProfileSection::rendererOwner)
