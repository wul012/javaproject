...
class OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessGateCatalogTests {
    ...
    void listsDraftGatesWithManualDraftAndMaterializationLocked() {
        var gates = OpsShardReadinessOperatorEvidenceValueSupplySignedApprovalArtifactDraftReadinessGateCatalog
                .allGates();
        ...
        assertThat(gates).anySatisfy(gate -> assertThat(gate.code()).contains("NO_MANUAL_ARTIFACT_DRAFT"));
