...
class OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightSlotCatalogTests {
    ...
    void catalogsTwentyFiveAdapterPreflightSlotsMappedToSupplySlots() {
        ...
        assertThat(OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightSlotCatalog.allSlots())
                .extracting(OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightResponse.AdapterSlot::sourceSupplySlot)
                .startsWith("VALUE_SUPPLY_01_ENVELOPE_ID")
                .endsWith("VALUE_SUPPLY_25_CLOSEOUT_LOCKS_HELD");
        assertThat(OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightSlotCatalog.allSlots())
                .extracting(OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightResponse.AdapterSlot::sourceEndpoint)
                .allMatch(endpoint -> endpoint.startsWith(OpsShardReadinessRoutePaths.BASE_PATH));
    }

    @Test
    void returnsStageSlicesForFocusedServices() {
        assertThat(OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightSlotCatalog.slots(12, 16))
                .extracting(OpsShardReadinessOperatorEvidenceValueSupplyAdapterPreflightResponse.AdapterSlot::adapterStage)
