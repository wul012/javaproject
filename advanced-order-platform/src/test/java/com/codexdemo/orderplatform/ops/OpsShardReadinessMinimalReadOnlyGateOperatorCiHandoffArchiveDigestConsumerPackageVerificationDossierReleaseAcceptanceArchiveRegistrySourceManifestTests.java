...
class OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistrySourceManifestTests {
    ...
    void buildsArchiveRegistryFromReleaseAcceptanceRegistry() {
        ...
        assertThat(response.sourceReleaseAcceptanceEndpoint()).isEqualTo(
        ...
        assertThat(response.archiveRegistryState())
                .isEqualTo("minimal-read-only-gate-operator-ci-handoff-archive-digest-consumer-package-verification-dossier-release-acceptance-archive-registry-ready");
    ...
    void carriesSourceSnapshotAndArtifactManifest() {
        ...
        assertThat(response.sourceArchiveSnapshots())
                .extracting(OpsShardReadinessMinimalReadOnlyGateOperatorCiHandoffArchiveDigestConsumerPackageVerificationDossierReleaseAcceptanceArchiveRegistryResponse
                        .SourceArchiveSnapshot::releaseAcceptanceVersion)
