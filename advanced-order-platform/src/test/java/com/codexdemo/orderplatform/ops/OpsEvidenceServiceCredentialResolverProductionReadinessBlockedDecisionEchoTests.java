...
class OpsEvidenceServiceCredentialResolverProductionReadinessBlockedDecisionEchoTests
  ...
  void
    ...
    assertThat(receipt.consumedByNodeCredentialResolverProductionReadinessDecisionGateState())
        .isEqualTo("blocked");
    assertThat(
            receipt.sourceNodeCredentialResolverFakeShellArchiveUpstreamEchoVerificationVersion())
        .isEqualTo("Node v267");
    ...
    assertThat(receipt.sourceNodeV268().readyForCredentialResolverPreImplementationPlan())
        .isFalse();
    ...
    assertThat(receipt.productionReadinessDecision().allowsRealResolverPreImplementationPlan())
        .isFalse();
    assertThat(receipt.productionReadinessDecision().allowsRealCredentialResolverImplementation())
        .isFalse();
    ...
    assertThat(receipt.productionReadinessDecision().nextPlanRequiredBeforeImplementation())
        .isTrue();
    ...
    assertThat(receipt.sideEffectBoundary().readyForCredentialResolverPreImplementationPlan())
        .isFalse();
    ...
    assertThat(receipt.productionBlockerCodes())
        .containsExactlyElementsOf(receipt.missingRequirementCodes());
