...
class OpsEvidenceServiceApprovalRequiredImplementationReadinessEchoTests
  ...
  void releaseApprovalRehearsalAddsApprovalRequiredImplementationReadinessEchoReceipt() {
    ...
    assertThat(
            receipt
                .consumedByNodeCredentialResolverApprovalRequiredImplementationReadinessReviewVersion())
        .isEqualTo("Node v281");
    assertThat(
            receipt
                .consumedByNodeCredentialResolverApprovalRequiredImplementationReadinessReviewProfile())
        .isEqualTo(
            "managed-audit-manual-sandbox-connection-credential-resolver-approval-required-implementation-readiness-review.v1");
    assertThat(
            receipt
                .consumedByNodeCredentialResolverApprovalRequiredImplementationReadinessReviewEndpoint())
        .isEqualTo(
    ...
    assertThat(
            receipt
                .consumedByNodeCredentialResolverApprovalRequiredImplementationReadinessReviewState())
        .isEqualTo("credential-resolver-approval-required-implementation-readiness-review-ready");
    assertThat(receipt.sourceNodeApprovalRequiredBoundaryUpstreamEchoVerificationVersion())
        .isEqualTo("Node v275");
    ...
    assertThat(receipt.sourceNodeV275().sourceSpan())
        .isEqualTo("Node v274 + Java v115 + mini-kv v121");
    ...
    assertThat(receipt.readinessReview().allApprovalRequiredBoundariesImplementationBlocked())
        .isTrue();
    ...
    assertThat(receipt.boundaryReadiness())
        .allMatch(
            boundary ->
                boundary.readinessState().equals("echo-ready-implementation-blocked")
                    && boundary
                        .implementationDisposition()
                        .equals("requires-explicit-follow-up-artifacts")
    ...
    assertThat(receipt.requiredArtifactIds())
        .hasSize(18)
        .contains(
  ...
  void releaseApprovalRehearsalAddsImplementationPlanEchoReceiptForNodeV284() {
    ...
    assertThat(receipt.implementationPlanReview().nextMiniKvReceiptVersion())
        .isEqualTo("mini-kv v126");
    assertThat(receipt.implementationPlanReview().nextNodeVerificationVersion())
        .isEqualTo("Node v284");
    assertThat(receipt.implementationPlanReview().fakeHarnessDeferredUntil())
        .isEqualTo("Node v285");
    assertThat(receipt.implementationPlanReview().readyForJavaV121MiniKvV126Echo()).isTrue();

    assertThat(receipt.interfaceBoundaries())
        .extracting(
            RehearsalSandboxEndpointCredentialResolverImplementationInterfaceBoundaryEcho::code)
        .containsExactly(
    ...
    assertThat(receipt.interfaceBoundaries())
        .allMatch(
            boundary ->
                boundary.status().equals("drafted-for-upstream-echo")
                    && boundary.requiredArtifacts().size() == 3
    ...
    assertThat(receipt.prohibitedActions())
        .hasSize(21)
        .contains(
    ...
    assertThat(receipt.echoWorkflowReadySteps())
        .containsExactly(
            ...
            "noAutoStartBoundaryEchoed");
    assertThat(receipt.echoWorkflowMissingSteps()).isEmpty();
    assertThat(receipt.readyForNodeV284CredentialResolverImplementationPlanEchoVerification())
        .isTrue();
    ...
    assertThat(receipt.nodeRecommendationCodes())
        .containsExactly(
            "RUN_PARALLEL_JAVA_V121_MINIKV_V126", "VERIFY_WITH_NODE_V284_BEFORE_FAKE_HARNESS");
