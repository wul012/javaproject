...
class OpsEvidenceServiceCredentialResolverDisabledRuntimeShellCandidateGateEchoTests
  ...
  void releaseApprovalRehearsalAddsRuntimeShellCandidateGateEchoReceiptForNodeV298() {
    ...
    assertThat(
            receipt
                .consumedByNodeCredentialResolverDisabledRuntimeShellImplementationCandidateGateVersion())
        .isEqualTo("Node v297");
    assertThat(
            receipt
                .consumedByNodeCredentialResolverDisabledRuntimeShellImplementationCandidateGateProfile())
        .isEqualTo(
    ...
    assertThat(
            receipt
                .nextNodeCredentialResolverRuntimeShellCandidateGateUpstreamEchoVerificationVersion())
        .isEqualTo("Node v298");
    assertThat(
            receipt
                .nextNodeCredentialResolverRuntimeShellCandidateGateUpstreamEchoVerificationProfile())
        .isEqualTo(
    ...
    assertThat(receipt.sourceHandoffEcho().sourceReadyForDisabledRuntimeShellImplementation())
        .isFalse();
    ...
    assertThat(receipt.readyForNodeV298RuntimeShellCandidateGateUpstreamEchoVerification())
        .isTrue();
    ...
    assertThat(receipt.nodeWarningCodes())
        .containsExactly(
            "CANDIDATE_GATE_ONLY_DEFAULT_BLOCKED", "UPSTREAM_ECHO_REQUIRED_BEFORE_NODE_V298");
    assertThat(receipt.nodeRecommendationCodes())
        .containsExactly(
            "RUN_PARALLEL_JAVA_V134_MINI_KV_V131", "VERIFY_WITH_NODE_V298_AFTER_UPSTREAM_ECHO");
