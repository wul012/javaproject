...
class OpsShardReadinessRouteCleanupMaintenanceArchiveManifestServiceTests {
    ...
    void buildsMaintenanceArchiveManifestForVersionedEvidenceArtifacts() {
        ...
        assertThat(manifest.endpoint()).isEqualTo(
                "/api/v1/ops/shard-readiness/route-cleanup-maintenance-archive-manifest");
        assertThat(manifest.profile()).isEqualTo(
        ...
        assertThat(manifest.artifacts())
                .extracting(OpsShardReadinessRouteCleanupMaintenanceArchiveManifestResponse
