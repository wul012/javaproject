...
class OpsShardReadinessLiveReadGatePlanServiceTests {
  ...
  void buildsReadOnlyLiveReadGateLifecyclePlan() {
    ...
    assertThat(plan.failClosedRules())
        .contains(
            "missing-port-or-base-url-blocks-live-read", "failed-smoke-blocks-node-consumption");
    ...
    assertThat(plan.evidencePath())
        .isEqualTo("e/159/evidence/java-shard-readiness-live-read-gate-plan-v159.json");
