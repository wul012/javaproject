...
class OpsShardReadinessRuntimeExecutionApprovalInputTemplateCompatibilityIntakeServiceTests {
    ...
    void buildsJavaCompatibilityIntakeReceiptWithoutCreatingApprovalInputs() {
        ...
        assertThat(receipt.receiptScope())
                .isEqualTo("java-side-runtime-execution-approval-input-template-compatibility-intake-receipt");
        assertThat(receipt.receiptId())
                .isEqualTo("java-runtime-execution-approval-input-template-compatibility-intake-receipt-v167");
        ...
        assertThat(receipt.nodeCompatibilityIntakeEvidencePath())
                .isEqualTo("D:/nodeproj/orderops-node/e/403/evidence/"
        ...
        assertThat(receipt.evidencePath())
                .isEqualTo("e/167/evidence/java-shard-readiness-runtime-execution-approval-input-template-compatibility-intake-v167.json");
