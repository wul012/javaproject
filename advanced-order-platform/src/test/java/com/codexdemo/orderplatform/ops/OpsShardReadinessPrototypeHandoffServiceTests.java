...
class OpsShardReadinessPrototypeHandoffServiceTests {
  ...
  void buildsPrototypeHandoffCatalogFromPrototypeCloseout() {
    ...
    assertThat(catalog.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-handoff-catalog");
    ...
    assertThat(catalog.sourcePrototypeEndpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-closeout");
    ...
    assertThat(catalog.entries())
        ...
        .satisfies(
            entry -> {
              ...
              assertThat(entry.checks()).contains("consume-java-v428-prototype-closeout-route");
            });
  ...
  void buildsEndpointInventoryEvidenceForReadOnlyRouteHandoff() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-handoff-endpoint-inventory");
  ...
  void buildsBoundaryMatrixEvidenceForForbiddenOperations() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-handoff-boundary-matrix");
    assertThat(evidence.profile())
    ...
    assertThat(evidence.forbiddenOperations())
        .contains(
            "write-routing", "managed-audit-connection", "node-start-or-stop-java-or-mini-kv");
    assertThat(evidence.status()).isEqualTo("passed");
  }
  ...
  void buildsConsumerVerificationChecklistEvidence() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-handoff-consumer-verification-checklist");
    assertThat(evidence.profile())
  ...
  void buildsReadWindowChecklistEvidence() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-handoff-read-window-checklist");
    assertThat(evidence.profile())
  ...
  void buildsDigestManifestEvidence() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-handoff-digest-manifest");
    assertThat(evidence.profile())
  ...
  void buildsCiManifestEvidence() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-handoff-ci-manifest");
    assertThat(evidence.profile())
  ...
  void buildsArchiveManifestEvidence() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-handoff-archive-manifest");
    assertThat(evidence.profile())
  ...
  void buildsOperatorSignoffPacketEvidence() {
    ...
    assertThat(evidence.endpoint())
        .isEqualTo("/api/v1/ops/shard-readiness/prototype-handoff-operator-signoff-packet");
    assertThat(evidence.profile())
  ...
  void closesOutPrototypeHandoffEvidenceRunForNodeConsumerGate() {
    ...
    assertThat(closeout.profile()).isEqualTo("java-shard-readiness-prototype-handoff-closeout.v1");
