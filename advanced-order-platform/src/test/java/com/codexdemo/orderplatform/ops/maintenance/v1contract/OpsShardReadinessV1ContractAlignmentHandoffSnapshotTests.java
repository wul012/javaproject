...
class OpsShardReadinessV1ContractAlignmentHandoffSnapshotTests {
  ...
  void freezesV190HandoffInputsWithoutReadingCurrentRegistryOrRuntimeState() {
    ...
    assertThat(alignment.sourceFixtureEndpoint())
    ...
    assertThat(
            OpsShardReadinessV1ContractAlignmentHandoffSnapshot
                .v190HistoricalCompatibilityVersion())
        .isEqualTo("Java v189");
    assertThat(OpsShardReadinessV1ContractAlignmentHandoffSnapshot.v190RegistryContainsAlignment())
        .isTrue();
    assertThat(
            OpsShardReadinessV1ContractAlignmentHandoffSnapshot
                .v190OlderSnapshotsRemainUnbackfilled())
        .isTrue();
    assertThat(
