    ...
    void releaseApprovalRehearsalReturnsVerificationHintAndReadOnlyExecutionContract() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/ops/release-approval-rehearsal"))
                ...
                .andExpect(jsonPath("$.verificationHint.responseSchemaVersion")
                        .value("java-release-approval-rehearsal-response-schema.v52"))
                ...
                .andExpect(jsonPath("$.verificationHint.schemaFields",
                        hasItem("inputHardeningDecisionEcho")))
                ...
                .andExpect(jsonPath("$.inputHardeningDecisionEcho.sourceNodeVersion").value("Node v329"))
                .andExpect(jsonPath("$.inputHardeningDecisionEcho.sourceCandidateGateDecision")
                        .value("require-input-export-hardening-before-disabled-runtime-design"))
                .andExpect(jsonPath("$.inputHardeningDecisionEcho.stableJavaEvidenceExportAvailable").value(true))
                .andExpect(jsonPath("$.inputHardeningDecisionEcho.readyForDisabledRuntimeShellDesignDraft").value(false))
                .andExpect(jsonPath("$.inputHardeningDecisionEcho.requiresCredentialValue").value(false))
                .andExpect(jsonPath("$.inputHardeningDecisionEcho.executesNetworkRequest").value(false))
                .andExpect(jsonPath("$.inputHardeningDecisionEcho.writesApprovalLedger").value(false))
                .andExpect(jsonPath("$.inputHardeningDecisionEcho.startsUpstreamProcess").value(false))
                .andExpect(jsonPath("$.verificationHint.schemaFields",
