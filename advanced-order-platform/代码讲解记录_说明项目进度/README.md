# advanced-order-platform 代码讲解记录_说明项目进度

本目录从 v48 之后作为新的代码讲解入口使用，和旧目录同级：

```text
D:\javaproj\advanced-order-platform\代码讲解记录
D:\javaproj\advanced-order-platform\代码讲解记录_说明项目进度
```
...
也就是说，本目录不是只写“代码做了什么”，还要明确说明“项目推进到了什么程度”。
...
旧目录记录“项目如何一步步长到 v47”，本目录从 v48 开始继续记录“每版代码怎么实现、项目进度推进到哪里、成熟度发生了什么变化”。
